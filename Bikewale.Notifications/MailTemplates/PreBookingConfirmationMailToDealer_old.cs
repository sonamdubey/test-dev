...
namespace Bikewale.Notifications.MailTemplates
{
    ...
    /// </summary>
    public class PreBookingConfirmationMailToDealer_old : ComposeEmailBase
    {
        ...
        public PreBookingConfirmationMailToDealer_old(string customerName, string customerMobile, string customerArea, string customerEmail, uint totalPrice, uint bookingAmount,
        ...
        public override string ComposeBody()
        {
            ...
            try
            {
                ...
                sb.Append("<a target=\"_blank\" href=\"http://www.bikewale.com/\"><img src=\"http://imgd3.aeplcdn.com/0x0/bw/static/design15/mailer-images/bw-logo.png\" border=\"0\" alt=\"BikeWale\" title=\"BikeWale\"></a>");                
                sb.Append("</div><div style=\" font-size:18px; font-weight:bold; float:left; margin:5px 0 0;\">Pre-Booking for " + BikeName + (!String.IsNullOrEmpty(BikeColor) ? " [" + BikeColor + "]" : "") + "</div><div style=\"float:right; color:#666; margin:5px 0 0;\">" + DateTime.Now.ToString("dd MMMM yyyy") + "</div>");
                ...
                sb.Append("</div><div style=\"background:url(http://imgd1.aeplcdn.com/0x0/bw/static/design15/mailer-images/red-border.png) no-repeat center center; height:2px; width:100%;\"></div><div style=\" padding:10px 0;\">");
                ...
                sb.Append("</div></div><div style=\"background:url(http://imgd3.aeplcdn.com/0x0/bw/static/design15/mailer-images/red-border.png) no-repeat center center; height:2px; width:100%\"></div>");
                ...
                if (OfferList != null && OfferList.Count > 0)
                {
                    ...
                    if (InsuranceAmount == 0)
                    {
                        ...
                        {
                            sb.Append("<p style=\"padding:0 10px 0 0; margin:10px 0 5px;\"><span style=\" background:url(http://imgd3.aeplcdn.com/0x0/bw/static/design15/old-images/d/bw-grey-bullet.png) no-repeat center center; padding:0 20px 0 0;\"></span>" + items.OfferText + ".</p>");
                        }
                    }
                    else
                    {
                ...
                sb.Append("</div><div style=\"margin-top:20px; margin-bottom:10px; max-width:670px;\"><a href=\"https://play.google.com/store/apps/details?id=com.bikewale.app&utm_source=BookingMailer&utm_medium=email&utm_campaign=DealerBookingMail\" target=\"_blank\"><img src=\"http://imgd2.aeplcdn.com/0x0/bw/static/design15/mailer-images/bw-footer-banner.jpg\" style=\"border:0; width:100%\"></a>");
                sb.Append("</div></div></div><div style=\"background:url(http://imgd2.aeplcdn.com/0x0/bw/static/design15/mailer-images/bottom-shadow.png) center center #eeeeee no-repeat; height:9px; width:100%\"></div></div>");
            }
            catch (Exception ex)
            {
