...
namespace Bikewale.Notifications.MailTemplates
{
    ...
    /// </summary>
    public class PreBookingConfirmationToCustomer_old : ComposeEmailBase
    {
        ...
        public PreBookingConfirmationToCustomer_old(string customerName, List<OfferEntity> offerList, string bookingReferenceNo, uint preBookingAmount, string makeName, string modelName, string dealerName, string dealerAddress, string dealerMobile, DateTime date, uint insuranceAmount = 0)
        {
        ...
        public PreBookingConfirmationToCustomer_old(string customerName, List<OfferEntity> offerList, string bookingReferenceNo, uint preBookingAmount, string bikeName ,string makeName, string modelName, string dealerName, string dealerAddress, string dealerMobile, DateTime date, uint insuranceAmount = 0)
        {
            CustomerName = customerName;
            OfferList = offerList;
            BookingReferenceNo = bookingReferenceNo;
