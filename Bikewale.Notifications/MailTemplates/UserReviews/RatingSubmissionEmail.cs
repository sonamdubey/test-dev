...

{
    ...
    public class RatingSubmissionEmail : ComposeEmailBase
    {
        ...
        /// </summary>
        public RatingSubmissionEmail(string userName, string makeName, string modelName,string reviewLink)
        {
        ...
        public override string ComposeBody()
        {
            ...
            sb.AppendFormat("<p>Every month, more than 6 million users research about bikes on BikeWale. ");
            sb.AppendFormat("The prospective buyers look out for user reviews to make their buying decision. ");
