            ...
            List<Entities.BikeBooking.PQ_Price> priceList, int totalPrice, List<Entities.BikeBooking.OfferEntity> offerList, string imagePath)
        {
            ...
            try
            {
                ...
                if (priceList != null && priceList.Count > 0)
                {
                    ...
                    {
                        mail.AppendFormat("<div style=\"padding-bottom:15px;\"> <div style=\"width:60%; float:left; color:#82888b;\">{0}</div> <div style=\"width:40%; float:left; text-align:right; font-weight:bold;\"><span><img src=\"http://imgd2.aeplcdn.com/0x0/bw/static/design15/mailer-images/inr-rupee-icon.png\" alt=\"Rupee\" title=\"Rupee\" border=\"0\" /></span>{1}</div> <div style=\"clear:both;\"></div> </div>"
                            ,list.CategoryName
                    ...
                    mail.AppendFormat("<div style=\"padding-bottom:15px;\"> <div style=\"width:60%; float:left; color:#82888b;\">Total Amount</div> <div style=\"width:40%; float:left; text-align:right; font-weight:bold;\"><span><img src=\"http://imgd2.aeplcdn.com/0x0/bw/static/design15/mailer-images/inr-rupee-icon.png\" alt=\"Rupee\" title=\"Rupee\" border=\"0\" /></span>{0}</div> <div style=\"clear:both;\"></div> </div></div></div><div style=\"text-align:center;\"> "
