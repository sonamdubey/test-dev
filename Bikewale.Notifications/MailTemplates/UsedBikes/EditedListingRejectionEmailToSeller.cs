...
namespace Bikewale.Notifications.MailTemplates.UsedBikes
{
    ...
    public class EditedListingRejectionEmailToSeller : ComposeEmailBase
    {
        ...
        public EditedListingRejectionEmailToSeller(string sellerName, string profileNo, string bikeName, string modelImage, string kms)
        {
