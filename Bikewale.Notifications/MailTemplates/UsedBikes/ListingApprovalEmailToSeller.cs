...
namespace Bikewale.Notifications.MailTemplates.UsedBikes
{
    ...
    public class ListingApprovalEmailToSeller : ComposeEmailBase
    {
        ...
        public ListingApprovalEmailToSeller(string sellerName, string profileNo, string bikeName, DateTime makeYear, string owner, string distance, string city, string imgPath,int inquiryId,string bwHostUrl)
        {
        ...
        public override string ComposeBody()
        {
            ...
            sb.AppendFormat("<div style='margin:0 20px 15px; border-bottom:1px solid #f5f5f5; text-align: center;'><div style='max-width: 490px; display: inline-block; vertical-align: middle; text-align: left;'><div style='color: #4d5057; font-weight: bold; margin-bottom: 5px;'>Your Ad on {0}</div><ul style='margin: 0; padding: 0; list-style: none; overflow: hidden;'><li style='float: left; min-width: 100px; margin: 10px 20px 10px 0'><img src=\"http://imgd.aeplcdn.com/0x0/bw/static/design15/mailer-images/calendar-grey-12.png\" alt='location' width='12' height='12' border='0' style='margin-right: 10px;' />{1} model</li><li style='float: left; min-width: 100px; margin: 10px 20px 10px 0'><img src=\"http://imgd.aeplcdn.com/0x0/bw/static/design15/mailer-images/author-grey-12.png\" alt='location' width='12' height='12' border='0' style='margin-right: 10px;' />{2} owner</li><li style='float: left; min-width: 100px; margin: 10px 20px 10px 0'><img src=\"http://imgd.aeplcdn.com/0x0/bw/static/design15/mailer-images/kms-grey-12.png' alt='location' width='12' height='12' border='0' style='margin-right: 10px;\" />{3} kms</li><li style='float: left; min-width: 100px; margin: 10px 20px 10px 0'><img src=\"http://imgd.aeplcdn.com/0x0/bw/static/design15/mailer-images/loc-grey-12.png\" alt='location' width='12' height='12' border='0' style='margin-right: 10px;' />{4}</li></ul><div style='clear: both;'></div></div><div style='display: inline-block; vertical-align: middle; text-align: left; margin-bottom: 10px;'><a href='{5}/used/sell/default.aspx?id={6}' target='_blank' style='text-decoration:none; color:#ef3f30; font-weight:bold; font-size:12px; width:158px; display: inline-block; background-color:#fff; border: 1px solid #ef3f30; padding:8px 0; border-radius:2px; text-align: center;'>Edit bike details</a></div><div style='margin-top: 10px; margin-bottom: 20px; text-align: left;'>You can view, edit, delete your listing and check replies to all your listings by logging into <a href='https://www.bikewale.com/mybikewale/' style='color: #0288d1; text-decoration: none;'>My BikeWale</a> account.</div></div>", bikeName, makeYear.Year, owner, distance, city, bwHostUrl, inquiryId);
            sb.AppendFormat("<div style='margin:0 20px 15px; border-bottom:1px solid #f5f5f5; text-align: center;'><div style='max-width: 480px; display: inline-block; vertical-align: middle; text-align: left; margin-bottom: 10px;'><div style='width: 80px; float: left; margin-right: 10px;'><img src='images/bike-model-img.jpg' alt='{0}' title='{0}' border='0' width='80' /></div><div style='width: auto; padding-top: 5px; padding-right: 20px;'><div style='color: #4d5057; font-weight: bold; margin-bottom: 5px;'>Ridden your bike for {1} kms. Help others in making the buying decision.</div></div><div style='clear: both;'></div></div><div style='display: inline-block; vertical-align: middle; text-align: left; margin-bottom: 20px;'><a href='' target='_blank' style='text-decoration:none; color:#fff; font-weight:bold; font-size:12px; width:158px; display: inline-block; background-color:#41B4C4; border: 1px solid #41B4C4; padding:8px 0; border-radius:2px; text-align: center;'>Write a review</a></div></div>",bikeName,distance);
