...
namespace Bikewale.Notifications.MailTemplates.UsedBikes
{
    ...
    public class ListingApprovalEmailToSeller : ComposeEmailBase
    {
        ...
        public override string ComposeBody()
        {
            ...
            sb.AppendFormat("You can view, edit, delete your listing and check replies to all your listings by logging into <a href='www.bikewale.com/mybikewale/'>My BikeWale</a> account.</p>");
