...
namespace Bikewale.Notifications.MailTemplates.UsedBikes
{
    ...
    public class ExpiringListingReminderEmail : ComposeEmailBase
    {
        private string _sellerName, _makeName, _modelName, _repostUrl, _remainingTime, _emailSubject,
            _qEncoded, _distance, _bwHostUrl, _imgPath;
        private EnumSMSServiceType _remainingDays;
        private uint _modelId;

        public ExpiringListingReminderEmail(string sellerName, string makeName, string modelName, EnumSMSServiceType remainingDays, string repostUrl, string emailSubject,string imgPath, string distance, string qEncoded, string bwHostUrl, uint modelId)
        {
        ...
        public override string ComposeBody()
        {
            ...
            sb.AppendFormat("<div style='margin: 0 20px 15px; border-bottom:1px solid #f5f5f5; text-align: center;'><div style='max-width: 480px; display: inline-block; vertical-align: middle; text-align: left; margin-bottom: 10px;'><div style='width: 80px; float: left; margin-right: 10px;'><img src='{0}' alt='{1} {2}' title='{1} {2}' border='0' width='80'/></div><div style='width: auto; padding-top: 5px; padding-right: 20px;'><div style='color: #4d5057; font-weight: bold; margin-bottom: 5px;'>Ridden your bike for {3} kms. Help others in making the buying decision.</div></div><div style='clear: both;'></div></div><div style='display: inline-block; vertical-align: middle; text-align: left; margin-bottom: 20px;'><a href='{4}/rate-your-bike/{5}/?q={6}' style='text-decoration:none; color:#fff; font-weight:bold; font-size:12px; width:158px; display: inline-block; background-color:#41B4C4; border: 1px solid #41B4C4; padding:8px 0; border-radius:2px; text-align: center;'>Write a review</a></div></div>", _imgPath, _makeName, _modelName, _distance, _bwHostUrl, _modelId, _qEncoded);
            //common footer
