...
namespace Bikewale.Notifications.MailTemplates.UsedBikes
{
    ...
    public class PhotoRequestToCustomerForThreeDays : ComposeEmailBase
    {
        ...
        public override string ComposeBody()
        {
            ...
            {
                sb.AppendFormat(@"Dear {3},<p>Thanks for choosing BikeWale to sell your {0} {1} bike. You are missing on opportunities because you have not uploaded any photo yet.
                    ...
                    To add photos click on the <a href='{4}/used/sell/?id={2}&hash=uploadphoto'>link</a>
                    <p>Cheers!</p><p>Team BikeWale</p>", _make, _model, _profileId, _customerName, Bikewale.Utility.BWConfiguration.Instance.BwHostUrl);
            }
            return sb.ToString();
        }
    }
