...
namespace Bikewale.Notifications.MailTemplates.UsedBikes
{
    ...
    /// </summary>
    public class EditedListingApprovalEmailToSeller : ComposeEmailBase
    {
        ...
        public EditedListingApprovalEmailToSeller(string sellerName, string profileNo, string bikeName, string modelImage, string kms, string writeReviewLink)
        {
