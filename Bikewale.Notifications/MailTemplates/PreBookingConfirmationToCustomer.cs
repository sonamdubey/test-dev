    ...
    public class PreBookingConfirmationToCustomer : ComposeEmailBase
    {
        ...
        public override string ComposeBody()
        {
            ...
            try
            {
                ...
                sb.Append("</div></div></div></div><div style=\"background:url(http://img1.carwale.com/bikewaleimg/images/bikebooking/mailer/bottom-shadow.png) center center #eeeeee no-repeat; height:9px; width:100%\"></div>");
