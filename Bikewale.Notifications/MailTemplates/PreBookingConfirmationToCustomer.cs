    ...
    public class PreBookingConfirmationToCustomer : ComposeEmailBase
    {
        ...
        public override StringBuilder ComposeBody()
        {
            ...
            try
            {
                ...
                sb.Append("<p style=\" margin:7px 0;\">Wishing you a great buying experience!</p><p style=\" margin:7px 0;\">Please feel free to call us at 022-67398888 for any help required in the process.</p>");
