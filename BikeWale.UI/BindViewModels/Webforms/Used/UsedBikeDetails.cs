            ...
            try
            {
                using (IUnityContainer container = new UnityContainer())
                {
                    ...
                    if (InquiryDetails != null && InquiryDetails.MinDetails != null)
                    {
                        ...
                        Description = string.Format("BikeWale - Used {0} {1} for sale in {2}. This second hand bike is of {3} model and its profile id is {4}{5}. Get phone number of the seller and call directly to inspect and test ride the bike.", InquiryDetails.Make.MakeName, InquiryDetails.Model.ModelName, InquiryDetails.City.CityName, ModelYear, InquiryDetails.OtherDetails.Seller, InquiryDetails.OtherDetails.Id);
