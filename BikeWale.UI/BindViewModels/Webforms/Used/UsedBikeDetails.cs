            ...
            try
            {
                using (IUnityContainer container = new UnityContainer())
                {
                    ...
                    if (InquiryDetails != null && InquiryDetails.MinDetails != null)
                    {
                        ...
                        CanonicalUrl = string.Format("https://www.bikewale.com/used/bikes-in-{0}/{1}-{2}-s{3}/", InquiryDetails.City.CityMaskingName, InquiryDetails.Make.MaskingName, InquiryDetails.Model.MaskingName, InquiryId);
                        AlternateUrl = string.Format("https://www.bikewale.com/m/used/bikes-in-{0}/{1}-{2}-s{3}/", InquiryDetails.City.CityMaskingName, InquiryDetails.Make.MaskingName, InquiryDetails.Model.MaskingName, InquiryId);
