                                    ...
                                    <ul id="used-bikes-list" data-bind="visible: OnInit() && !noBikes()">
                                        ...
                                        <li>
                                            ...
                                            <div class="model-details-content font14">
                                                <h2 class="margin-bottom5"><a href="<%= string.Format("/used/bikes-in-{0}/{1}-{2}-{3}/",bike.CityMaskingName,bike.MakeMaskingName,bike.ModelMaskingName,bike.ProfileId) %>" class="text-truncate text-black" title="<%= curBikeName %>"><%= curBikeName %></a></h2>
                                        ...
                                        <li>
                                            ...
                                            <div class="model-thumbnail-image">
                                                <a href="" data-bind="attr: { 'href': '/used/bikes-in-' + cityMasking + '/' + makeMasking + '-' + modelMasking + '-' + profileId + '/' },title:bikeName" title="">
                                                    ...
                                                    <!-- /ko --><!-- ko if : $index() > 2 -->
                                                    <img data-bind="attr: { alt: bikeName, title: bikeName}, lazyload: ((photo.originalImagePath != '') ? (photo.hostUrl + '/370x208/' + photo.originalImagePath) : 'http://imgd3.aeplcdn.com/174x98/bikewaleimg/images/noimage.png'), " alt="" title="" border="0" />
                                                    <!-- /ko -->
