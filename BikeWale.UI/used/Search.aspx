...
<div class="container_12">
    ...
    <div class="grid_8 margin-top15">
        ...
        <div id="searchRes" runat="server">
            <img src='http://img.carwale.com/loader.gif' border='0'alt="Loading.." />            
        </div>
    </div>
</div>
<div id="expended_row" class="hide">
	<div><span id="last_update_row" class="right-float"></span><span id="close_row"><img alt="collapse" src="http://img.carwale.com/used/collapsible.png" title="collapse" border="0" align="left"/></span>&nbsp;<span id="bike_row" class="price2" style="zoom:1;"></span>&nbsp;&nbsp;<span id="profileId_row"></span></div>    
	<div style="width:10%;" class="thumb_img left-float margin-top10" align="center"><img id="front_image" alt="Loading..." src="http://img.carwale.com/bikewaleimg/common/nobike.jpg" border="0" /><br /><a id="photo_count"></a><div id="certified_cont"></div></div>
