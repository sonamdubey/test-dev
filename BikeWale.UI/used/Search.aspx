                            ...
                            <div id="sort-by-content" class="grid-3 omega">
                                ...
                                <div class="sort-selection-div sort-list-items hide">
                                    <ul id="sort-listing">
                                        ...
                                        <li data-sortorder="1" >Most recent</li>
                                        <li data-sortorder="2">Price - Low to High</li>
                                        <li data-sortorder="3" >Price - High to Low</li>
                                        <li data-sortorder="4" >Kms - Low to High</li>
                                        <li data-sortorder="5">Kms - High to Low</li>
                                    </ul>
                                </div>
                            </div>
                            <div class="clear"></div>
                                ...
                                <div id="filter-sidebar" class="border-solid-right">
                                    ...
                                    <div id="filter-type-city" class="filter-block">
                                        ...
                                        <select class="city-chosen-select hide">
                                             <option data-cityid="0" data-bind="click: FilterCity">All India</option>
                                             <% if (citiesList != null)
                                                { %>
                                            <% foreach(var city in citiesList) { %>
                                                  <option data-cityid="<%= city.CityId %>" data-bind="click: FilterCity"><%=city.CityName %></option>
                                            <% } %>
                                            <%} %>
                                        </select>
                                    </div>
