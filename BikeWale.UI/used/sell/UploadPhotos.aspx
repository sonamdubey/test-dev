...
<div class="grid_8">	
	<div class="sell_block moz-round">
		...
		<p>BikeWale stats show that the listings with photos are likely to fetch more number of genuine leads. So, go ahead and upload your bike photos.</p>
		<div class="mid-box">
			<div id="utility">				
				<div>In case currently you don't have bike photos, you can skip for now and come back later to upload.</div>		
				<div class="mid-box">
			...
			<div id="basic-uploader" class="text-grey2" style="margin-top:30px;">Problem uploading photos? Use <a href="UploadBasic.aspx">Basic File Uploader</a></div>
