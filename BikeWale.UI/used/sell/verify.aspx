...
<script type="text/javascript" src="<%= staticUrl != "" ? "https://st.aeplcdn.com" + staticUrl : "" %>/src/classified/sellbike.js?1.1"></script>
<div class="container_12 margin-top20">    
    <div class="grid_8 min-height"><!--    Left Container starts here -->
        ...
        <div class="margin-top5">
            <img align="absmiddle" src="https://imgd1.aeplcdn.com/0x0/bw/static/design15/old-images/d/mobi-verif.gif" border="0" />
