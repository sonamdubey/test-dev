...
%>
    ...
    <link href="<%= staticUrl != "" ? "https://st1.aeplcdn.com" + staticUrl : "" %>/css/sell-bike/sell-bike.css?<%= staticFileVersion %>" rel="stylesheet" type="text/css" />
...
<body class="bg-light-grey header-fixed-inner" data-contestslug="">
