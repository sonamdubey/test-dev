            ...
            <div class="container section-bottom-margin">
                <div class="grid-12">
                    <div class="bg-white">
                        ...
                        <p class="section-inner-padding font14 text-light-grey">There are 100 authorised Honda service centers in India. BikeWale strongly recommends you to avail services only from authorized Honda service centers. These authorised service centers are spread over 50 cities to service your Honda bike and keep your bike moving. Enter the name of your city in the search box provided below to find authorised Honda service centers in your city.</p>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
            ...
            <div class="container section-bottom-margin">
                <div class="grid-12">
                    <div class="content-box-shadow">
                        <h2 class="section-h2-title padding-15-20"><%=DealerCount%> <%=objMMV.MakeName %> service centers in <%=citiesCount%> cities</h2>
