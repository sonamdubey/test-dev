...
<head>
    ...
    <style type="text/css">
        ...
        .inner-content-card li {
            ...
            .inner-content-card li.front {
                border: none;
            }

            .inner-content-card li .imageWrapper {
                width: 100%;
                height: 166px;
            }

                .inner-content-card li .imageWrapper a {
                    display: table-cell;
        ...
        .sort-list-items ul::after, .sort-list-items ul::before {
        ...
        .sort-selection-div ul li {
            ...
            .sort-selection-div ul li:hover {
                cursor: pointer;
                background: #82888b;
                color: #fff;
            }
        ...
        .sort-list-items ul::before {
            border-bottom: 10px solid #e2e2e2;
            top: -11px;
        }

        .sort-list-items ul::after {
        ...
        #makeUpcomingBikesContent .jcarousel-control-left {
            left: 0;
        }

        #makeUpcomingBikesContent .jcarousel-control-right {
            right: 0;
        }

        .inner-content-carousel .jcarousel {
            width: 934px;
            left: 20px;
            padding: 0;
        }

        #makeDealersContent .inner-content-carousel .jcarousel {
            left: 10px;
        }

        .inner-content-carousel .jcarousel li {
            width: 292px;
            height: auto;
            margin-right: 28px;
        }

        .inner-content-carousel h3 a.text-black {
            display: block;
        }

        .inner-content-carousel .jcarousel-control-left {
            left: -10px;
            top: 13%;
        }

        .inner-content-carousel .jcarousel-control-right {
            right: 10px;
            top: 13%;
        }

        .inner-content-carousel .jcarousel-control-next, .inner-content-carousel .jcarousel-control-prev {
            width: 36px;
            height: 68px;
        }

            .inner-content-carousel .jcarousel-control-prev:hover {
                background-position: -36px -134px;
            }

            .inner-content-carousel .jcarousel-control-next:hover {
                background-position: -63px -134px;
            }

        .inner-content-carousel .jcarousel-control-prev {
            background-position: -36px -79px;
        }

        .inner-content-carousel .jcarousel-control-next {
            background-position: -63px -79px;
        }

        .inner-content-carousel .jcarousel-control-prev.inactive {
            background-position: -36px -24px;
        }

        .inner-content-carousel .jcarousel-control-next.inactive {
        ...
        #makeOverallTabsWrapper {
            width: 100%;
            height: 45px;
        }

        .overall-floating-tabs {
            width: 976px;
            background: #fff;
            border-bottom: 1px solid #e2e2e2;
        }

        #makeOverallTabs.fixed-tab {
            position: fixed;
            top: 0;
            margin: 0 auto;
            z-index: 5;
            border-bottom: 0;
            -moz-box-shadow: 0 2px 2px #e2e2e2,0 1px 1px #f1f1f1;
            -webkit-box-shadow: 0 2px 2px #e2e2e2,0 1px 1px #f1f1f1;
            -o-box-shadow: 0 2px 2px #e2e2e2,0 1px 1px #f1f1f1;
            -ms-box-shadow: 0 2px 2px #e2e2e2,0 1px 1px #f1f1f1;
            box-shadow: 0 2px 2px #e2e2e2,0 1px 1px #f1f1f1;
        }

        .mail-grey-icon, .phone-black-icon {
            margin-right: 3px;
            position: relative;
        }
        ...
        .overall-specs-tabs-wrapper {
            ...
            .overall-specs-tabs-wrapper a {
                ...
                .overall-specs-tabs-wrapper a.active {
                    border-bottom: 3px solid #ef3f30;
                    font-weight: 700;
                    color: #4d5057;
                }

        #makeTabsContentWrapper h2 {
            margin-bottom: 15px;
        }

        #makeTabsContentWrapper h3 {
            font-weight: 700;
            margin-bottom: 12px;
        }

        #makeReviewsContent h3.model-section-subtitle {
            margin-bottom: 20px;
        }
        ...
        #makeUpcomingBikesContent .model-preview-image-container {
            border: none;
        }

        .model-preview-image-container a {
            width: 100%;
            height: 164px;
            display: block;
            background: url(http://imgd4.aeplcdn.com/0x0/bw/static/sprites/d/loader.gif) center center no-repeat;
            ...
            .model-preview-image-container a img {
                width: 100%;
                height: 164px;
            }
        ...
        #makeReviewsContent .article-target-link, #makeVideosContent .article-target-link {
            margin-bottom: 8px;
            line-height: 1.5;
        }
        ...
        .model-user-review-rating-container {
            width: 148px;
            height: 84px;
            border: 1px solid #e2e2e2;
            background: #f9f9f9;
        ...
        .model-user-review-title-container {
            width: 308px;
        }

        #makeTabsContentWrapper .model-user-review-title-container h3 {
            font-size: 16px;
            color: #2a2a2a;
            line-height: 1.7;
            margin-bottom: 5px;
        ...
        .dealer-jcarousel-image-preview {
            width: 292px;
            height: 114px;
            display: block;
            margin-bottom: 15px;
        ...
        .city-sprite {
            background: url(http://imgd1.aeplcdn.com/0x0/bw/static/sprites/d/city-sprite.png?24062016) no-repeat;
            display: inline-block;
        }

        .ahmedabad-icon, .bangalore-icon, .chandigarh-icon, .chennai-icon, .delhi-icon, .hyderabad-icon, .kolkata-icon, .lucknow-icon, .mumbai-icon, .pune-icon {
            height: 92px;
        }
        ...
        .ahmedabad-icon, .chandigarh-icon {
            width: 0;
            background-position: 0 0;
        }
        ...
        .newBikes-latest-updates-container .home-tabs {
            background: #ccc;
        }

            .newBikes-latest-updates-container .home-tabs li {
                width: 170px;
                text-align: center;
                font-size: 18px;
                padding: 13px 14px;
                ...
                .newBikes-latest-updates-container .home-tabs li:first-child {
                    margin-right: -2px;
                }

                .newBikes-latest-updates-container .home-tabs li.active {
                    background: #fff;
                    color: #2a2a2a;
                }
