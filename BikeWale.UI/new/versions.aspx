<%@ Page Language="C#" AutoEventWireup="false" Inherits="Bikewale.New.Versions" Trace="false" Debug="false" Async="true" %>
         ...
         <div>
            ...
            <div class="grid_3 alpha margin-top15">
                ...
                <a href="/<%= MakeMaskingName%>-bikes/<%= ModelMaskingName %>/photos/" title="<%= MakeMaskingName + " " + ModelMaskingName%>">
                    ...
                    <img  src="<%=MakeModelVersion.GetModelImage(hostURL,imageUrl,Bikewale.Utility.ImageSize._210x118) %>" class="padding-5 border-light" title="<%=model%>" alt="<%=model%>" />
                    <% if (isPhotoAvailable) { %>
                </a>
                <% } %>
            </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#ddlVersion").change(function () {
            ...
            $("#versionDetails").html("<img src='http://img.carwale.com/loader.gif' border='0'/>Loading Results...");
            setTimeout(2000);
