                        ...
                        <div class="grid-4 floating-card-area-details">
                              <% if (!modelPageEntity.ModelDetails.Futuristic)
                               { %>
                                ...
                                <% else if (!isOnRoadPrice)
                                   {%>
                                <p class="font14 text-light-grey leftfloat exshowroom-area"><span class="leftfloat">Ex-showroom price in</span><span class="leftfloat text-truncate exshowroom-area-name city-area-name margin-right5"><%= areaName %><%= !string.IsNullOrEmpty(areaName) ? ", " : ""%> <%= cityName %></span></p>
                                <% } %>
                                <% else
                                   {%>
                                <p class="font14 text-light-grey leftfloat"><span class="leftfloat">On-road price in</span><span class="leftfloat text-truncate city-area-name margin-right5"><%= areaName%><%=!string.IsNullOrEmpty(areaName) ? ", " : ""%> <%= cityName %></span></p>
