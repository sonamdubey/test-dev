                            ...
                            <div class="grid-7 model-details-wrapper omega rightfloat padding-top5">
                                ...
                                <div id="modelPriceContainer">
                                    ...
                                    <% else if (!isCitySelected)
                                       {%>
                                    <p class="font14 text-light-grey">Ex-showroom price in <span class="font14 text-default"><%= Bikewale.Utility.BWConfiguration.Instance.DefaultName %></span><a data-persistent="true" data-modelid="<%=modelId %>" class="margin-left5 getquotation changeCity"><span class="bwsprite loc-change-blue-icon"></span></a></p>
                                    <% } %>
                                    ...
                                    <% else
                                       {%>
                                    <p class="font14 text-light-grey">On-road price in<span><span class="city-area-name"><%= !string.IsNullOrEmpty(areaName) ? string.Format("{0}, {1}", areaName, cityName) : cityName %></span></span><a data-persistent="true"  data-modelid="<%=modelId %>" class="margin-left5 getquotation changeCity"><span class="bwsprite loc-change-blue-icon"></span></a></p>
                                    ...
                                    <% 
                                           ...
                                           { %>
                                    <a id="btnGetOnRoadPrice" href="javascript:void(0)" data-persistent="true" data-modelid="<%=modelId %>" class="btn btn-orange margin-top10 getquotation">Check on-road price</a>
                                    <div class="clear"></div>
