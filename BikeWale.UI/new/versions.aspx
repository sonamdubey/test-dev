...
<head>
    ...
    <style type="text/css">
        ...
        .navigation .carousel-navigation li:hover, .sort-div, .viewBreakupText {
            cursor: pointer;
        }
        ...
        #modelDetailsContainer .model-details-wrapper {
            width: 522px;
            margin-left: 20px;
        }
        ...
        #variantDetailsContainer .variantText {
            float: left;
            font-size: 14px;
            line-height: 28px;
        }

        #variantDetailsContainer .variantDropDown {
            float: left;
        }

            #variantDetailsContainer .variantDropDown .form-control {
        ...
        .variantList li {
            ...
            .variantList li:first-child {
                border-left: none;
                text-align: left;
                padding-left: 0;
            }

        .sort-div, .sort-selection-div {
            min-width: 150px;
        ...
        .model-details-floating-card .city-area-name {
            width: 140px;
        }

        .exshowroom-area.exshowroom-area-name, .model-details-floating-card .exshowroom-area-name.city-area-name {
            width: 120px;
        }
        ...
        .sort-selection-div {
            ...
            .sort-selection-div ul li {
                margin-bottom: 5px;
                margin-top: 5px;
                font-size: 14px;
            }

                .sort-selection-div ul li.selected {
                    font-weight: 700;
                }

                .sort-selection-div ul li input {
                    background: #fff;
                    color: #4d5057;
                ...
                .sort-selection-div ul li:hover input {
                    padding: 2px 0 2px 8px;
                    cursor: pointer;
                    background: #82888b;
                    color: #fff;
        ...
        .bike-discontinued-tag, .bike-upcoming-tag {
            z-index: 2;
        }

        .model-name-review-container:hover .write-review-text {
            display: block;
        }
        ...
        .connected-carousels .carousel {
            ...
            .connected-carousels .carousel li {
                ...
                .connected-carousels .carousel li .carousel-img-container {
                    display: table;
                    width: 385px;
                    height: 220px;
                    text-align: center;
                    ...
                    .connected-carousels .carousel li .carousel-img-container span {
                        display: table-cell;
                        vertical-align: middle;
                        width: 385px;
                        height: 220px;
                        background: url(http://imgd4.aeplcdn.com/0x0/bw/static/sprites/d/loader.gif) center center no-repeat;
                    }

                        .connected-carousels .carousel li .carousel-img-container span img {
                            width: 100%;
                            height: 220px;
                        }
        ...
        .navigation .carousel-navigation li {
            ...
            .navigation .carousel-navigation li.active img {
        ...
        .navigation .carousel-navigation li .carousel-nav-img-container {
            display: table;
            width: 90px;
            height: 50px;
            text-align: center;
            ...
            .navigation .carousel-navigation li .carousel-nav-img-container span {
                display: table-cell;
                vertical-align: middle;
                width: 90px;
            }
        ...
        .connected-carousels .next, .connected-carousels .prev {
            position: absolute;
            top: 40%;
            z-index: 1;
            width: 26px;
        ...
        .connected-carousels .navigation .prev-navigation, .connected-carousels .prev-stage {
            background-position: -125px -355px;
        }

        .connected-carousels .navigation .next-navigation, .connected-carousels .next-stage {
            background-position: -150px -355px;
        }

        .connected-carousels .navigation .prev-navigation:hover, .connected-carousels .prev-stage:hover {
            background-position: -125px -386px;
        }

        .connected-carousels .navigation .next-navigation.hover, .connected-carousels .next-stage:hover {
            background-position: -150px -386px;
        }

        .connected-carousels .navigation .next-navigation.inactive, .connected-carousels .navigation .prev-navigation.inactive, .connected-carousels .next-stage.inactive, .connected-carousels .prev-stage.inactive {
            display: block;
        }

        .connected-carousels .navigation .prev-navigation.inactive, .connected-carousels .prev-stage.inactive {
            background-position: -125px -325px;
            cursor: not-allowed;
        }

        .connected-carousels .navigation .next-navigation.inactive, .connected-carousels .next-stage.inactive {
            background-position: -150px -325px;
            cursor: not-allowed;
        }

        .connected-carousels .navigation .next-navigation, .connected-carousels .navigation .prev-navigation {
            width: 26px;
            height: 45px;
            text-indent: -9999;
            border: none;
        ...
        .dealership-benefit-list .benefit-list-image, .dealership-benefit-list .benefit-list-title, .dealership-benefit-list li {
            display: inline-block;
            vertical-align: middle;
        }

        .dealership-benefit-list li {
            width: 290px;
            color: #82888b;
            margin-top: 10px;
        }

        .dealership-benefit-list.dealer-two-offers li {
            width: 440px;
        }

        .dealership-benefit-list.f-two-offers .benefit-list-title {
            width: 400px;
        }

        .dealership-benefit-list .benefit-list-title {
            width: 255px;
            padding-right: 10px;
            padding-left: 10px;
        }
        ...
        #buyingAssistance .errorIcon, #buyingAssistance .errorText, .less-dealers-link {
            display: none;
        }
        ...
        #moreDealersList {
            ...
            #moreDealersList a:hover {
                text-decoration: none;
            }

        .model-sprite {
            background: url(http://imgd2.aeplcdn.com/0x0/bw/static/sprites/d/model-sprite-new.png?v=18Aug2016) no-repeat;
            display: inline-block;
        }

        .loc-change-blue-icon {
            width: 12px;
            height: 16px;
            ...
            .loc-change-blue-icon:hover {
                background-position: -205px -35px;
            }

        .offer-benefit-sprite {
            background: url(http://imgd1.aeplcdn.com/0x0/bw/static/sprites/d/offer-benefit-sprite.png?v1=30Mar2016v1) no-repeat;
            display: inline-block;
        }

        .benifitIcon_1, .benifitIcon_2, .benifitIcon_3, .benifitIcon_4, .benifitIcon_5, .offerIcon_1, .offerIcon_2, .offerIcon_3, .offerIcon_4, .offerIcon_5, .offerIcon_6, .offerIcon_7 {
            width: 30px;
        }
        ...
        .benifitIcon_5, .offerIcon_5, .offerIcon_7 {
            height: 30px;
        ...
        #leadCapturePopup, #otpPopup {
            display: none;
        }

        #modelSpecsTabsContentWrapper {
            min-height: 300px;
        }

        #modelDetailsFloatingCardContent {
            display: block;
            position: fixed;
            top: -500px;
            left: 5%;
            ...
            #modelDetailsFloatingCardContent .model-details-floating-card {
                width: 976px;
            }

            #modelDetailsFloatingCardContent.fixed-card {
                top: 0;
            }

            #modelDetailsFloatingCardContent .overall-specs-tabs-wrapper {
                display: none;
            }

            #modelDetailsFloatingCardContent.activate-tabs .overall-specs-tabs-wrapper {
                display: block;
            }

        .overall-specs-tabs-wrapper {
            display: table;
            background: #fff;
        }

            .overall-specs-tabs-wrapper a {
                padding: 10px 20px;
                display: table-cell;
                font-size: 14px;
                color: #82888b;
                ...
                .overall-specs-tabs-wrapper a:hover {
                    text-decoration: none;
                    color: #4d5057;
                }

                #modelSpecsTabsContentWrapper .overall-specs-tabs-wrapper a:first-child, .overall-specs-tabs-wrapper a.active {
                    border-bottom: 3px solid #ef3f30;
                    font-weight: 700;
                    color: #4d5057;
                }

        .content-inner-block-2010 {
            padding: 20px 10px;
        }
    </style>
