                                         ...
                                         <ItemTemplate>
                                           <td class="maintd <%# Container.ItemIndex == featuredBikeIndex ? "featuredBike" : ""  %>">
                                               <table class="<%=!isFeatured ? ((count==2) ? "threecolum": (count==3 ? "fourcolum" : (count==4 ? "fourcolum" : ""))) : ((count==2) ? "threecolum": (count==3 ? "fourcolum" : (count==4 ? "fivecolum" : (count==5 ? "fivecolum" : ""))))%>" cellpadding="0" border="0" cellspacing="0">
                                                   <tr><td>
                                                       <div class="bikeclose"><a class='delBike pointer right-float <%= !isFeatured ? ((count==2) ? "hide" : "") : ((count==3) ? "hide" : "") %>' versionId='<%# DataBinder.Eval(Container.DataItem,"BikeVersionId") %>'><img src="http://imgd1.aeplcdn.com/0x0/bw/static/design15/old-images/d/delete.ico" /></a></div>
                                                       <div class="clear"></div>
                                                       <div class="bikemain">
