...
namespace Bikewale.New
{
    public class bikeModel : PageBase //inherited page base class to move viewstate from top of the html page to the end
    {
        ...
        protected void rptVarients_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                ErrorClass objErr = new ErrorClass(ex, Request.ServerVariables["URL"] + "rptVarients_ItemDataBound");
                objErr.SendMail();
            }
        }
        ...
        private void FetchOnRoadPrice()
        {
            ...
            catch (Exception ex)
            {
                ...
                ErrorClass objErr = new ErrorClass(ex, Request.ServerVariables["URL"] + "-" + "FetchOnRoadPrice" + " ===== parameters ========= " + errorParams);
                objErr.SendMail();
            }
        }
        /// <summary>
        ...
        private PQOnRoadPrice GetOnRoadPrice()
        {
                    ...
                    if (objPQOutput != null)
                    {
                        ...
                        if (objPQOutput != null && objPQOutput.PQId > 0)
                        {
                            ...
                            if (objPQOutput.DealerId != 0)
                            {
                                ...
                                {
                                    ErrorClass objErr = new ErrorClass(ex, Request.ServerVariables["URL"] + "GetOnRoadPrice" + "-" + api);
                                    objErr.SendMail();
                                }
                            }
                        }
            ...
            {
                ErrorClass objErr = new ErrorClass(ex, Request.ServerVariables["URL"] + "GetOnRoadPrice");
                objErr.SendMail();
            }
            return pqOnRoad;
        }
        ...
        private void FetchVariantDetails(int versionId)
        {
            ...
            {
                ErrorClass objErr = new ErrorClass(ex, Request.ServerVariables["URL"] + "FetchVariantDetails");
                objErr.SendMail();
            }
        }
        /// <summary>
        ...
        private List<CityEntityBase> FetchCityByModelId(string modelId)
        {
            ...
            {
                ErrorClass objErr = new ErrorClass(ex, Request.ServerVariables["URL"] + "FetchCityByModelId");
                objErr.SendMail();
            }
            return cityList;
        }
        ...
        private List<Bikewale.Entities.Location.AreaEntityBase> GetAreaForCityAndModel()
        {
            ...
            {
                ErrorClass objErr = new ErrorClass(ex, Request.ServerVariables["URL"] + "GetAreaForCityAndModel");
                objErr.SendMail();
            }
