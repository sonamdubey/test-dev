<%@ Page Language="C#" AutoEventWireup="false" Inherits="Bikewale.New.VersionSpecs" trace="false"%>
<script type="text/javascript">
    isSpecsExist = '<%= isSpecsAvailable%>';
    count='<%= count%>';
    if (isSpecsExist <= 0 && count == 1) {
        $("#specification-and-features");
    }

    if (isSpecsExist <= 0 && count > 1) {
        $("#divSpecs").text("Specification for this version is not available.").addClass('margin-top20');
    }
</script>
...
<div class="grid_4 alpha">           
    <table width="100%" class="tbl-specs margin-top10">                
        ...
        <tr>
            <td width="150">Displacement (cc)</td>
            <td  width="145">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:literal id="ltr_MaxPowerRpm" runat="server" />
            </td>
        </tr>
        <tr>
            ...
            <td>
                ...
                <asp:literal id="ltr_MaxTorqueRpm" runat="server" />
            </td>
        </tr>
        <tr>
            <td>Bore (mm)</td>
