...
<head> 
    <% 
        ...
        canonical = string.Format("https://www.bikewale.com/new/{0}-dealers/", objMMV.MaskingName);
        alternate = string.Format("https://www.bikewale.com/m/new/{0}-dealers/", objMMV.MaskingName);
    %>
