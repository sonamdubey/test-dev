...
<body class="bg-light-grey">
    <form runat="server">
        ...
        <header class="dealerlocator-banner">
            <div id="dealer-locator-box" class="container">
                <div class="welcome-box">
                    <h1 class="margin-bottom30">Bike dealer locator</h1>
                    <p class="font20 margin-bottom50">Find new bike dealer showrooms across 200 cities in India</p>
                </div>
            </div>
        </header>
        ...
        <section>
            <div class="container section-container">
                <div class="grid-12">
                    <h2 class="section-header">Locate dealers by brand</h2>
