<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BikesByYear.aspx.cs" Inherits="Bikewale.New.NewLaunchBikes.BikesByYear" %>

<!DOCTYPE html>
<html>
<head>
    <title>New bike launches by year</title>
    <%
        isHeaderFix = true;    
    %>
    ...
    <form id="form1" runat="server">
                ...
                <div class="grid-12">
                    <div class="breadcrumb margin-bottom15">
                        <ul>
                            ...
                            <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                                <span class="bwsprite fa-angle-right margin-right10"></span>
                                <span itemprop="title">New Bike Launches in 2017</span>
                            </li>
                        </ul>
                        <div class="clear"></div>
                    </div>
        ...
        <section>
            <div class="container section-bottom-margin">
                <div class="grid-12">
                    <div class="bg-white">
                        <h1 class="section-header">New Bike Launches in 2017</h1>
                    ...
                    <div class="content-box-shadow">
                        <div class="padding-right20 padding-left20">
                            <div class="padding-top15 padding-bottom15 border-solid-bottom">
                                <h2 class="font18 text-black grid-4 alpha">Latest bikes in India - 2017</h2>
                                <div class="grid-8 omega text-right new-launch-filter">
                                    ...
                                    <div class="select-box inline-block right-align-box">
