            ...
            <asp:repeater id="rptLaunches" runat="server">						           
                    <ItemTemplate>
                        <div class="margin-bottom15">
                            ...
                            <div style="margin:5px 0;"><b>When to expect:</b> <%# String.IsNullOrEmpty(Convert.ToString(DataBinder.Eval(Container.DataItem, "ExpectedLaunch"))) ? "N/A" : Convert.ToDateTime(DataBinder.Eval(Container.DataItem, "ExpectedLaunch")).ToString("MMM yyyy") %></div>
