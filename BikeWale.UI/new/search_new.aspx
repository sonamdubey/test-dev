                                ...
                                <div class="contentWrapper">
                                    ...
                                    <div class="bikeDescWrapper">
                                        ...
                                        <div id="reviewRatingsDiv" class="text-xt-light-grey margin-bottom10 position-rel pos-right5">
                                            ...
                                            <span class='font11 text-xt-light-grey inline-block padding-left3' data-bind="template: { if: bikemodel.ratingCount() }">(<span data-bind="    text: bikemodel.ratingCount()"></span> ratings)</span><span data-bind="    template: { if: bikemodel.reviewCount() }"><a class='text-xt-light  inline-block' data-bind="    attr: { href: '/' + bikemodel.makeBase.maskingName() + '-bikes/' + bikemodel.maskingName() + '/reviews/' }"><span class="review-left-divider" data-bind="    text: bikemodel.reviewCount()"></span> <span data-bind="    text: bikemodel.reviewCount() == 1 ? 'review' : 'reviews'"></span></a></span>
                                        </div>
