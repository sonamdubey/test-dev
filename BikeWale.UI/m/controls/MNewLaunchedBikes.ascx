            ...
            <div class="front">
                <div class="contentWrapper">
                    ...
                    <div class="bikeDescWrapper">
                        ...
                        <a href="javascript:void(0)" modelName="<%# DataBinder.Eval(Container.DataItem,"ModelName").ToString() %>" makeName="<%# DataBinder.Eval(Container.DataItem,"MakeBase.MakeName").ToString() %>" pqSourceId="<%= PQSourceId%>" pagecatid="<%=PageId %>" modelId="<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "ModelId")) %>" class="btn btn-sm btn-white margin-top10 getquotation <%# (Convert.ToString(DataBinder.Eval(Container.DataItem, "MinPrice"))!="0")?"":"hide" %> ">Check on-road price</a>
                    </div>
                </div>
            </div>
          </div>
