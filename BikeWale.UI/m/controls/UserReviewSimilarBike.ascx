    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <div class="swiper-card">
                <a href="<%=string.Format("/{0}-bikes/{1}/user-reviews/",UserDetails.MakeMaksingName,UserDetails.ModelMaskingName)%>" title="<%=string.Format("{0} {1}",UserDetails.MakeName,UserDetails.ModelName) %>">
                    ...
                    <div class="swiper-details-block">
                        ...
                        <ul class="bike-review-features">
                            ...
                            <li class="font14"><%=UserDetails.ReviewCounting%> Reviews</li>
                        </ul>
                    </div>
                </a>
            </div>
