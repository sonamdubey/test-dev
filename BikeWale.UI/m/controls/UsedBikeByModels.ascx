    ...
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide">
            <div class="swiper-card">
                <a href="<%=string.Format("/m/used/{0}-{1}-bikes-in-{2}/",MakeMaskingName,ModelDetails.ModelMaskingName,CityMaskingName) %>" title="<%=string.Format("Used {0} bikes in {1}",ModelDetails.ModelName,CityName)%>" class="card-target-block">
