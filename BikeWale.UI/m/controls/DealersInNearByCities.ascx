...
<div class="container bg-white box-shadow padding-top15 padding-bottom20 font14 active">
    ...
    <div class="swiper-container padding-top5 padding-bottom5 sw-0 swiper-container-horizontal bwm-brands-swiper">
        <div id="nearbyCities" class="swiper-wrapper">
                ...
                <div class="swiper-card">
                    <a href="/m/<%= MakeMaskingName %>-dealer-showrooms-in-<%= Dealer.CityMaskingName %>/" title="<%= MakeName %> showrooms in <%= Dealer.CityName %>">
                        ...
                        <div class="swiper-details-block">
                            <h3 class="target-link font12 text-truncate margin-bottom5 padding-top5"><%= Dealer.CityName%></h3>
                            <p class="text-truncate text-light-grey font11"><%= Dealer.DealersCount %> <%= MakeName%> showroom<%if(Dealer.DealersCount > 1){%>s<%}%></p>
                        </div>
                    </a>
                </div>
            </div>
