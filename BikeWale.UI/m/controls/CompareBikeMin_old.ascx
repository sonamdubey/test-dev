<%@ Control Language="C#" AutoEventWireup="false" Inherits="Bikewale.Mobile.Controls.CompareBikeMin_old" %>
<style>
...
<asp:Repeater ID="rptCompareList" runat="server">
    <ItemTemplate>
        <a href="/m/comparebikes/<%#DataBinder.Eval(Container.DataItem,"MakeMaskingName1")%>-<%#DataBinder.Eval(Container.DataItem,"ModelMaskingName1")%>-vs-<%#DataBinder.Eval(Container.DataItem,"MakeMaskingName2")%>-<%#DataBinder.Eval(Container.DataItem,"ModelMaskingName2")%>/" class="normal">
            <div class="box1 new-line5">
                ...
                <div style="text-align: center;"><strong><%# DataBinder.Eval( Container.DataItem, "Bike1" ) %>&nbsp;<span class="red-text">vs</span>&nbsp;<%# DataBinder.Eval( Container.DataItem, "Bike2" ) %></strong></div>
            </div>
        </a>
    </ItemTemplate>
</asp:Repeater>
