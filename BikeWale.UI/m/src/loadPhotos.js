...
function ShowLargePhotos(_thumbDiv) {
    ...
    $("#divPhotosOverlay").attr("style", "position:absolute;top:0;left:0;width:100%;height:" + (parseInt($("#divPhotos").height()) + 10) + "px;z-index;1000;background-color:black;filter:alpha(opacity=80);opacity:0.80;background-image: url('/m/images/loader.gif');background-position:center center;background-repeat:no-repeat;");
    LoadLargePhoto();
}