        ...
        private string SetBannerImage(EnumBikeBodyStyles enumBikeBodyStyles)
        {
            ...
            switch (enumBikeBodyStyles)
            {
                case EnumBikeBodyStyles.AllBikes:
                    ...
                    bannerImage = "https://imgd1.aeplcdn.com/0x0/bw/static/landing-banners/m/top-bikes-banner.jpg";
                    break;
                case EnumBikeBodyStyles.Cruiser:
                    pqSource = PQSourceEnum.Desktop_Generic_CruiserBikes;
                    bannerImage = "https://imgd1.aeplcdn.com/0x0/bw/static/landing-banners/m/cruiser-style-banner.jpg";
                    break;
                ...
                case EnumBikeBodyStyles.Scooter:
                    ...
                    bannerImage = "https://imgd1.aeplcdn.com/0x0/bw/static/landing-banners/m/scooter-style-banner.jpg";
                    break;
                case EnumBikeBodyStyles.Sports:
                    pqSource = PQSourceEnum.Desktop_Generic_SportsBikes;
                    bannerImage = "https://imgd1.aeplcdn.com/0x0/bw/static/landing-banners/m/sports-style-banner.jpg";
                    break;
                default:
                    pqSource = PQSourceEnum.Desktop_Generic_Bikes;
                    bannerImage = "https://imgd1.aeplcdn.com/0x0/bw/static/landing-banners/m/top-bikes-banner.jpg";
