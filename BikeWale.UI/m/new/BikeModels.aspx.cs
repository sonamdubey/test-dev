...
namespace Bikewale.Mobile.New
{
    ...
    public class NewBikeModels : PageBase //inherited page base class to move viewstate from top of the html page to the end
    {
        ...
        protected uint onRoadPrice, totalDiscountedPrice, price, bookingAmt, cityId, campaignId, manufacturerId, modelId, versionId, defaultVersionId, areaId, dealerId;
        ...
        private void FetchModelPageDetails()
        {
            try
            {
                using (IUnityContainer container = new UnityContainer())
                {
                    ...
                    modelPage = objBikeEntity.GetModelPageDetails(Convert.ToInt16(modelId), (int)versionId);
                    if (modelPage != null)
                    {
