        ...
        <div style="position: fixed; right: 5px; top: -5px; left: 5px; z-index: 10; display: block;" id="divFloat">
            <div style="padding:0px 0px;position:static;" class="box2 new-line5">
             <div id="divFloatBikeHeader" type="divBikeImage" style="border-bottom:1px solid #b3b4c6;">
                ...
                <div style="width:23px;height:24px;position:absolute;top:17px;z-index:1;right:-10px;background: url('http://img.carwale.com/bikewaleimg/images/icons-sheet.png?v=5.2') no-repeat scroll 0 0 transparent;background-position: 0 -1148px;"></div></div>
        ...
        <div id="divBikeHeader" type="divBikeImage" style="border-bottom:1px solid #b3b4c6;position:relative;">
            <div style="position:relative;" class="compareBikeContainer">
                <div class="compareBikeBox">
                    ...
                    <div id="divImgContainer" class="divImage"><a href="/m/<%=bikeDetails.Rows[0]["MakeMaskingName"] %>-bikes/<%=bikeDetails.Rows[0]["ModelMaskingName"] %>/" style="color:black;text-decoration:none;font-weight:bold;" class="ui-link"><img src="<%= !String.IsNullOrEmpty(bikeDetails.Rows[0]["HostURL"].ToString()) ? Bikewale.Utility.Image.GetPathToShowImages(bikeDetails.Rows[0]["OriginalImagePath"].ToString(),bikeDetails.Rows[0]["HostURL"].ToString(),Bikewale.Utility.ImageSize._210x118) :  "http://img.bikewale.com/bikewaleimg/common/nobike.jpg" %>"></a></div>
            ...
            <div style="width:23px;height:24px;position:absolute;top:51.5px;z-index:1;right:-10px;background: url('http://img.carwale.com/bikewaleimg/images/icons-sheet.png') no-repeat scroll 0 0 transparent;background-position: 0 -1148px;"></div></div>
            ...
            <div style="position:relative;" class="compareBikeContainer">
                <div class="compareBikeBox colorborderLt">
                    ...
                    <div id="divImgContainer1" class="divImage"><a href="/m/<%=bikeDetails.Rows[1]["MakeMaskingName"] %>-bikes/<%=bikeDetails.Rows[1]["ModelMaskingName"] %>/" style="color:black;text-decoration:none;font-weight:bold;" class="ui-link"><img src="<%= !String.IsNullOrEmpty(bikeDetails.Rows[1]["HostURL"].ToString()) ? Bikewale.Utility.Image.GetPathToShowImages(bikeDetails.Rows[1]["OriginalImagePath"].ToString() ,bikeDetails.Rows[1]["HostURL"].ToString(),Bikewale.Utility.ImageSize._210x118) :  "http://img.bikewale.com/bikewaleimg/common/nobike.jpg" %>"></a></div>
