        ...
        <div id="divBikeHeader" type="divBikeImage" style="border-bottom:1px solid #b3b4c6;position:relative;">
            <div style="position:relative;" class="compareBikeContainer">
                <div class="compareBikeBox">
                    <%--<div id="divImgContainer" class="divImage"><a href="/m/<%=bikeDetails.Rows[0]["MakeMaskingName"] %>-bikes/<%=bikeDetails.Rows[0]["ModelMaskingName"] %>/" style="color:black;text-decoration:none;font-weight:bold;" class="ui-link"><img src="<%= !String.IsNullOrEmpty(bikeDetails.Rows[0]["HostURL"].ToString()) ? Bikewale.Common.ImagingFunctions.GetPathToShowImages("/bikewaleimg/models/" + bikeDetails.Rows[0]["largePic"].ToString(),bikeDetails.Rows[0]["HostURL"].ToString()) :  "http://imgd1.aeplcdn.com/0x0/bw/static/design15/old-images/d/nobike.jpg" %>"></a></div>--%>
                    <div id="divImgContainer" class="divImage"><a href="/m/<%=bikeDetails.Rows[0]["MakeMaskingName"] %>-bikes/<%=bikeDetails.Rows[0]["ModelMaskingName"] %>/" style="color:black;text-decoration:none;font-weight:bold;" class="ui-link"><img src="<%= !String.IsNullOrEmpty(bikeDetails.Rows[0]["HostURL"].ToString()) ? Bikewale.Utility.Image.GetPathToShowImages(bikeDetails.Rows[0]["OriginalImagePath"].ToString(),bikeDetails.Rows[0]["HostURL"].ToString(),Bikewale.Utility.ImageSize._310x174) :  "http://imgd2.aeplcdn.com/0x0/bw/static/design15/old-images/d/nobike.jpg" %>"></a></div>
            ...
            <div style="position:relative;" class="compareBikeContainer">
                <div class="compareBikeBox colorborderLt">
                    <%--<div id="divImgContainer1" class="divImage"><a href="/m/<%=bikeDetails.Rows[1]["MakeMaskingName"] %>-bikes/<%=bikeDetails.Rows[1]["ModelMaskingName"] %>/" style="color:black;text-decoration:none;font-weight:bold;" class="ui-link"><img src="<%= !String.IsNullOrEmpty(bikeDetails.Rows[1]["HostURL"].ToString()) ? Bikewale.Common.ImagingFunctions.GetPathToShowImages("/bikewaleimg/models/",bikeDetails.Rows[1]["HostURL"].ToString()) + bikeDetails.Rows[1]["largePic"] :  "http://imgd3.aeplcdn.com/0x0/bw/static/design15/old-images/d/nobike.jpg" %>"></a></div>--%>
                    <div id="divImgContainer1" class="divImage"><a href="/m/<%=bikeDetails.Rows[1]["MakeMaskingName"] %>-bikes/<%=bikeDetails.Rows[1]["ModelMaskingName"] %>/" style="color:black;text-decoration:none;font-weight:bold;" class="ui-link"><img src="<%= !String.IsNullOrEmpty(bikeDetails.Rows[1]["HostURL"].ToString()) ? Bikewale.Utility.Image.GetPathToShowImages(bikeDetails.Rows[1]["OriginalImagePath"].ToString() ,bikeDetails.Rows[1]["HostURL"].ToString(),Bikewale.Utility.ImageSize._310x174) :  "http://imgd1.aeplcdn.com/0x0/bw/static/design15/old-images/d/nobike.jpg" %>"></a></div>
