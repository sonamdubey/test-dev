        ...
        <section class="container bg-white margin-bottom10">
            <div class="bg-white box-shadow">
                ...
                <div class="dealer-details position-rel pos-top-3 content-inner-block-20 font14">
                    ...
                    <a id="anchorGetDir" href="https://maps.google.com/maps?z=12&t=m&q=loc:<%= dealerLat %>,<%= dealerLong %>" target="_blank"><span class="bwmsprite get-direction-icon margin-right5"></span>Get directions</a>
                    <% } %>
                </div>
