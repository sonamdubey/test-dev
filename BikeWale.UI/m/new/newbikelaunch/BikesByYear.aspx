<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BikesByYear.aspx.cs" Inherits="Bikewale.Mobile.New.Newbikelaunch.BikesByYear" %>

<!DOCTYPE html>
<html>
<head>
    <title>New Bikes Launches by Year</title>
    ...
    <form id="form1" runat="server">
        ...
        <section>
            <div class="container bg-white card-bottom-margin">
                <h1 class="card-header">New Bike Launches in 2017</h1>
        ...
        <section>
            <div class="container bg-white box-shadow card-bottom-margin">
                <h2 class="padding-15-20 border-solid-bottom">Latest bikes in India - 2017</h2>
                <div class="padding-top10 padding-right20 padding-bottom10 padding-left20 border-light-bottom">
                    ...
                    <p id="brand-filter-selection" class="filter-selection-value text-truncate inline-block selection-auto-width">All brands</p>
                </div>
        ...
        <section>
            <div class="container bg-white box-shadow padding-top15 padding-bottom15 card-bottom-margin">
                <h2 class="padding-right20 padding-bottom15 padding-left20">Upcoming bikes in India</h2>
