                    ...
                    <ul class="text-center">
                        ...
                        <li>
                            <a href="/m/bajaj-bikes/">
                                <span class="brand-type">
                                        <span class="lazy brandlogosprite brand-bajaj" data-original="http://imgd3.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/hero-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-hero" data-original="http://imgd3.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/tvs-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-tvs" data-original="http://imgd3.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/yamaha-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-yamaha" data-original="http://imgd1.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                    ...
                    <ul id="more-brand-nav" class="brand-style-moreBtn brandTypeMore border-top1 padding-top25 text-center hide">
                        <li>
                            <a href="/m/aprilia-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-aprilia" data-original="http://imgd1.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/benelli-bikes/">
                                <span class="brand-type">
                                        <span class="lazy brandlogosprite brand-benelli" data-original="http://imgd1.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/bmw-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-bmw" data-original="http://imgd4.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/ducati-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-ducati" data-original="http://imgd4.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/harleydavidson-bikes/">
                                <span class="brand-type">
                                        <span class="lazy brandlogosprite brand-harley" data-original="http://imgd4.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/indian-bikes/">
                                <span class="brand-type">
                                        <span class="lazy brandlogosprite brand-indian" data-original="http://imgd2.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/kawasaki-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-kawasaki" data-original="http://imgd2.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/ktm-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-ktm" data-original="http://imgd2.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/lml-bikes/">
                                <span class="brand-type">
                                        <span class="lazy brandlogosprite brand-lml" data-original="http://imgd2.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/yo-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-yo" data-original="http://imgd3.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                            <a href="/m/mv-agusta-bikes/">
                                <span class="brand-type">
                                    <span class="lazy brandlogosprite brand-agusta" data-original="http://imgd3.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                </span>
                        ...
                        <li>
                             <a href="/m/um-bikes/">
                                 <span class="brand-type">
                                     <span class="lazy brandlogosprite brand-um" data-original="http://imgd3.aeplcdn.com/0x0/bw/static/sprites/m/brand-type-sprite.png?<%= staticFileVersion %>"></span>
                                 </span>
