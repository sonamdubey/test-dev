...
<head>
    ...
    <style type="text/css">
        ...
        /* similar bikes */
        .swiper-type-similar .swiper-btn-block {
	        padding-bottom: 15px;
        }
        .swiper-type-similar .right-arrow {
	        width: 8px;
	        height: 12px;
	        background-position: -182px -394px;
	        position: absolute;
	        right: 18px;
	        top: 13px;
	        transform: scale(0.8);
        ...
        .compare-sm {
	        width: 17px;
	        height: 12px;
	        background-position: -173px -596px;
	        position: relative;
	        top: 1px;
	        margin-right: 5px;
        }
                        ...
                        <div class="swiper-container card-container swiper-type-similar">
                            <div class="swiper-wrapper">
                                <% if (similarBikes != null && similarBikes.Bikes != null && similarBikes.Bikes.Count() > 0)
                                {
                                    ...
                                    { 
                                        var bikeUrl = String.Format("/m{0}", Bikewale.Utility.UrlFormatter.BikePageUrl(bike.MakeBase.MaskingName, bike.ModelBase.MaskingName)); %>                                        <div class="swiper-slide">
