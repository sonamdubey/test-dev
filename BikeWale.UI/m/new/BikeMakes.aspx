                        ...
                        <div class="container">
                            <table style="width:100%;" cellpadding="0" cellspacing="0">
                                <tr>
                                    ...
                                    <td style="width:100px;"><img src="<%# MakeModelVersion.GetModelImage(DataBinder.Eval(Container.DataItem,"SeriesHostUrl").ToString(), DataBinder.Eval(Container.DataItem,"OriginalImagePath").ToString(),Bikewale.Utility.ImageSize._110x61) %>" title='<%# DataBinder.Eval(Container.DataItem,"MakeBase.MakeName") + " " + DataBinder.Eval(Container.DataItem,"ModelSeries.SeriesName") %>' alt="<%# DataBinder.Eval(Container.DataItem,"MakeBase.MakeName") + " " + DataBinder.Eval(Container.DataItem,"ModelSeries.SeriesName") %>" width="90" /></td>
