...
<style type="text/css">
    ...
    <div class="padding5">
        <div id="br-cr">
            ...
            <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
            <a href="/m/<%=objModelEntity.MakeBase.MaskingName %>-bikes/" class="normal" itemprop="url"><span itemprop="title"><%=objModelEntity.MakeBase.MakeName %> Bikes</span></a> </span>&rsaquo; 
            <span itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
            <a href="/m/<%=objModelEntity.MakeBase.MaskingName %>-bikes/<%= objModelEntity.MaskingName %>/" class="normal" itemprop="url"><span itemprop="title"><%=objModelEntity.MakeBase.MakeName %> <%= objModelEntity.ModelName %></span></a></span> &rsaquo; 
