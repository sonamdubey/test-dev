...
<head>
    ...
    <!--
    <link rel="stylesheet" href="<%= staticUrl != "" ? "https://st1.aeplcdn.com" + staticUrl : "" %>/m/css/bw-new-style.css?<%= staticFileVersion %>" />
    -->
    <style type="text/css">
