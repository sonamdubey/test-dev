		...
		<div class="bg-white padding-10-5 bottom-shadow margin-bottom10">
			<div class="bike-details margin-bottom15">
				...
				<p class="font16 text-bold padding-left15 padding-right15">
					...
					<a href="javascript:void(0)" rel="nofollow" pqSourceId="<%= (int)Bikewale.Entities.PriceQuote.PQSourceEnum.Mobile_DPQ_Quotation %>" modelId="<%= objPriceQuote.objModel.ModelId %>" class="getquotation" ismodel="true"><span class="bwmsprite loc-change-blue-icon"></span></a>
				</p>
			</div>
			<script type="text/javascript">                
				var dropdown = {
