...
<div class="padding5">
        ...
        <div class="box1 new-line10">
            ...
            <div class="full-border bike-img margin-top-10">
                ...
                <img src="<%= Bikewale.Utility.Image.GetPathToShowImages(_objPQ.objQuotation.OriginalImagePath,_objPQ.objQuotation.HostUrl,Bikewale.Utility.ImageSize._210x118) %>" alt="" title="" border="0" />
            </div>
