    ...
    public class Quotation : System.Web.UI.Page
    {
        ...
        private void SavePriceQuote(object sender, EventArgs e)
        {
            ...
            finally
            {
                ...
                {
                    // Save pq cookie                    
                    Response.Redirect("/m/pricequote/dealer/?MPQ=" + EncodingDecodingHelper.EncodeTo64(PriceQuoteQueryString.FormQueryString(cityId.ToString(), objPQOutput.PQId.ToString(), areaId.ToString(), selectedVersionId.ToString(), objPQOutput.DealerId.ToString())), false);
                    HttpContext.Current.ApplicationInstance.CompleteRequest();
                    this.Page.Visible = false;
                }
        ...
        private void BindAlternativeBikeControl(string versionId)
        {
            ...
            {
                ctrlAlternateBikes.VersionId = Convert.ToUInt32(versionIdd);
