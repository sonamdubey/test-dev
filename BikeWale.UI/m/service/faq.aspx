...
<head>
    ...
    <style type="text/css">
    .faq-top-banner { background: #57605e url(http://imgd3.aeplcdn.com/0x0/bw/static/landing-banners/m/m-faqs-banner.jpg) no-repeat center center; background-size: cover; height: 130px; }
	        ...
	        <div class="container margin-top10">
    	        <div class="grid-12">
                    ...
                    <div class="faq-content content-box-shadow content-inner-block-10 margin-bottom10" id="faq5">
                        ...
                        <p>If you’ve got a liquid-cooled motorcycle and you’ve got a puddle of green under your motorcycle, that means you’re leaking coolant. There is a coolant reservoir somewhere on the motorcycle – find it and look at the level. If it is low, then you’ll need to top it up. If you’re nowhere near a service centre, first wait for the bike to cool down. The coolant system functions under high pressure, so if you open it while it is hot, you’re likely to get steam burns – think ‘pressure cooker’. Top up the coolant to the level that is designated ‘maximum’ on the reservoir with bottled water. Coolant is nothing but water mixed with anti-freeze, so this will do in an emergency. Check the radiator level as well – remember to open it only after the motorcycle has cooled down. If bottled water isn’t available, any water will do, but the cleaner the better. Remember to try and find a clear route that doesn’t make you ride at low speeds or stop, and remember to ride at low revs and small throttle openings, to help the motorcycle keep cool. There’s also the obvious: if it is the middle of the day, wait until it is cooler to make your run to the service centre.</p>
                    </div>
