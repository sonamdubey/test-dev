    ...
    public class ServiceCenterDetails : System.Web.UI.Page
    {
        ...
        private void BindControls()
        {
            try
            {
                ...
                ctrlDealerCard.widgetHeading = string.Format("{0} showrooms in {1}", makeName, serviceCity);
                ...
                if (ctrlusedBikeModel != null)
                {
                    ...
                    ctrlusedBikeModel.WidgetTitle = string.Format("Second Hand Bikes in {0}", cityId > 0 ? serviceCity : "India");
