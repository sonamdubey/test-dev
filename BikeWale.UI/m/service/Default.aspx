...
<head>
    <%
        ...
        canonical = "https://www.bikewale.com/bike-service-centers/";
                ...
                <div id="brand-type-container" class="brand-type-container">
                        <ul class="text-center">
                           <%foreach(var bikebrand in TopMakeList) {%>
                                      <li>
                                        <a href="/m/bike-service-centers/<%=bikebrand.MaskingName %>/" title="<%=bikebrand.MakeName %> Service Center in India">
            ...
            $("input[type='button'].locator-submit-btn").click(function () {
                ...
                if (!isNaN(selMakeId) && selMakeId != "0") {
                    if (!isNaN(selCityId) && selCityId != "0") {
                        ...
                        window.location.href = "/m/bike-service-centers/" + ddlmakemasking + "/" + ddlcityMasking + "/";
                    }
                    else {
