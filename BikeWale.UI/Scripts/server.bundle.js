...
function extractPageNoFromURL(url) {
	...
	if (matches) {
		...
		/*if(matches[0] == 8887)
  	return 1;
  console.log('in commonFunc - '+matches[0])*/
		return matches[0];
	} else return 1; // no /page/no in url means first page
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Router__ = __webpack_require__(141);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Link__ = __webpack_require__(67);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__IndexLink__ = __webpack_require__(137);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__withRouter__ = __webpack_require__(152);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__IndexRedirect__ = __webpack_require__(138);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__IndexRoute__ = __webpack_require__(139);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__Route__ = __webpack_require__(140);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__RouterContext__ = __webpack_require__(33);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__match__ = __webpack_require__(150);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__useRouterHistory__ = __webpack_require__(74);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__applyRouterMiddleware__ = __webpack_require__(143);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__browserHistory__ = __webpack_require__(144);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__hashHistory__ = __webpack_require__(148);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__createMemoryHistory__ = __webpack_require__(71);
...
var _ArticleList = __webpack_require__(90);

var _ArticleList2 = _interopRequireDefault(_ArticleList);

var _NewsPagination = __webpack_require__(92);
...
var _NewBikes = __webpack_require__(51);
...
var _commonVar = __webpack_require__(10);
...
var ArticleListComponent = function (_React$Component) {
    ...
    function ArticleListComponent(props) {
        ...
        _this.onBackButtonClickEvent = _this.onBackButtonClickEvent.bind(_this);
    ...
    _createClass(ArticleListComponent, [{
        ...
        value: function componentDidMount() {
            window.addEventListener('popstate', this.onBackButtonClickEvent);
            //articleList has been fetched
        ...
        value: function componentWillUnmount() {
            window.removeEventListener('popstate', this.onBackButtonClickEvent);
        }
    }, {
        ...
        key: 'onBackButtonClickEvent',
        value: function onBackButtonClickEvent() {
        ...
        value: function onArticleClickEvent(ArticleInitialData) {
            ...
            // TODO see if url contains /m/news/
            this.props.router.push({ pathname: ArticleInitialData.ArticleUrl, query: {} });
            //this.props.router.push({pathname : MOBILE_URL_PREFIX + NEWS_URL_PREFIX + '/' + ArticleInitialData.ArticleUrl+'.html' , query : {}}) 
            //TODO change url 
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        'title',
                        null,
                        'Bike News - Latest Indian Bike News & Views | BikeWale'
                    )
                ),
                _react2.default.createElement(
                    'div',
...
var _AsyncUtils = __webpack_require__(104);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__getRouteParams__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ContextUtils__ = __webpack_require__(31);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__combineReducers__ = __webpack_require__(85);
...
var _actionTypes = __webpack_require__(46);
...
var fetchNewsArticleDetail = function fetchNewsArticleDetail(articleInitialData) {
	// article data is passed as argument,if no data then pass null
	// TODO fetch article according to url
	return function (dispatch) {

		var url = null;
		if (articleInitialData) {
			if ((0, _commonFunc.isInt)(articleInitialData)) {
				// only basicId passed
				dispatch({ type: _actionTypes.newsDetailAction.FETCH_NEWSDETAIL });
				url = _commonVar.apiBaseUrl + 'api/pwa/id/' + articleInitialData + '/page/';
			} else {
				dispatch({ type: _actionTypes.newsDetailAction.FETCH_NEWSDETAIL_WITH_INITIAL_DATA, payload: articleInitialData });
				url = _commonVar.apiBaseUrl + articleInitialData.ArticleApi;
			}
		}
		/*else {
  	//TODO whether to push any url 
  	dispatch({type:newsDetailAction.FETCH_NEWSDETAIL});
		...
		xhr.onreadystatechange = function () {
			if (xhr.readyState == 4) {
				if (xhr.status == 200) dispatch({ type: _actionTypes.newsDetailAction.FETCH_NEWSDETAIL_SUCCESS, payload: JSON.parse(xhr.responseText) });else dispatch({ type: _actionTypes.newsDetailAction.FETCH_NEWSDETAIL_FAILURE });
			}
		};
		//'http://127.0.0.1:8887/news/api/newsdetail.json'
		xhr.open('GET', url);
		xhr.send();
	};
};

var fetchNewBikesListDataForNewsDetail = function fetchNewBikesListDataForNewsDetail(basicId) {
	// basicId is the id of the news item. null for newsList page
	return function (dispatch) {
		var url; // = 'http://172.16.2.171:9011/api/pwa/bikelists/id/0/page/'
		if (parseInt(basicId) > 0) {
			url = 'http://localhost:9011/api/pwa/bikelists/id/' + basicId + '/page/';
		} else {
			url = 'http://localhost:9011/api/pwa/bikelists/id/0/page/';
		}

		var xhr = new XMLHttpRequest();
		xhr.onreadystatechange = function () {
			if (xhr.readyState == 4) {
				if (xhr.status == 200) dispatch({ type: _actionTypes.newBikesListAction.FETCH_NEW_BIKES_LIST_SUCCESS_FOR_NEWS_DETAIL, payload: JSON.parse(xhr.responseText) });else dispatch({ type: _actionTypes.newBikesListAction.FETCH_NEW_BIKES_LIST_FAILURE_FOR_NEWS_DETAIL });
			}
		};
		xhr.open('GET', url);
		xhr.send();
		dispatch({ type: _actionTypes.newBikesListAction.FETCH_NEW_BIKES_LIST_FOR_NEWS_DETAIL });
	};
};

var fetchRelatedModelObjectForNewsDetail = function fetchRelatedModelObjectForNewsDetail(basicId) {
	return function (dispatch) {
		//TODO use basicId for api call
		console.log('in fetchRelatedModelObjectForNewsDetail');
		console.log(basicId);
		var url = 'http://localhost:9011/api/pwa/bikeinfo/id/' + basicId + '/page/';
		var xhr = new XMLHttpRequest();
		xhr.onreadystatechange = function () {
			if (xhr.readyState == 4) {
				if (xhr.status == 200) dispatch({ type: _actionTypes.modelObjectAction.FETCH_MODEL_OBJECT_SUCCESS_FOR_NEWS_DETAIL, payload: JSON.parse(xhr.responseText) });else dispatch({ type: _actionTypes.modelObjectAction.FETCH_MODEL_OBJECT_FAILURE_FOR_NEWS_DETAIL });
			}
		};

		xhr.open('GET', url);
		xhr.send();
		dispatch({ type: _actionTypes.modelObjectAction.FETCH_MODEL_OBJECT_FOR_NEWS_DETAIL });
	};
};
...
var _ModelSlug = __webpack_require__(91);
...
var ArticleDetail = function (_React$Component) {
    ...
    _createClass(ArticleDetail, [{
        ...
        value: function componentDidMount() {
            ...
            /*if initialData==null, then it is the first refresh. so basicId will be present in the store
            else if not null then basicId within initialData
            */
            // NEVER WILL THE STORE BE COMPLETELY EMPTY -- WITHOUT BASICID
            var basicId;
            if (this.props.ArticleDetailData) {
                if (this.props.ArticleDetailData.InitialData) basicId = this.props.ArticleDetailData.InitialData.BasicId;else if (this.props.ArticleDetailData.ArticleDetail) basicId = this.props.ArticleDetailData.ArticleDetail.BasicId;
            }
            ...
            if (this.props.ArticleDetailData && this.props.ArticleDetailData.Status == _commonVar.Status.Fetched) {
                ...
                //TODO how much to be server rendered
                if (this.props.RelatedModelInfo && this.props.RelatedModelObject.Status !== _commonVar.Status.Fetched) {
                    this.props.fetchRelatedModelObject(basicId);
                }
                if (this.props.NewBikesListData && this.props.RelatedModelObject.Status !== _commonVar.Status.Fetched) {
                    this.props.fetchNewBikesListData(basicId);
                }
            } else {
                // data that is purely client rendered
                if (!this.props.ArticleDetailData.InitialData) this.props.fetchArticleDetail(); //initialdata is never null as initialData is always set from previous page or entire store is server rendered
                //if initialdata != null then fetchArticleDetail already performed by previous page
                this.props.fetchRelatedModelObject(basicId);
                this.props.fetchNewBikesListData(basicId);
            }

            window.scrollTo(0, 0); // TODO scroll to top required
        ...
        /* extractBasicIdFromArticleUrl() {
             ...
             console.log('in extractbasicid')
             if(matches) {
                 var basicId = matches[1]; // whole matching url in matches[0]
                 this.fetchArticleDetail(basicId);
                 this.fetchRelatedModelObject(basicId);
                 this.fetchNewBikesListData(basicId);
             }
         }*/
        ...
        key: 'onBackButtonClickEvent',
        value: function onBackButtonClickEvent() {
            //this.extractBasicIdFromArticleUrl();
            var basicId;
            var url = window.location.pathname;
            var regexp = /\/m\/news\/(\d+)-.*\.html/;
            var matches = url.match(regexp);
            if (matches) {
                var basicId = matches[1]; // whole matching url in matches[0]
                this.props.fetchArticleDetail(basicId);
                this.props.fetchRelatedModelObject(basicId);
                this.props.fetchNewBikesListData(basicId);
            }
        }
        ...
        value: function onArticlePaginationClickEvent(articleInitialData) {
            // TODO articleurl has /m/news/ prefix ?
            //this.props.router.push({pathname : MOBILE_URL_PREFIX + NEWS_URL_PREFIX + '/' + articleInitialData.ArticleUrl , query : {}}) //TODO fix url
            this.props.router.push({ pathname: articleInitialData.ArticleUrl, query: {} }); //TODO fix url
            this.props.fetchArticleDetail(articleInitialData);
            this.props.fetchNewBikesListData(articleInitialData.BasicId); // TODO pass basicId
            console.log('in onArticlePaginationClickEvent');
            console.log(articleInitialData);
        ...
        value: function renderArticleContent(articleDetail, initialData) {
            /*
            <img alt="Spec comparison: Triumph Street Twin vs Ducati Scrambler - BikeWale News" title="Spec comparison: Triumph Street Twin vs Ducati Scrambler - BikeWale News" src="https://imgd.aeplcdn.com//640x348//bw/ec/22068/Action-67335.jpg?wm=0&amp;t=121231680&amp;t=121231680">
            <img alt="BMW S1000 range launched in India at Rs 16.90 lakh - BikeWale News" title="BMW S1000 range launched in India at Rs 16.90 lakh - BikeWale News" src="https://imgd.aeplcdn.com//640x348//bw/ec/28576/BMW-S1000-RR-Front-threequarter-94301.jpg?wm=2">
            */

            if (!articleDetail && initialData) {
                return _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(_ArticleDetailContent2.default, { htmlContent: null, initialData: initialData })
                );
            } else if (articleDetail) {
                return _react2.default.createElement(
                    'div',
                    null,
                    _react2.default.createElement(_ArticleDetailContent2.default, { htmlContent: articleDetail.Content, initialData: initialData }),
                    this.renderModelSlug(),
                    _react2.default.createElement(_SocialMediaSlug2.default, { shareUrl: articleDetail.ShareUrl }),
        ...
        value: function renderModelSlug() {
            if (!this.props.RelatedModelObject || this.props.RelatedModelObject.Status !== _commonVar.Status.Fetched) return false;
        ...
        value: function render() {
            ...
            //TODO handle cases carefully
            if (!componentData.InitialData) {
                //TODO fix Status.error handling
                ...
                componentData.InitialData = (0, _commonFunc.mapNewsArticleDataToInitialData)(componentData.ArticleDetail);
                if (!componentData.InitialData) // articleDetail does not have data
                    return _react2.default.createElement(_Spinner2.default, null);
            }

            var articleInitialData = componentData.InitialData;
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "grid-4" },
                        _react2.default.createElement("a", { href: "https://www.carwale.com/m/", target: "_blank", className: "bwmsprite cw-footer-icon", title: "CarWale" }),
                        _react2.default.createElement(
                            "p",
                    ...
                    _react2.default.createElement(
                        "div",
                        { className: "grid-4" },
                        _react2.default.createElement("a", { href: "https://m.cartrade.com/", target: "_blank", className: "bwmsprite ct-footer-icon", title: "CarTrade" })
                    ),
...
/*issue :
1. css issue with text align of bottom 2 texts. no solid line above it.
*/
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        _reactRouter.Link,
                        { to: '/', className: 'header-link inline-block' },
                        _react2.default.createElement('span', { className: 'bwm-logo' })
                    )
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(
                        'div',
                        { className: 'global-search cur-pointer', id: 'global-search' },
                        _react2.default.createElement('span', { className: 'bwmsprite search-bold-icon' })
                    ),
                    _react2.default.createElement(
                        'div',
                        { className: 'global-location cur-pointer' },
...
var NavigationDrawer = function (_React$Component) {
    ...
    function NavigationDrawer() {
        ...
        return _possibleConstructorReturn(this, (NavigationDrawer.__proto__ || Object.getPrototypeOf(NavigationDrawer)).apply(this, arguments));
    }
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    ...
                                    _react2.default.createElement(
                                        'a',
                                        { href: '/m/dealer-showroom-locator/' },
                                        'Locate Dealer'
                                    )
                                ),
                                _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/m/used/sell/', className: 'nav-item' },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/m/trackday2016/', className: 'nav-item' },
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/m/users/login.aspx', className: 'nav-item' },
                        ...
                        _react2.default.createElement(
                            'li',
                            { className: 'padding-top10 padding-bottom15' },
                            _react2.default.createElement('div', { className: 'border-solid-top' })
                        ),
                        _react2.default.createElement(
                            'li',
                            null,
                            _react2.default.createElement(
                                'p',
                                { className: 'font12 text-light-grey padding-left15' },
                                'Profile'
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/users/MyContactDetails.aspx', className: 'nav-item' },
                                _react2.default.createElement('span', { className: 'bwmsprite myBikeWale-icon' }),
                                _react2.default.createElement(
                                    'span',
                                    null,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/mybikewale/myinquiries/', className: 'nav-item' },
                                _react2.default.createElement('span', { className: 'bwmsprite inquiry-icon' }),
                                _react2.default.createElement(
                                    'span',
                                    null,
                                    'My Inquiries'
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/users/newssubscription.aspx', className: 'nav-item' },
                                _react2.default.createElement('span', { className: 'bwmsprite newsletter-icon' }),
                                _react2.default.createElement(
                                    'span',
                                    null,
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/mybikewale/changepassword/', className: 'nav-item' },
                                _react2.default.createElement('span', { className: 'bwmsprite password-icon' }),
                                _react2.default.createElement(
                                    'span',
                                    null,
                                    'Change password'
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'a',
                                { href: '/m/users/login.aspx?logout=logout&ReturnUrl=/m/', className: 'nav-item' },
                                _react2.default.createElement('span', { className: 'bwmsprite logout-icon' }),
                                _react2.default.createElement(
                                    'span',
                                    null,
                                    'Logout'
        ...
        value: function renderListItem(item) {
            ...
            if (item.Price == "") {
                ...
                priceHtml = _react2.default.createElement(
                    "div",
                    null,
                    _react2.default.createElement("span", { className: "bwmsprite inr-xsm-icon" }),
                    "\xA0",
                    _react2.default.createElement(
                        "span",
                        { className: "value-size-16" },
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement("img", { src: item.ImgUrl, alt: item.Name, border: "0" })
                        ),
                        _react2.default.createElement(
                            "div",
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    newBikesData.BikesList.map(function (item) {
...
var _reactSideEffect = __webpack_require__(153);

var _reactSideEffect2 = _interopRequireDefault(_reactSideEffect);

var _deepEqual = __webpack_require__(100);

var _deepEqual2 = _interopRequireDefault(_deepEqual);

var _HelmetUtils = __webpack_require__(128);

var _HelmetConstants = __webpack_require__(60);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_storeShape__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__PropTypes__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ContextUtils__ = __webpack_require__(31);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__PatternUtils__ = __webpack_require__(13);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_history_lib_useQueries__ = __webpack_require__(55);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_history_lib_useBasename__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_history_lib_createMemoryHistory__ = __webpack_require__(109);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__useRouterHistory__ = __webpack_require__(74);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__routerWarning__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__computeChangedRoutes__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__TransitionUtils__ = __webpack_require__(142);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__isActive__ = __webpack_require__(149);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__getComponents__ = __webpack_require__(146);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__matchRoutes__ = __webpack_require__(151);
...
/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["ServerRouterWrapper"] = __webpack_require__(99);
...
var fetchNewsArticleList = function fetchNewsArticleList(pageNo) {
	return function (dispatch) {
		//API -> http://172.16.2.171:9011/api/pwa/cat/2,19/posts/10/pn/1/
		console.log('in fetchNewsArticleList');
		if (pageNo == -1) {
			pageNo = (0, _commonFunc.extractPageNoFromURL)(window.location.href);
		}
		var method = 'GET';
		var url = _commonVar.apiBaseUrl + 'api/pwa/cat/2,19/posts/' + _commonVar.NewsArticlesPerPage + '/pn/' + pageNo + '/'; // TODO remove hardcoded api
		//var url = "http://127.0.0.1:8887/news/api/newslistapi.json"
		//TODO use specific api url with page no as parameter

		var xhr = new XMLHttpRequest();
		xhr.onreadystatechange = function () {
			if (xhr.readyState == 4) {
				if (xhr.status == 200) dispatch({ type: _actionTypes.newsListAction.FETCH_NEWSLIST_SUCCESS, payload: JSON.parse(xhr.responseText) });else dispatch({ type: _actionTypes.newsListAction.FETCH_NEWSLIST_FAILURE }); // TODO hit api again on failure
			}
		};
		xhr.open(method, url);
		xhr.send();
		dispatch({ type: _actionTypes.newsListAction.FETCH_NEWSLIST });
	};
};

var fetchNewBikesListDataForNewsList = function fetchNewBikesListDataForNewsList(basicId) {
	// TODO basicId is the id of the news item. null for newsList page
	return function (dispatch) {
		var url;
		if (parseInt(basicId) > 0) {
			url = 'http://172.16.2.171:9011/api/pwa/bikelists/id/' + basicId + '/page/';
		} else {
			url = 'http://172.16.2.171:9011/api/pwa/bikelists/id/0/page/';
		}

		var xhr = new XMLHttpRequest();
		xhr.onreadystatechange = function () {
			if (xhr.readyState == 4 && xhr.status == 200) {
				if (xhr.status == 200) dispatch({ type: _actionTypes.newBikesListAction.FETCH_NEW_BIKES_LIST_SUCCESS_FOR_NEWS_LIST, payload: JSON.parse(xhr.responseText) });else dispatch({ type: _actionTypes.newBikesListAction.FETCH_NEW_BIKES_LIST_FAILURE_FOR_NEWS_LIST });
			}
		};
		xhr.open('GET', url);
		xhr.send();
		dispatch({ type: _actionTypes.newBikesListAction.FETCH_NEW_BIKES_LIST_FOR_NEWS_LIST });
	};
};
		...
		value: function render() {
			...
			if (this.props.initialData) {
				return _react2.default.createElement(
					...
					_react2.default.createElement('img', { alt: this.props.initialData.Title, title: this.props.initialData.Title, src: this.props.initialData.HostUrl + this.props.initialData.LargePicUrl }),
    ...
    _createClass(ArticleList, [{
        ...
        value: function onArticleClickEvent(article, event) {
            ...
            /*{
                ...
                ImageUrl : article.HostUrl+article.LargePicUrl
            }*/
            this.props.onArticleClickEvent(articleInitialData);
        }
    }, {
        key: 'renderArticleContent',
        value: function renderArticleContent(article) {
            //TODO display date
            return _react2.default.createElement(
                'div',
        ...
        value: function renderArticleLinkTag(article) {
            //TODO change to dependence on categoryId
            //if(article.categoryId == 1) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.props.articleList.map(function (article) {
                    return this.renderArticleLinkTag(article);
                }.bind(this))
            );
        }
    }]);
	...
	_createClass(ModelSlug, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						' ',
						_react2.default.createElement('span', { className: 'bwmsprite inr-12-grey' }),
						usedBikesLink.Price
					)
				),
  	...
  	switch(type) {
  		...
  		case 'videos' : return {
  							...
  							'linkTitle' : 'User Reviews',
  							'className' : 'user-reviews-sm'
  						}
  	}
  	return null;
  }*/
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'div',
							null,
							_react2.default.createElement('span', { className: 'bwmsprite inr-sm-icon' }),
							_react2.default.createElement(
								'span',
...
var NewsPagination = function (_React$Component) {
    ...
    _createClass(NewsPagination, [{
        ...
        value: function onClickLink(pageNo) {
            //event.preventDefault();
            console.log('in onclicklink - newspagination - ' + pageNo);
        ...
        value: function renderPreviousPageArrow(pageNo) {
            if (pageNo == 1) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactRouter.Link, { to: '', className: 'bwmsprite bwsprite prev-page-icon' })
                );
            } else {
                ...
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactRouter.Link, { to: '/m/news/page/' + goToPageNo + '/', className: 'bwmsprite bwsprite prev-page-icon', onClick: this.onClickLink.bind(this, goToPageNo) })
                );
            }
        }
    }, {
        ...
        value: function renderNextPageArrow(pageNo, maxNoOfPages) {
            if (pageNo == maxNoOfPages) {
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactRouter.Link, { to: '', className: 'bwmsprite bwsprite next-page-icon' })
                );
            } else {
                var goToPageNo = parseInt(pageNo) + 1;
                return _react2.default.createElement(
                    ...
                    _react2.default.createElement(_reactRouter.Link, { to: '/m/news/page/' + goToPageNo + '/', className: 'bwmsprite bwsprite next-page-icon', onClick: this.onClickLink.bind(this, goToPageNo) })
                );
            }
        }
    }, {
...
var _NavigationDrawer = __webpack_require__(50);
...
//import AdUnitTop from '../components/AdUnitTop'
...
var _ArticleListComponent = __webpack_require__(22);

var _ArticleListComponent2 = _interopRequireDefault(_ArticleListComponent);

var _newsArticleListActionCreators = __webpack_require__(86);

var _newsArticleDetailActionCreators = __webpack_require__(45);

var _immutableWrapperContainer = __webpack_require__(52);
...
var mapStateToProps = function mapStateToProps(store) {
	...
	return {
		ArticleListData: store.getIn(['NewsReducer', 'NewsArticleListReducer', 'ArticleListData']),
		NewBikesListData: store.getIn(['NewsReducer', 'NewsArticleListReducer', 'NewBikesListData'])
	};
};

var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		fetchArticleList: (0, _Redux.bindActionCreators)(_newsArticleListActionCreators.fetchNewsArticleList, dispatch),
		fetchArticleDetail: (0, _Redux.bindActionCreators)(_newsArticleDetailActionCreators.fetchNewsArticleDetail, dispatch),
		fetchNewBikesListData: (0, _Redux.bindActionCreators)(_newsArticleListActionCreators.fetchNewBikesListDataForNewsList, dispatch)
	};
};

var NewsArticleListContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)((0, _immutableWrapperContainer.toJS)(_ArticleListComponent2.default));

exports.default = NewsArticleListContainer;
...
var _ArticleDetailComponent = __webpack_require__(47);
...
var mapStateToProps = function mapStateToProps(store) {
	return {
		ArticleDetailData: store.getIn(['NewsReducer', 'NewsDetailReducer', 'ArticleDetailData']),
		RelatedModelObject: store.getIn(['NewsReducer', 'NewsDetailReducer', 'RelatedModelObject']),
		NewBikesListData: store.getIn(['NewsReducer', 'NewsDetailReducer', 'NewBikesListData'])
	};
};
...
var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	return {
		fetchArticleDetail: (0, _Redux.bindActionCreators)(_newsArticleDetailActionCreators.fetchNewsArticleDetail, dispatch),
		fetchNewBikesListData: (0, _Redux.bindActionCreators)(_newsArticleDetailActionCreators.fetchNewBikesListDataForNewsDetail, dispatch),
		fetchRelatedModelObject: (0, _Redux.bindActionCreators)(_newsArticleDetailActionCreators.fetchRelatedModelObjectForNewsDetail, dispatch)
	};
};

var newsDetailContainer = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)((0, _immutableWrapperContainer.toJS)(_ArticleDetailComponent2.default));
...
var _NewsArticleListContainer = __webpack_require__(95);

var _NewsArticleListContainer2 = _interopRequireDefault(_NewsArticleListContainer);

var _NewsDetailContainer = __webpack_require__(96);

var _NewsDetailContainer2 = _interopRequireDefault(_NewsDetailContainer);
...
function getRoutes() {
	...
	return _react2.default.createElement(
		_reactRouter.Route,
		{ path: _commonVar.MOBILE_URL_PREFIX + _commonVar.NEWS_URL_PREFIX, component: _App2.default },
		_react2.default.createElement(_reactRouter.IndexRoute, { component: _NewsArticleListContainer2.default }),
		_react2.default.createElement(_reactRouter.Route, { path: 'index.html', component: _NewsArticleListContainer2.default }),
		_react2.default.createElement(_reactRouter.Route, { path: 'page/:pageNo', component: _NewsArticleListContainer2.default }),
		_react2.default.createElement(_reactRouter.Route, { path: '*.html', component: _NewsDetailContainer2.default })
	);
}
...
var _ServerAppComponent = __webpack_require__(98);
...
var ServerRouterWrapper = function (_React$Component) {
		...
		_createClass(ServerRouterWrapper, [{
				...
				value: function render() {
						...
						var history = (0, _reactRouter.createMemoryHistory)(url); // TODO change url passed to createMemoryHistory
						//var childComponent = ChildComponents[this.props.ChildComponentName];
						var childComponentProps = Object.assign({}, this.props);
						//delete childComponentProps.ChildComponentName;

						//var bindPropsToComponent = (Component) => (<Component {...childComponentProps}/>) ;
						...
						return _react2.default.createElement(
								...
								_react2.default.createElement(
										_reactRouter.Route,
										{ path: '/m/news/', component: _ServerAppComponent2.default },
										_react2.default.createElement(_reactRouter.IndexRoute, { component: function component() {
														return _react2.default.createElement(_ArticleListComponent2.default, childComponentProps);
												} }),
										_react2.default.createElement(_reactRouter.Route, { path: 'index.html', component: function component() {
														return _react2.default.createElement(_ArticleListComponent2.default, childComponentProps);
												} }),
										_react2.default.createElement(_reactRouter.Route, { path: 'page/:pageNo', component: function component() {
														return _react2.default.createElement(_ArticleListComponent2.default, childComponentProps);
												} }),
										_react2.default.createElement(_reactRouter.Route, { path: '*.html', component: function component() {
														return _react2.default.createElement(_ArticleDetailComponent2.default, childComponentProps);
												} })
								)
						);
				}
...
var strictUriEncode = __webpack_require__(171);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_Subscription__ = __webpack_require__(64);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_storeShape__ = __webpack_require__(65);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_shallowEqual__ = __webpack_require__(136);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mapDispatchToProps__ = __webpack_require__(131);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__routerWarning__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_invariant__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Redirect__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__InternalPropTypes__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_invariant___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_invariant__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__RouteUtils__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__InternalPropTypes__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__createTransitionManager__ = __webpack_require__(73);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__InternalPropTypes__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RouterContext__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__RouteUtils__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__RouterUtils__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__routerWarning__ = __webpack_require__(15);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AsyncUtils__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__RouterContext__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__routerWarning__ = __webpack_require__(15);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_history_lib_createBrowserHistory__ = __webpack_require__(107);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createRouterHistory__ = __webpack_require__(72);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__AsyncUtils__ = __webpack_require__(30);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__PromiseUtils__ = __webpack_require__(68);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_history_lib_createHashHistory__ = __webpack_require__(108);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_history_lib_Actions__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RouteUtils__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__RouterUtils__ = __webpack_require__(70);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__routerWarning__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__RouteUtils__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_lodash_es_isPlainObject__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils_warning__ = __webpack_require__(80);
/* unused harmony export default */
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__utils_warning__ = __webpack_require__(80);
...
var fetchKeys = __webpack_require__(122);
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(40), __webpack_require__(174)(module)))
...
var ServerRouterWrapper = __webpack_require__(82);
