        ...
        protected void CreateItem(int index)
        {
            if (index == 0)
            {
                AddRSSItem(
                    ...
                    Bikewale.Utility.Image.GetPathToShowImages(ds.Tables[0].Rows[index]["OriginalImgUrl"].ToString(), ds.Tables[0].Rows[index]["HostUrl"].ToString(), Bikewale.Utility.ImageSize._310x174),
                    Bikewale.Utility.Image.GetPathToShowImages(ds.Tables[0].Rows[index]["OriginalImgUrl"].ToString(), ds.Tables[0].Rows[index]["HostUrl"].ToString(),Bikewale.Utility.ImageSize._642x361),
