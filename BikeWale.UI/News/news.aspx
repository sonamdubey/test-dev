...
<style type="text/css" >
	...
	.next-prev-link a span.next-arrow { background:url(http://imgd3.aeplcdn.com/0x0/bw/static/design15/old-images/d/cw-sprite.png) 0 -589px no-repeat; width:10px; height:15px; display:inline-block;  }
	.next-prev-link:hover a span.next-arrow { background-position:0 -610px; }
	.next-prev-link a span.prev-arrow { background:url(http://imgd3.aeplcdn.com/0x0/bw/static/design15/old-images/d/cw-sprite.png) -13px -589px no-repeat; width:10px; height:15px; display:inline-block; margin-right:5px; }
...
<div class="container_12">
	<div class="grid_12"><ul class="breadcrumb"><li>You are here: </li>
		...
		<li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">&rsaquo; 
			<a title="Indian Bike News" href="/news/" itemprop="url">
				<span itemprop="title">Bike News</span>
			</a>
		</li>
		<li class="current">&rsaquo; <strong><%= articleTitle%></strong></li></ul><div class="clear"></div></div>
