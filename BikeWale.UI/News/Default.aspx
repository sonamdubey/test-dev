...
<style type="text/css">
    ...
    .article-category { color:#c20000; margin-top:3px; margin-bottom:3px; }
...
<div class="container margin-bottom30">
    <div class="grid-12">
        <div class="bg-white padding-bottom20">
            ...
            <div id="content" class="grid-8">
                <h1 class="black-text margin-bottom15">Bike News <span>Latest Indian Bikes News and Views</span></h1>
					        ...
					        <div id='post-<%# Eval("BasicId") %>' class="<%# Convert.ToString(DataBinder.Eval(Container.DataItem,"AuthorName")).ToLower().Contains("sponsored") ? "sponsored-content"  : "post-content" %> article-content">
						        ...
						        <div class="margin-bottom10">
                                    <div class="grid-4 alpha omega article-image-wrapper">
                                        <%#"<a href='/news/" + Eval("BasicId") + "-" + Eval("ArticleUrl") + ".html'><img src='" + Bikewale.Utility.Image.GetPathToShowImages(Eval("OriginalImgUrl").ToString(), Eval("HostUrl").ToString(),Bikewale.Utility.ImageSize._144x81) + "' width='100%' border='0' /></a>" %>
                                    </div>
                                    <div class="grid-8 padding-left20 omega">
                                        <div class="article-category">
                                            <span class="text-uppercase font12 text-bold">News</span>
                                            <span class="text-uppercase font12 text-bold">Expert Reviews</span>
                                            <span class="text-uppercase font12 text-bold">Features</span>
                                            <span class="text-uppercase font12 text-bold">Road Test</span>
                                        </div>
                                        <h2 class="font14 margin-bottom5">
                                            <a href="/news/<%# Eval("BasicId") %>-<%# Eval("ArticleUrl") %>.html" rel="bookmark" title="Permanent Link to <%# Eval("Title") %>" class="text-black text-bold"><%# Eval("Title") %></a>
                                        </h2>
