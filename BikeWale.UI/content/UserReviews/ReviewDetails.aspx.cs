...
namespace Bikewale.Content
{
    public class ReviewDetails : System.Web.UI.Page
    {
        ...
        private void CreatMetas()
        {
            ...
            returnUrl = Utils.Utils.EncryptTripleDES(string.Format("returnUrl=/{0}-bikes/{1}/reviews/{2}/&sourceid={3}", MakeMaskingName, ModelMaskingName, reviewId,(int)Bikewale.Entities.UserReviews.UserReviewPageSourceEnum.Desktop_UserReview_Details));
        }
        /// <summary>
        /// Created By :- Subodh Jain 17 Jan 2017
