        ...
        <div class="grid_3 alpha margin-top10 margin-top15">
            ...
            <div style="margin-top: 5px; line-height: 17px;">
                ...
                <span class="margin-top5"><a title="<%= MakeName%> <%= ModelName%> details" href='/<%= MakeMaskingName %>-bikes/<%= ModelMaskingName %>/'><%= ModelName %> Details</a><% if (IsNew && IsUsed)
                                                                                                                                                                                         { %><span class="text-grey"> | </span><a class="getquotation" href="/pricequote/default.aspx?model=<%= modelId %>" pqSourceId="<%= (int)Bikewale.Entities.PriceQuote.PQSourceEnum.Desktop_UserReview_ModelPage %>" data-modelid="<%= modelId %>">On Road Price</a><% } %></span>
            </div>
        </div>
        ...
        <div class="gray-block-top">
            <div class="grey-bg content-block margin-top5">
                <div class="left-float">
                    Show reviews for 
                    <asp:dropdownlist id="drpVersions" runat="server" autopostback="true"></asp:dropdownlist>
                </div>
