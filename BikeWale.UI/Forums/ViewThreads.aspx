											...
											<table width="100%">
												<tr>
													...
													<td width="30%" align="right" valign="middle">
														...
														<%# flagLogin ? "<a onclick='javascript:reportAbuse(" + DataBinder.Eval(Container.DataItem, "Id") + ")' style=\"cursor:pointer\"><img align='absmiddle' src='http://imgd2.aeplcdn.com/0x0/bw/static/design15/old-images/d/alertforum.jpg' title='Report this post to administrators' border='0' /></a>" : "" %> 
														<%# modLogin ? "<a style=\"cursor:pointer;\" onClick=\"if ( confirm('Do you really want to DELETE this post?') ) { __doPostBack('lnkDeletePost','" + DataBinder.Eval(Container.DataItem, "Id") + "') }\"><img src=\"http://imgd1.aeplcdn.com/0x0/bw/static/design15/old-images/d/delete.ico\" align='absmiddle' title=\"Delete this post\" border=\"0\" /></a><a style=\"cursor:pointer;\" onClick=\"EditPost('" + DataBinder.Eval(Container.DataItem, "Id") + "')\"><img align='absmiddle' src=\"http://imgd1.aeplcdn.com/0x0/bw/static/design15/old-images/d/add.gif\" title=\"Edit this post\" border=\"0\" /></a>" : "" %>
														</span>		
													</td>
												</tr>
											</table>
