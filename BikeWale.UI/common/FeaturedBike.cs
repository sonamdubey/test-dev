...
namespace Bikewale.Common
{
    ...
    public class FeaturedBike
    {
        ...
        {
            ErrorClass objErr = new ErrorClass(new Exception("Method not used/commented"), "FeaturedBike.GetFeaturedVersion");
            objErr.SendMail();
            return string.Empty;
        ...
        {
            ErrorClass objErr = new ErrorClass(new Exception("Method not used/commented"), "FeaturedBike.GetFeaturedBikeForNewSearch");
            objErr.SendMail();
            return null;
        ...
        {
            ErrorClass objErr = new ErrorClass(new Exception("Method not used/commented"), "FeaturedBike.GetFeaturedModel");
            objErr.SendMail();
            return null;
