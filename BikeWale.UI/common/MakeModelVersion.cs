...
namespace Bikewale.Common
{
    ...
    public class MakeModelVersion
    {
        ...
        public static string GetModelImage(string hostUrl, string imagePath)
        {
            ...
            {
                fullImagePath = "https://imgd.aeplcdn.com/0x0/bikewaleimg/images/noimage.png";
            }
            else
            {
        ...
        {
            ErrorClass.LogError(new Exception("Method not used/commented"), "MakeModelVersion.GetBuyingPreference");
