...
namespace Bikewale.Common 
{
	public class BikewaleSecurity
	{
	  ...
	  //this will return the 20 character long string generated randomly
        ...
        #region EncodeEncryptedData method
        /// <summary>
        /// Added By : Ashish G. Kamble on 6 Nov 2012
        /// Summary : This function takes the encrypted data as input and encode it into URL friendly encoded data to avoid any special character
        /// </summary>
        /// <param name="input">string to encode</param>
        /// <returns>Returns url friendly endoded string</returns>
        ...
        /// <summary>
        /// Added By : Ashish G. Kamble on 6 Nov 2012
        /// Summary : This function takes the encoded data as input and decode it into the encrypted value which has been encoded
        /// </summary>
