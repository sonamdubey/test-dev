...
<div class="bw-popup hide bw-popup-sm" id="popupWrapper">
    <div class="popup-inner-container" stopbinding: true>
        ...
        <div class="padding-top10" id="popupContent">
            ...
            <input id="btnDealerPricePopup" class="action-btn margin-top15 margin-left70" style="display: block;" type="button" value="Get on road price" data-bind="click: getPriceQuotePopup, visible: (!hasAreas() && bookingCities().length > 0) || (hasAreas && selectedArea)">
