                ...
                <div class="jcarousel" data-jcarousel="true">
                    <ul>
                        <% if (DealerCountCityList != null) { 
                          ...
                          { %>
                        <li>
                            <a href="/<%= MakeMaskingName %>-dealer-showrooms-in-<%= Dealer.CityMaskingName %>/" title="<%= MakeName %> showrooms in <%= Dealer.CityName %>">
