...
<div class="model-updates-videos-container" id="ctrlVideos">
    ...
    <asp:Repeater ID="rptVideos" runat="server">
        <ItemTemplate>
            <div class="margin-bottom20">
                ...
                <div class="grid-8">
                    <h3 class="margin-top5"><a href="<%# Bikewale.Utility.UrlFormatter.VideoDetailPageUrl(DataBinder.Eval(Container.DataItem,"VideoTitleUrl").ToString(),DataBinder.Eval(Container.DataItem,"BasicId").ToString()) %>" class="article-target-link"><%# DataBinder.Eval(Container.DataItem,"VideoTitle").ToString() %></a></h3>
    ...
    <div class="padding-left10">
        <a href="<%=MoreVideoUrl%>"  class="bw-ga" c="Model_Page" a="View_all_videos_link_cliked" v="myBikeName">View all videos<span class="bwsprite blue-right-arrow-icon"></span></a>        
    </div>
</div>
<!-- Ends here-->
