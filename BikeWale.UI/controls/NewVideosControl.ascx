...
<div class="model-updates-videos-container" id="ctrlVideos">
    ...
    <div class="padding-left10 more-article-target view-all-btn-container">
        <a title="<%= linkTitle %>" href="<%=MoreVideoUrl%>" class="bw-ga btn view-all-target-btn" c="Model_Page" a="View_all_videos_link_cliked" v="myBikeName">View all videos<span class="bwsprite teal-right"></span></a>
    </div>
</div>
<!-- Ends here-->
