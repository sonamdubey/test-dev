                    ...
                    <div class="carousel-photos carousel-stage-photos">
                        <ul>
                            <asp:Repeater ID="rptModelPhotos" runat="server">
                                <ItemTemplate>
                                    <li>
                                        <img class="lazy" data-original="<%# Bikewale.Utility.Image.GetPathToShowImages(DataBinder.Eval(Container.DataItem, "OriginalImgPath").ToString(),DataBinder.Eval(Container.DataItem, "HostUrl").ToString(),Bikewale.Utility.ImageSize._640x348) %>" title="<%# DataBinder.Eval(Container.DataItem, "ImageCategory").ToString() %>" alt="<%# DataBinder.Eval(Container.DataItem, "ImageCategory").ToString() %>" src="http://img1.aeplcdn.com/grey.gif" width="640" height="348">
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
                    ...
                    <div class="carousel-photos carousel-navigation-photos">
                        <ul>
                            <asp:Repeater ID="rptNavigationPhoto" runat="server">
                                <ItemTemplate>
                                    <li>
                                        <img class="lazy" data-original="<%# Bikewale.Utility.Image.GetPathToShowImages(DataBinder.Eval(Container.DataItem, "OriginalImgPath").ToString(),DataBinder.Eval(Container.DataItem, "HostUrl").ToString(),Bikewale.Utility.ImageSize._144x81) %>" src="http://img1.aeplcdn.com/grey.gif" title="<%# DataBinder.Eval(Container.DataItem, "ImageCategory").ToString() %>" alt="<%# DataBinder.Eval(Container.DataItem, "ImageCategory").ToString() %>" width="144" height="81">
                                    </li>
                                </ItemTemplate>
                            </asp:Repeater>
                        </ul>
