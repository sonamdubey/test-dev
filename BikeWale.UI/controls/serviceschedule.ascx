						...
						<div class="content-box-shadow padding-15-20-20">
							...
							<div class="grid-8 omega">
								...
								<div data-bind="visible: !isDataExist()" id="service-not-available">
									...
									<p class="font14 text-light-grey">Sorry! The service schedule for <span data-bind="text: currentBikeName()"></span> is not available.<br />Please check out the service schedule for other <%= MakeName %> bikes.</p>
								</div>
							</div>
							<div class="clear"></div>
						</div>
