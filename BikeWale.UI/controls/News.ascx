        ...
        <div class="margin-bottom20">
            ...
            <div class="grid-8">
                ...
                <div class="article-stats-left-grid">
                    ...
                    <span class="article-stats-content"><%= firstPost.DisplayDate.ToString("MMM dd, yyyy") %></span>
                </div>
                ...
                <p class="line-height17 margin-top10">
                    <%= Bikewale.Utility.FormatDescription.TruncateDescription(firstPost.Description,280) %>
                </p>
            </div>
            <div class="clear"></div>
        </div>
