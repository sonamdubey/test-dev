                ...
                <td>
                  ...
                  <table border="0">
                        <tr style="display:inline-block; max-width:136px; height:200px; border:2px solid #eeeeee; padding:20px 5px 10px; margin:0 5px 15px;text-align:center; vertical-align:top; position:relative;">
                            <td  style="font-size:10px;  color:#333;margin:15px 0 26px;"><img src="https://imgd3.aeplcdn.com/0x0/bw/static/design15/mailer-images/dealer-confirmation.png" border="0">Get in touch with Dealership</td>
                        ...
                        <tr style="display:inline-block; max-width:136px; height:200px; border:2px solid #eeeeee; padding:20px 5px 10px; margin:0 5px 15px; text-align:center; vertical-align:top; position:relative;">
                            <td  style="font-size:10px; color:#333; margin:15px 0 26px;"><img src="https://imgd2.aeplcdn.com/0x0/bw/static/design15/mailer-images/claim-price.png" border="0">Claim your Price</td>
                        
                    		<td style="text-align:left;">Please present this price certificate to dealership to claim the price for your purchase.</td>
                        </tr>
                        <tr style="display:inline-block; max-width:136px; height:200px; border:2px solid #eeeeee; padding:20px 5px 10px; margin:0 5px 15px; text-align:center; vertical-align:top; position:relative;">
                            <td  style="font-size:10px; color:#333;margin:15px 0 26px;"><img src="https://imgd3.aeplcdn.com/0x0/bw/static/design15/mailer-images/documentation.png" border="0">Be ready with Documentation</td>
                        ...
                        <tr style="display:inline-block; max-width:136px; height:200px; border:2px solid #eeeeee; padding:20px 5px 10px; margin:0 5px 15px; text-align:center; vertical-align:top; position:relative;">
                            <td  style="font-size:10px;color:#333;margin:15px 0 26px;"><img src="https://imgd4.aeplcdn.com/0x0/bw/static/design15/mailer-images/buy-your-bike.png" border="0">Buy your Bike!</td>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%" border="0">
                        <tr>
                            <td style="width:100px;vertical-align:top;border-right:1px solid #E5E5E5;">
                                 <div>
                                    <img alt=" Bajaj Avenger 220 DTS- i Photos" src="https://imgd1.aeplcdn.com/0x0/bw/static/design15/old-images/d/548b.jpg" title="Bajaj Avenger 220 DTS- i Photos">
                                 </div>
                            </td>
