    ...
    <ItemTemplate>
        <div class="grid_3">
            <div class="border-light border-radius5 content-block">
                <img alt="<%# DataBinder.Eval( Container.DataItem, "BikeName" ) %>" title="<%# DataBinder.Eval( Container.DataItem, "BikeName" ) %>" src="http://<%# DataBinder.Eval( Container.DataItem, "HostUrl").ToString() %><%# DataBinder.Eval( Container.DataItem, "ImagePath").ToString() %>" hspace="0" vspace="0" border="0" style="width:200px;height:125px;" />
