                                    ...
                                    <li>
                                        <a href="/<%= bike.Make.MaskingName %>-bikes/<%= bike.Model.MaskingName %>/images/" title="<%= bikeName %> images" class="jcarousel-card">
                                            ...
                                            <div class="card-desc-block">
                                                ...
                                                <p class="text-light-grey margin-bottom5">Ex-showroom,&nbsp;City</p>
                                                <p class="font18 text-default inline-block">&#x20b9;<span class="text-bold">&nbsp;0&nbsp;</span><span class="font14">onwards</span></p>
                                            </div>
                                        </a>
                                        <a title="" href="" class="margin-bottom5 compare-with-target text-truncate">
                                            <span class="bwsprite photos-sm"></span><span class="margin-left5 text-default inline-block">View all&nbsp<%= bike.PhotosCount %> images</span><span class="bwsprite next-grey-icon"></span>
                                        </a>
                                    </li>
                                    <% } %>     
                                </ul>
