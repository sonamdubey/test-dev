            ...
            <li class="front">
                <div class="contentWrapper">
                    ...
                    <div class="bikeDescWrapper">
                        ...
                        <div class="bikeStartPrice margin-bottom10 font20">
                       ...
                       <div class="leftfloat margin-left10 font16 text-light-grey <%# Convert.ToString(DataBinder.Eval(Container.DataItem,"ReviewCount")) != "0" ? "" : "hide" %>">
                        ...
                        <div class="clear"></div>
                        <a href="javascript:void(0)" pqSourceId="<%= PQSourceId %>" modelId="<%# Convert.ToString(DataBinder.Eval(Container.DataItem, "modelBase.ModelId")) %>" class="<%# (Convert.ToString(DataBinder.Eval(Container.DataItem, "VersionPrice"))!="0")?"":"hide" %> btn btn-grey margin-top10 fillPopupData">Get on-road price</a>
                    </div>
                </div>
            </li>
        </ItemTemplate>        
