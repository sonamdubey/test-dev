...
<div class="padding-left10 view-all-btn-container">
    <a title="<%= linkTitle %>" href="/<%=MakeMaskingName%>-bikes/<%=ModelMaskingName%>/reviews/"  class="bw-ga btn view-all-target-btn" c="Model_Page" a="Read_all_user_reviews_link_cliked" v="myBikeName">Read all reviews<span class="bwsprite teal-right"></span></a>   
</div>
