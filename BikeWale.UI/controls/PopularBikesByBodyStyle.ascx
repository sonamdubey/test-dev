...
<div class="content-box-shadow padding-15-20-10 margin-bottom20">
    <h2>Popular <%= !string.IsNullOrEmpty(Convert.ToString(BodyStyle))? Convert.ToString(BodyStyle) : string.Empty %> bikes</h2>
    ...
    <div class="margin-top10 margin-bottom10">
        <a href="<%=Bikewale.Utility.UrlFormatter.FormatGenericPageUrl(BodyStyle) %>" title="Best <%=BodyStyle %> bikes" class="font14">View all popular<%= BodyStyle %> bikes<span class="bwsprite blue-right-arrow-icon"></span></a>
    </div>
</div>
<%} %>