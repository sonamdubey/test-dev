...
<asp:Repeater ID="rptVideosByCat" runat="server">
    ...
    <FooterTemplate>
        ...
        <span class="jcarousel-control-right"><a href="#" class="bwsprite jcarousel-control-next"></a></span>
                    ...
                    <a href="<%# Bikewale.Utility.UrlFormatter.VideoByCategoryPageUrl(FirstVideoRecord.SubCatName,((int)CategoryId).ToString()) %>" class="font16 text-center more-videos-link">View more videos</a>
        </div>
                <div class="clear"></div>
        </div>
        </section>
