            ...
            <div class="ad-thumbs">
                ...
                <% 
                    ...
                    <div id="noImageAv" visible="false" runat="server">
                        <li>
                            <a href='https://imgd1.aeplcdn.com/0x0/bw/static/design15/old-images/d/no-img-big.png'>
				                <img src='https://imgd2.aeplcdn.com/0x0/bw/static/design15/old-images/d/no-img-thumb.png' border="0" style="height:70px;" title='No Images Available' alt='No Images Available' />
			                </a>
                        </li>                          
                    </div>      
                </ul>
