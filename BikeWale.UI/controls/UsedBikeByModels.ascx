...
<div class="jcarousel-wrapper inner-content-carousel city-model-carousel type-model-carousel">
    <div class="jcarousel">
        <ul>
            ...
            <li>
                <a href="<%=string.Format("/used/{0}-{1}-bikes-in-{2}/",MakeMaskingName,ModelDetails.ModelMaskingName,CityMaskingName) %>"  title="<%=string.Format("Used {0} {1} bikes in {2}",MakeMaskingName,ModelDetails.ModelName,CityName)%>" class="card-target-block">
