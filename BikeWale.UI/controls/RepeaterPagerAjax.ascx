			...
			<table class="tbl-search" border="0" cellspacing="0" cellpadding="0" width="100%">
				...
				<asp:Repeater ID="rptFeaturedBike" runat="server">
					<itemtemplate>
                        ...
                        <%# GetModelRow(DataBinder.Eval(Container.DataItem, "ModelId").ToString(), DataBinder.Eval(Container.DataItem, "ModelCount").ToString(), DataBinder.Eval(Container.DataItem, "BikeModel").ToString(), DataBinder.Eval(Container.DataItem, "MoReviewRate").ToString(), DataBinder.Eval(Container.DataItem, "MinPrice").ToString(), DataBinder.Eval(Container.DataItem, "MaxPrice").ToString(), DataBinder.Eval(Container.DataItem,"HostUrl").ToString(),DataBinder.Eval(Container.DataItem,"OriginalImagePath").ToString(), DataBinder.Eval(Container.DataItem,"MoReviewCount").ToString(), DataBinder.Eval(Container.DataItem,"MakeName").ToString(), DataBinder.Eval(Container.DataItem,"ModelName").ToString(),DataBinder.Eval(Container.DataItem,"MakeMaskingName").ToString(),DataBinder.Eval(Container.DataItem,"ModelMaskingName").ToString())%>
