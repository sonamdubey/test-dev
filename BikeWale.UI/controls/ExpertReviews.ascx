        ...
        <ItemTemplate>
            <div class="padding-bottom30">
                ...
                <div class="grid-8 omega padding-top5 font14">
                    <a href="/road-tests/<%# DataBinder.Eval(Container.DataItem,"ArticleUrl").ToString() + "-" + DataBinder.Eval(Container.DataItem,"BasicId").ToString() %>.html" class="article-target-link margin-bottom10"><%# DataBinder.Eval(Container.DataItem, "Title").ToString()%></a>
