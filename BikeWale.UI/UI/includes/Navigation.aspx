<nav id="nav">
    <ul class="navUL">
        ...
        <li>
         ...
         <li>
                ...
                <ul class="nestedUL">
                    <li><a href="/honda-scooters/">Honda Scooters</a></li>
                    <li><a href="/hero-scooters/">Hero Scooters</a></li>
                    <li><a href="/tvs-scooters/">TVS Scooters</a></li>
                    <li><a href="/yamaha-scooters/">Yamaha Scooters</a></li>
                    <li><a href="/scooters/">All Scooters</a></li>
                </ul>
            </li>
        ...
        <li>
            <a href="javascript:void(0)" rel="nofollow">
                <span class="bwsprite news-icon"></span>
    ...
    <div class="margin-top40 margin-bottom40 margin-left20">
        <a href="https://play.google.com/store/apps/details?id=com.bikewale.app&referrer=utm_source%3DDesktopsite%26utm_medium%3DDrawer%26utm_campaign%3DBikeWale%2520Desktopsite%2520Drawer" target="_blank" rel="noopener nofollow" class="gplay-icon margin-right5" title="BikeWale App on Google Play">BikeWale App on Google Play</a>
