...
<%@ Register Src="~/UI/controls/SimilarUsedBikes.ascx" TagPrefix="BW" TagName="SimilarUsedBikes" %>
...
<head>
    ...
    <style type="text/css">
        ...
        .listing-sold-icon{width:87px;height:64px;background:url('https://imgd.aeplcdn.com/0x0/bw/static/icons/4d5057/sold-sign.svg') no-repeat center/contain;display:inline-block;vertical-align:middle}.listing-removed-icon{width:127px;height:64px;background:url('https://imgd.aeplcdn.com/0x0/bw/static/icons/4d5057/removed-sign.svg') no-repeat center/contain;display:inline-block;vertical-align:middle}.listing--removed .bike-sold-msg{width:85%}
    </style>
...
<body>
    <form id="form1" runat="server">
                ...
                <div class="grid-12">
                    <div class="breadcrumb margin-bottom15">
                        ...
                        <ul>
                            ...
                            <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                                <span class="bwsprite fa-angle-right margin-right10"></span>
                                <a href="/used/bikes-in-<%= cityMaskingName %>/" itemprop="url">
                                    <span itemprop="title"><%= inquiryDetails.City.CityName %></span>
                                </a>
                            </li>
                            <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                                <span class="bwsprite fa-angle-right margin-right10"></span>
                                <a href="<%= string.Format("/used/{0}-bikes-in-{1}/", inquiryDetails.Make.MaskingName, cityMaskingName) %>" itemprop="url">
                            ...
                            <li itemscope="" itemtype="http://data-vocabulary.org/Breadcrumb">
                                <span class="bwsprite fa-angle-right margin-right10"></span>
                                <a href="<%= string.Format("/used/{0}-{1}-bikes-in-{2}/", inquiryDetails.Make.MaskingName, inquiryDetails.Model.MaskingName, cityMaskingName) %>" itemprop="url">
        ...
        <section>
            <div class="container">
                <div class="grid-12 margin-bottom20">
                    <div class="content-box-shadow content-inner-block-20 listing--removed">
                        <span class="listing-removed-icon"></span>
                       
                        <div class="bike-sold-msg text-grey"> <h1><%= bikeName %></h1>
                            The <%= bikeName %> bike you are looking for has been removed. You might want to consider other used bikes shown below.</div>
                    </div>
                </div>
                <div class="clear"></div>
            </div>
                    ...
                    <div class="content-box-shadow">
                        ...
                        <div id="specsContent" class="bw-model-tabs-data specs-features-list font14">
                            <h2 class="content-inner-block-20">Specifications summary</h2>
                             ...
                             %>
                            <%for (int gridCount = 0; gridCount < 3 && specsIndex < listLength; gridCount++)
                            {%>
                            <div class="grid-4 omega specs-features__content margin-bottom20">
                                <% for (int i = 0; i < 4 && specsIndex < listLength; i++)
                                     {
                                 %>
                                <p>
                                    <span class="specs-features-item__content text-light-grey"><%=specsList[specsIndex].Name%> </span>
                                    <span class="specs-features-item__content text-bold"><%=Bikewale.Utility.FormatMinSpecs.ShowAvailable(specsList[specsIndex].Value, specsList[specsIndex].UnitType, specsList[specsIndex].DataType, specsList[specsIndex].Id)%> </span>
                                </p>
                                <%specsIndex++; %>
                                 <%} %>
                            </div>
                            ...
                            <div class="grid-8 alpha margin-bottom25">
                                <h2 class="content-inner-block-20">Features summary</h2>
                                 <%for (int gridCount = 0; gridCount < 2 && specsIndex < listLength; gridCount++)
                                     {%>
                                    <div class="grid-6 omega specs-features__content margin-bottom20">
                                    <% for (int i = 0; i < 3 && specsIndex < listLength; i++)
                                    {
                                     %>
                                    <p>
                                      <span class="specs-features-item__content text-light-grey"><%=specsList[specsIndex].Name%> </span>
        ...
        <% if (inquiryDetails != null && inquiryDetails.PhotosCount > 1 && !isBikeSold && !isFakeListing)
           { %>
        <!-- gallery -->
        <section>
        ...
        <%if (inquiryDetails != null && inquiryDetails.PhotosCount == 0 && !isBikeSold && !isFakeListing)
          { %>
        ...
        <script type="text/javascript" src="<%= staticUrl%>/UI/src/used-details.js?<%= staticFileVersion%>">
        </script>
        <script type="text/javascript" >
