            ...
            <% foreach(var bike in  objSimilarBikes) { %>
                <div class="swiper-slide">
                    <div class="swiper-card rounded-corner2">
                        <a href="/m/<%= Bikewale.Utility.UrlFormatter.CreateCompareUrl(bike.MakeMasking1,bike.ModelMasking1,bike.MakeMasking2,bike.ModelMasking2,bike.VersionId1,bike.VersionId2, bike.ModelId1,bike.ModelId2, Bikewale.Entities.Compare.CompareSources.Mobile_Featured_Compare_Widget) %>" title ="<%= Bikewale.Utility.UrlFormatter.CreateCompareTitle(bike.Model1,bike.Model2) %>" class="block">
                        ...
                        <div class="grid-6">
                            <div class="model-img-content">
                                <img class="swiper-lazy" src="<%= Bikewale.Utility.Image.GetPathToShowImages(bike.OriginalImagePath1,bike.HostUrl1,Bikewale.Utility.ImageSize._144x81, Bikewale.Utility.QualityFactor._70) %>" alt="<%= bike.Model1 %>" title="<%= bike.Model1 %>" />
                        ...
                        <div class="grid-6">
                            <div class="model-img-content">
                                <img class="swiper-lazy" src="<%= Bikewale.Utility.Image.GetPathToShowImages(bike.OriginalImagePath2,bike.HostUrl2,Bikewale.Utility.ImageSize._144x81, Bikewale.Utility.QualityFactor._70) %>" alt="<%= bike.Model2 %>" title="<%= bike.Model2 %>" />
                                <span class="swiper-lazy-preloader"></span>
                            </div>
