...
docReady(function () {
	...
	if (navigator.userAgent.match(/UCBrowser\/10/g) || navigator.userAgent.match(/UCBrowser\/11/g)) {
		$('body').addClass('browser--uc-fallback');
	}
	...
	/* trigger resize event after orientation change event for UC browser */
