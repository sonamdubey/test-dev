...
/*
 *	Modified By: Dutiyesh Salunkhe on 02 August 2017.
 *	Description: Prevent click method call in 'Chosen.prototype.result_select' function.
*/

/*
 *	Modified By: Dutiyesh Salunkhe on 22 August 2017.
 * 	Method: Add 'results_without_focus' method in register
 *	Description: 'results_without_focus' method will open suggestion list without input focus
*/

/* 
 * Modified By: Dutiyesh Salunkhe on 30 April 2018.
    ...
    SelectParser = function() {
        ...
        return d(Chosen, c), Chosen.prototype.setup = function() {
            ...
            return this.container.bind("mousedown.chosen", function(b) {
                ...
                a.preventDefault()
            }), this.form_field_jq.bind("chosen:results_without_focus.chosen", function(b) {
				a.results_without_focus(b)
			})
        ...
        }, Chosen.prototype.results_without_focus = function() {
            return this.is_multiple && this.max_selected_options <= this.choices_count() ? (this.form_field_jq.trigger("chosen:maxselected", {
                chosen: this
            }), !1) : (this.container.addClass("chosen-with-drop chosen-container-active"), this.results_showing = !0, this.search_field.val(this.search_field.val()), this.winnow_results(), this.form_field_jq.trigger("chosen:showing_dropdown", {
                chosen: this
			}))
