...
namespace Bikewale.Service.Controllers.CMS
{
    ...
    public class CMSController : CompressionApiController//ApiController
    {
        ...
        public IHttpActionResult GetOtherModelsPhotos(int modelId, int posts, int pageNumber)
        {
            ...
            Bikewale.Entities.CMS.Photos.CMSImage objPhotos = null;
            ...
            try
            {
                ...
                {
                    objPhotos = objClient.GetApiResponseSync<Bikewale.Entities.CMS.Photos.CMSImage>(Utility.APIHost.CW, Utility.BWConfiguration.Instance.APIRequestTypeJSON, _apiUrl, objPhotos);
                }
