...
<link href="<%= staticUrl != "" ? "http://img2.aeplcdn.com" : "" %>/m/css/bwm-common-style.css?14sept2015" rel="stylesheet" type="text/css">
<link href="<%= staticUrl != "" ? "http://img2.aeplcdn.com" : "" %>/m/css/home.css?14sept2015" rel="stylesheet" type="text/css">
<script type="text/javascript" src="<%= staticUrl != "" ? "http://img2.aeplcdn.com" : "" %>/m/src/frameworks.js?14sept2015"></script>
