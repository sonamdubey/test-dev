            ...
            <div class="container_12">
                ...
                <div class="grid_12 primary-nav-container">
                	<ul>
                        ...
                        <li class="active"><a href="/new/">New Bikes</a></li>
                        <li class="pri-nav-sept"></li>
        ...
        <div class="container_12">
            <div id="sub-nav" class="grid_12">
                 <ul id="sub-nav-list">
                    ...
                    <li><a href="/pricequote/">On-road Price Quote</a></li>
                    <li class="sub-nav-sept"></li>
                    ...
                    <li class="sub-nav-sept"></li>
                    <li><a href="/new-bikes-launches/">Recent Launches</a></li>
                    <li class="sub-nav-sept"></li>
                    <%--<li><a href="/tipsadvices/">Tips & Advices</a></li>
                    <li class="sub-nav-sept"></li>--%>
                    <%--<li><a href="/finance/emicalculator.aspx">calculate emi</a></li>
                    <li class="sub-nav-sept"></li>--%>
                    <li><a href="/new/locate-dealers/">Locate Dealers</a></li>
                </ul>
            </div>
        </div>
