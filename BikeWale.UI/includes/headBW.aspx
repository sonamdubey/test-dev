    	...
    	<div class="profileBoxContent">
            ...
            <div class="user-profile-banner">
            	<div class="user-profile-details padding-left10 padding-top70">
                    ...
                    <div class="user-profile-name">
	            		<p class="font16 text-white padding-left10">John Doe</p>
                    </div>
            	</div>
            </div>
            ...
            <div class="user-profile-option-list padding-top20">
            	<ul class="profileUL">
                    ...
                    <li>
                    	<a herf="#">
                        	<span class="margin-left15 bwsprite login-garage-icon"></span>
                            <span class="margin-left20 profile-option-title">My garage</span>
                        </a>
                    </li>
                    <li>
                    	<a herf="#">
