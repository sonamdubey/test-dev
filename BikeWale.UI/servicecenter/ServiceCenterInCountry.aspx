...
<body class="bg-light-grey">
    <form runat="server">
                    ...
                    <div class="content-box-shadow padding-bottom20">
                        <ul class="accordion-list">
                            ...
                            <li>
                                ...
                                <div class="accordion-body">
                                    <p>We've all been there at some point, and there's the obvious - jumper cables.<br />
                                        <br />
                            ...
                            <li>
                                ...
                                <div class="accordion-body">
                                    <p>If you have a scooter, obviously this isn't a problem. However, this can be quite a big issue if you've got something that needs gears to be shifted manually.<br />
                                        <br />
                                        ...
                                        <br />
                                        Remember - these are very risky manoeuvres, so please do not try them unless there is an emergency and you cannot afford to wait at all.</p>
                                </div>
                            </li>
                        </ul>
        ...
        <script type="text/javascript" src="<%= staticUrl != "" ? "https://st2.aeplcdn.com" + staticUrl : "" %>/src/service/location.js?<%= staticFileVersion %>"></script>
