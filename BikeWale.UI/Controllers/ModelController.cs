...
namespace Bikewale.Controllers
{
    public class ModelController : Controller
    {
        ...
        {
            ModelPage obj = new ModelPage(makeMasking, modelMasking, Request.RawUrl, _userReviewsSearch, _userReviewsCache, _objModel, _objDealerPQ, _objAreaCache, _objCityCache, _objPQ, _objDealerCache, _objDealerDetails, _objVersionCache, _objArticles, _objVideos, _objUsedBikescache, _objServiceCenter, _objPQCache, _objCompare, _userReviewCache, _usedBikesCache, _objBestBikes, _upcoming, _objManufacturerCampaign);
