            ...
            <div class="grid_4 alpha margin-top15">
                <table border="0" cellpadding="0" cellspacing="0" class="tbl-default" width="100%">
                    <tr>
                        ...
                        <td>
                            <input style="text-align: right; width:100px;" type="text" maxlength="10" id="txtloanamount" size="10" value="100000" runat="server" tabindex="1"/></td>
                    </tr>
                    <tr>
                        <td>Rate Of Interest (<strong>% </strong>)</td>
                        <td>
                            <input style="text-align: right; width:100px;" id="interestRate" type="text" maxlength="5" value="12.5" size="5" runat="server" tabindex="2"/></td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
                        <td>
                    ...
                    <tr>
                        <td>&nbsp;</td>
                        <td>                         
                            <input id="btnCalcEmi" class="buttons" type="submit" title="Calculate EMI" name="Button" value="Calculate EMI" tabindex="4"/>                        
                        </td>
                    </tr>
                </table>
            </div>
