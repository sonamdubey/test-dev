...
<head>
    ...
    <style type="text/css">
    .faq-top-banner { background:#57605e no-repeat center top; background-size: cover; height: 285px; padding-top: 1px; }
...
<body class="bg-light-grey">
    <form runat="server">
        ...
        <header class="faq-top-banner lazy" data-original="http://img.aeplcdn.com/bikewaleimg/images/d_faqs_banner.jpg" >    	
            <div class="container">
        ...
        <section>
    	    <div class="container margin-top50">
        	    <div class="grid-12">
                    ...
                    <div class="faq-content content-box-shadow content-inner-block-20 margin-bottom30">
