...
docReady(function () {
    ...
    newBikeSearch = function () {
        ...
        self.getBikeSearchResult = function (ele) {
    ...
    //$.bindBikeListing = function (searchUrl, filterName) {
    //    var response = JSON.parse(Base64.decode($('#allSearchResult').val()));
