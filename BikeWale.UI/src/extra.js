...
; (function (factory) {
    ...
    $.Zebra_DatePicker = function (element, options) {
        ...
        var defaults = {
            ...
            //
            //  default is ['&#171;','&#187;']
            header_navigation: ['<span class="bwsprite bwmsprite dp-prev-icon"></span>', '<span class="bwsprite bwmsprite dp-next-icon"></span>'],
        ...
        var init = function (update) {
            ...
            if (!plugin.settings.always_visible) {
                ...
                if (!update) {
                    ...
                    if (plugin.settings.show_icon) {
                        ...
                        var icon_wrapper = $(''); // bw: remove icon wrapper
                        ...
                        icon = $('<button type="button" class="hide"></button>'); // bw: empty button for position fix
            ...
            var html = '' +
                '<div class="Zebra_DatePicker rounded-corner2">' +
            ...
            if (!plugin.settings.always_visible) {
                ...
                if (plugin.settings.container.is('body')) {
                    ...
                    var
                        ...
                        window_scroll_top = $(element).offset().top,
                    ...
                    datepicker.css({
                        'left': left,
                        'top': top - 17 // bw: border alignment
                    });
