...
var cwTracking = { hostPath: location.host, type: { impression: "imp", click: "click" }, getSource: function () { var t = document.referrer, e = location.host; return e.indexOf(cwTracking.hostPath) >= 0 ? "" : "src=" + t }, getPageUrl: function () { var t = document.location.href; return t.indexOf("?") > 0 ? "pi=" + t.split("?")[0] : t.indexOf("#") > 0 ? "pi=" + t.split("#")[0] : "pi=" + t }, getQSFromUrl: function () { var t = document.location.href, e = ""; return t.indexOf("?") > 0 ? e = t.split("?")[1] : t.indexOf("#") > 0 && (e = t.split("#")[1]), e.length > 0 ? (e = e.replace(/&+/g, "|"), "qs=" + e) : "" }, getReferrer: function () { var t = document.referrer, e = location.host; return e.indexOf(cwTracking.hostPath) >= 0 && t.length > 0 ? "ref=" + t.split(cwTracking.hostPath)[1] : "" }, addToQS: function (t, e) { return t.length > 0 ? t += "&" + e : t = e, t }, getAttributeValue: function (t) { switch (t) { case "imp": return "cwti"; case "click": return "cwtc"; default: return "cwcti" } }, getCompleteQS: function (t, e) { var i, c, n, r = "", a = cwTracking.getAttributeValue(e), o = !1; return t.is("[qs]") && (o = !0), i = t.data(a + "cat"), c = t.data(a + "lbl"), n = t.data(a + "act"), r = cwTracking.getFinalQS(i, n, c, o) }, getFinalQS: function (t, e, i, c) { var n, r, a, o, g = ""; return n = cwTracking.getSource(), r = cwTracking.getPageUrl(), o = cwTracking.getReferrer(), void 0 != t && t.length > 0 && (g = cwTracking.addToQS(g, "cat=" + t)), void 0 != e && e.length > 0 && (g = cwTracking.addToQS(g, "act=" + e)), void 0 != i && i.length > 0 && (g = cwTracking.addToQS(g, "lbl=" + i)), void 0 != n && n.length > 0 && (g = cwTracking.addToQS(g, n)), void 0 != r && r.length > 0 && (g = cwTracking.addToQS(g, r)), void 0 != o && o.length > 0 && (g = cwTracking.addToQS(g, o)), c && (a = cwTracking.getQSFromUrl(), void 0 != a && a.length > 0 && (g = cwTracking.addToQS(g, a))), g }, trackCustomData: function (t, e, i, c) { var n = cwTracking.getFinalQS(t, e, i, c); cwTracking.sendRequest(n) }, trackDataFromNode: function (t, e) { var i = cwTracking.getCompleteQS(t, e); cwTracking.sendRequest(i) }, sendRequest: function (t) { t.length > 0 && (t = "&" + t); var e = new Image; e.src = cwTracking.getHandlerUrl() + $.now() + t }, getHandlerUrl: function () { switch (cwTracking.hostPath) { case "www.bikewale.com": return "https://bhrigu.bikewale.com/pixel.gif?t="; case "bikewale.com": return "https://bhrigu.bikewale.com/pixel.gif?t="; case "localhost": return "https://bhrigustg.bikewale.com/pixel.gif?t="; case "webserver": return "https://bhrigustg.bikewale.com/pixel.gif?t="; case "staging.bikewale.com": return "https://bhrigustg.bikewale.com/pixel.gif?t="; default: return "https://bhrigustg.bikewale.com/pixel.gif?t=" } }, trackImpression: function () { $("[cwt]").bind("inview", function (t, e) { if (1 == e) cwTracking.trackDataFromNode($(this), cwTracking.type.impression); else { var i = $(this); i.unbind("inview"), i.removeAttr("cwt") } }) }, trackPerformace: function () { var t, e = 0, i = "", c = ""; if (void 0 != window.performance && void 0 != window.performance.timing) { t = JSON.stringify(window.performance.timing), t = $.parseJSON(t); for (var n in t) c += n + "=" + t[n] + "|"; e = c.length, e > 0 && (c = c.substr(0, e - 1)), i = "DesktopSite", cwTracking.trackCustomData("BWPerformance", i, c, !1) } }, uiEvents: function () { var t = "undefined" != typeof bwTrackingCat ? bwTrackingCat : "BWPageViews", e = "undefined" != typeof bwTrackingAct ? bwTrackingAct : "", i = "undefined" != typeof bwTrackingLab ? bwTrackingLab : "NA"; cwTracking.trackCustomData(t, e, i, !0), $(document).on("click", "[data-cwtccat]", function () { cwTracking.trackDataFromNode($(this), cwTracking.type.click) }), cwTracking.trackImpression(), $(document).ajaxComplete(function () { cwTracking.trackImpression() }) } }; $(window).load(function () { setTimeout(function () { cwTracking.trackPerformace() }, 100) }), $(document).ready(function () { cwTracking.uiEvents() });
