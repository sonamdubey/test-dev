...
namespace Bikewale.Models
{
    ...
    public class PriceInCityPageVM : ModelBase
    {
        ...
        public String ServiceCenterWidget_H2 { get { return (HasServiceCenters ? String.Format("{0} {1} Service centers in {2}",ServiceCenterCount, Make.MakeName, CityEntity.CityName) : ""); } }
