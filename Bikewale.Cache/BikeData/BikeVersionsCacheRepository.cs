    ...
    public class BikeVersionsCacheRepository<T, U> : IBikeVersionCacheRepository<T, U> where T : BikeVersionEntity, new()
    {
        ...
        public IEnumerable<Entities.BikeData.SimilarBikeEntity> GetSimilarBikesList(U versionId, uint topCount, uint cityid)
        {
            ...
            try
            {
                ...
                versions = _cache.GetFromCache<IEnumerable<Entities.BikeData.SimilarBikeEntity>>(key, cacheTime, () => _objVersionsRepository.GetSimilarBikesList(versionId, topCount, cityid));
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<Entities.BikeData.SimilarBikeEntity> GetSimilarBikesByModel(U modelId, uint topCount, uint cityid)
        {
            ...
            try
            {
                ...
                bikelist = _cache.GetFromCache<IEnumerable<Entities.BikeData.SimilarBikeEntity>>(key, cacheTime, () => _objVersionsRepository.GetSimilarBikesByModel(modelId, topCount, cityid));
            }
            catch (Exception ex)
            {
        ...
        public IEnumerable<Entities.BikeData.SimilarBikeEntity> GetSimilarBikesByMinPriceDiff(U modelId, uint topCount, uint cityid)
        {
            ...
            try
            {
                ...
                bikelist = _cache.GetFromCache<IEnumerable<Entities.BikeData.SimilarBikeEntity>>(key, cacheTime, () => _objVersionsRepository.GetSimilarBudgetBikes(modelId, topCount, cityid));
            }
            catch (Exception ex)
            {
        ...
        public List<BikeVersionMinSpecs> GetVersionMinSpecs(uint modelId, bool isNew)
        {
            ...
            try
            {
                versions = _cache.GetFromCache<List<BikeVersionMinSpecs>>(key, new TimeSpan(1, 0, 0), () => _objVersionsRepository.GetVersionMinSpecs(modelId, isNew));
            }
            catch (Exception ex)
            {
