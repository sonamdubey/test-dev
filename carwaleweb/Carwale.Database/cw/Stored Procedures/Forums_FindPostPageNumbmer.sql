IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[cw].[Forums_FindPostPageNumbmer]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [cw].[Forums_FindPostPageNumbmer]
GO
...
-- =============================================      
CREATE PROCEDURE [cw].[Forums_FindPostPageNumbmer]      -- execute cw.Forums_CheckStickyThreads 1278
