IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[cw].[GetDefaultNewsPageDetails_16]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [cw].[GetDefaultNewsPageDetails_16]
GO
...
-- =============================================      
CREATE PROCEDURE [cw].[GetDefaultNewsPageDetails_16.4.8] -- execute cw.[GetDefaultNewsPageDetails_16.4.8]  1, 1, 1000,1
