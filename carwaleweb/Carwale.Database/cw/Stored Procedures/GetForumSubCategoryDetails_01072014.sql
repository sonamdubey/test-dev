IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[cw].[GetForumSubCategoryDetails_01072014]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [cw].[GetForumSubCategoryDetails_01072014]
GO
...
-- =============================================
CREATE  PROCEDURE [cw].[GetForumSubCategoryDetails_01072014] 
