CREATE TABLE [UCAlert].[WeeklyAlerts] (
    [WeeklyAlert_Id]             BIGINT        IDENTITY (1, 1) NOT NULL,
    ...
    [Is_Mailed]                  INT           CONSTRAINT [DF_WeeklyAlerts_Is_Mailed] DEFAULT ((0)) NOT NULL,
    ...
    [CreatedOn]                  DATETIME      CONSTRAINT [DF_WeeklyAlerts_CreatedOn] DEFAULT (getdate()) NULL,
    [IsAlertFromNewDesign]       BIT           NULL
);


GO
CREATE CLUSTERED INDEX [IX_WeeklyAlerts_UsedCarAlert_Id]
    ON [UCAlert].[WeeklyAlerts]([UsedCarAlert_Id] ASC);


GO
CREATE NONCLUSTERED INDEX [IX_WeeklyAlerts_IsMailed]
    ON [UCAlert].[WeeklyAlerts]([Is_Mailed] ASC);
