IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[UCAlert].[RecommendedUsedCarAlertAlgo_14]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [UCAlert].[RecommendedUsedCarAlertAlgo_14]
GO
...
CREATE PROCEDURE [UCAlert].[RecommendedUsedCarAlertAlgo_14.11.1] 
@Price  INT,
@CarVersionId INT,
@CityId INT,
