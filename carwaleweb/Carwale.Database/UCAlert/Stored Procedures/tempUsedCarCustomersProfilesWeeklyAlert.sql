IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[UCAlert].[tempUsedCarCustomersProfilesWeeklyAlert]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [UCAlert].[tempUsedCarCustomersProfilesWeeklyAlert]
GO
...
-- [UCAlert].[tempUsedCarCustomersProfilesWeeklyAlert] 229
-- =============================================
CREATE PROCEDURE [UCAlert].[tempUsedCarCustomersProfilesWeeklyAlert]
@UsedCarAlertId varchar(max)
