IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[UCAlert].[SendUserSearchCriteria]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [UCAlert].[SendUserSearchCriteria]
GO
...
-- =============================================
CREATE PROCEDURE [UCAlert].[SendUserSearchCriteria]
