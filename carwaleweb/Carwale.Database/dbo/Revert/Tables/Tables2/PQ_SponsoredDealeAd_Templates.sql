            ...
            <div style="padding:10px; line-height:1.6em">
                ...
                <div style="margin-bottom:15px;">
                	<table cellpadding="5" cellspacing="0" border="1" width="100%" style="border-collapse:collapse">
                        <tr><td><strong>Car</strong></td><td><strong>@(Model.MakeName+" "+Model.ModelName+" "+Model.VersionName)</strong></td></tr>
                        ...
                        <tr style="display:@(string.IsNullOrEmpty(Model.OfferExistance) ? "none" : "");"><td>Applicable Offers / promotion on this purchase</td><td></td></tr>
                    </table>
                </div>
                <p style="font-family: Arial, Helvetica, sans-serif; font-size:12px; color:#333333; margin:0 0 15px 0;">Please feel free to call us at  <strong>@Model.TollFreeNumber</strong> for any queries.</p>                    
