CREATE TABLE [dbo].[NewCarQuoteOptions] (
    [Id]                    NUMERIC (18)    IDENTITY (11526320, 1) NOT FOR REPLICATION NOT NULL,
    ...
    CONSTRAINT [PK_NewCarQuoteOptions_New] PRIMARY KEY CLUSTERED ([Id] ASC) WITH (FILLFACTOR = 90)
);
