IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetUsedCarModelCountByCity]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetUsedCarModelCountByCity]
GO
...
-- =============================================      
CREATE PROCEDURE [dbo].[GetUsedCarModelCountByCity]   -- exec GetUsedCarModelCountByCity 2,1
