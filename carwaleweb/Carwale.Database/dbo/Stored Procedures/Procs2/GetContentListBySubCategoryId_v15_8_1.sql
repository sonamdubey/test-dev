IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentListBySubCategoryId_v15_8_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentListBySubCategoryId_v15_8_1]
GO
...
CREATE PROCEDURE [dbo].[GetContentListBySubCategoryId_v15_8_1]
		@ApplicationId INT
