IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentListByCategory_v15]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentListByCategory_v15]
GO
...
--================================================================
CREATE PROCEDURE [dbo].[GetContentListByCategory_v15.9.4]
