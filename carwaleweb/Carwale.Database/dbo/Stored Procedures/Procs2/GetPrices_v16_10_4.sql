IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetPrices_v16_10_4]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetPrices_v16_10_4]
GO
...
--==========================================================
CREATE PROCEDURE [dbo].[GetPrices_v16_10_4] @ModelId INT
	,@CityId INT
AS
BEGIN
	DECLARE @StateId INT
