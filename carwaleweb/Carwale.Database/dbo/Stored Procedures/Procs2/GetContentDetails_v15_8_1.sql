IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentDetails_v15_8_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentDetails_v15_8_1]
GO
...
CREATE PROCEDURE [dbo].[GetContentDetails_v15_8_1] @BasicId INT
AS
BEGIN
