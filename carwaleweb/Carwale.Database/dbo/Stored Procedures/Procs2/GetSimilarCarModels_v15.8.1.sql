IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetSimilarCarModels_v15]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetSimilarCarModels_v15]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[GetSimilarCarModels_v15.8.1]
