IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[IMG_CarPhotosUpdateInBetweenProcRQ]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[IMG_CarPhotosUpdateInBetweenProcRQ]
GO
...
-- =============================================      
CREATE PROCEDURE [dbo].[IMG_CarPhotosUpdateInBetweenProcRQ]      
