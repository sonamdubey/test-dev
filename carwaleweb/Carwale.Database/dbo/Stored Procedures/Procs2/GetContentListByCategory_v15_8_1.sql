IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentListByCategory_v15_8_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentListByCategory_v15_8_1]
GO
...
--================================================================
CREATE PROCEDURE [dbo].[GetContentListByCategory_v15_8_1] -- exec [dbo].['GetContentListByCategory_v15_8_1','2',1,100
