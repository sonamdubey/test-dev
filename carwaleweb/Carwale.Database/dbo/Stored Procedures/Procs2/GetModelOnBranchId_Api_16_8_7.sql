IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetModelOnBranchId_Api_16_8_7]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetModelOnBranchId_Api_16_8_7]
GO
...
--	============================================================
CREATE PROCEDURE [dbo].[GetModelOnBranchId_Api_16_8_7] @BranchId INT
