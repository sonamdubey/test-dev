IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetPQVersionDetails_v16_8_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetPQVersionDetails_v16_8_1]
GO
...
-- =============================================
create PROCEDURE [dbo].[GetPQVersionDetails_v16_8_1]
