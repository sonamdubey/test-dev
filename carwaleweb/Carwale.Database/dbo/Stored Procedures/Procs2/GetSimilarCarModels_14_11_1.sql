IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetSimilarCarModels_14_11_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetSimilarCarModels_14_11_1]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[GetSimilarCarModels_14_11_1]
