IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentDetails_v16_5_3]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentDetails_v16_5_3]
GO
...
--================================================================
-- exec [dbo].[GetContentDetails_v15.9.4] 21435
CREATE PROCEDURE [dbo].[GetContentDetails_v16_5_3] @BasicId INT
AS
BEGIN
