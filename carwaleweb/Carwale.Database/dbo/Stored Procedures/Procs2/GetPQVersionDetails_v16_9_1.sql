IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetPQVersionDetails_v16_9_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetPQVersionDetails_v16_9_1]
GO
...
-- =============================================
create PROCEDURE [dbo].[GetPQVersionDetails_v16_9_1]
...
BEGIN
	...
	SELECT 
		...
		,@FuelType=CF.FuelType,@FuelTypeId=CF.FuelTypeId, @SubSegmentId = MO.SubSegmentID, @RootId = MR.RootId, @BodyStyleId = CV.BodyStyleId
