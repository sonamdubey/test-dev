IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentListByCategory_V14111]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentListByCategory_V14111]
GO
...
--================================================================
CREATE PROCEDURE [dbo].[GetContentListByCategory_V14111] -- exec dbo.GetContentListByCategory_V14111 1,'2',1,100
