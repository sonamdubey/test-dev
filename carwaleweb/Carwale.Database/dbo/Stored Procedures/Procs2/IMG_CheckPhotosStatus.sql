IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[IMG_CheckPhotosStatus]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[IMG_CheckPhotosStatus]
GO
...
-- =============================================    
CREATE PROCEDURE [dbo].[IMG_CheckPhotosStatus]    
