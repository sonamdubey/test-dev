IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetModelDetails_v16_6_9]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetModelDetails_v16_6_9]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[GetModelDetails_v16_6_9] --Execute [dbo].[GetModelDetails_v16.1.4] 458
	@ModelId INT
	,@MakeId INT OUTPUT
