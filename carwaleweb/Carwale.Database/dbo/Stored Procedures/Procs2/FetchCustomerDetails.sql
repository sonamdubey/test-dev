IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[FetchCustomerDetails]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[FetchCustomerDetails]
GO
...
CREATE PROCEDURE [dbo].[FetchCustomerDetails]
	@CustomerId		NUMERIC,
...
/****** Object:  StoredProcedure [dbo].[GetMaskingNumberForDealers]    Script Date: 10/3/2014 11:46:26 AM ******/
SET ANSI_NULLS ON
