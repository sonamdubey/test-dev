IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetMostRecentArticles_V14111_BACKUP]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetMostRecentArticles_V14111_BACKUP]
GO
...
CREATE PROCEDURE [dbo].[GetMostRecentArticles_V14111_BACKUP] 
	@ApplicationId INT
