...
-- Modified By:Komal Manjare on 25 July 2016 ,Isdeleted condition for dealers insteadt of status check
 --Modified By : Mihir Chheda On 16 th Aug 2016 , left join on DCRM_ADM_UserDealers and OprUsers table. 
-- =============================================
...
BEGIN
	...
	LEFT JOIN DCRM_ADM_UserDealers DAUD  (NOLOCK) ON D.Id=DAUD.DealerId  AND DAUD.RoleId=3 ---- Mihir Chheda On 16 th Aug 2016
	LEFT JOIN OprUsers OU (NOLOCK) ON OU.Id=DAUD.UserId
	WHERE 
		--D.Status = 0 
		...
		-- AND  DAUD.RoleId=3 -- Mihir Chheda On 16 th Aug 2016
