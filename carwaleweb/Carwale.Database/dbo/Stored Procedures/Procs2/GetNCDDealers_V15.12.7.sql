...
GO
	...
	-- =============================================          
-- Author:  <supriya > exec [GetNCDDealers_V15.12.7] -1,1,18
...
-- =============================================          
CREATE PROCEDURE [dbo].[GetNCDDealers_V15.12.7] (
	@StateId SMALLINT
	,@CityId SMALLINT
	,@MakeId SMALLINT
	)
...
BEGIN
	...
	SELECT D.Id AS Id
		...
		,D.PhoneNo AS LandLineNo
		, -1 AS CampaignId
		,0 as ShowEmail --added by Ashwini Todkar
		,-1 as LeadPanel --added by Ashwini Todkar
		,-1 as DealerLeadBusinessType --added by Ashwini Todkar
		,mi.HostURL
		,mi.OriginalImgPath
		,mdc.DealerContent
