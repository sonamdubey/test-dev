IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetCampaignById_v16_7_6]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetCampaignById_v16_7_6]
GO
...
-- Modified: Shalini Nair,25/07/2016 to fetch ShowInRecommendation
-- ===================================================================================================

CREATE PROCEDURE [dbo].[GetCampaignById_v16_7_6] @CampaignId INT
