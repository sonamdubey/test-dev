...
-- =============================================
CREATE  PROCEDURE   [dbo].[GetIndividualListingDetails_15.8.1] 
...
BEGIN
	...
	GROUP BY CSI.ID,MA.NAME + ' ' + MO.NAME + ' ' + VE.NAME ,VE.ID ,CSI.CarRegNo,CSI.EntryDate,CSI.Price,CSI.MakeYear
		...
		,CSI.ClassifiedExpiryDate,CSI.PackageExpiryDate,CP.ImageUrlThumbSmall,CP.HostURL,CP.DirectoryPath ,CP.OriginalImgPath,CSI.PackageType,VE.CarModelId ,P.Name,P.Amount,CSI.PackageId,CSI.IsPremium,CSI.CurrentStep
