IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetCompulsoryCharges]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetCompulsoryCharges]
GO
...
-- Description:	To get Compulsory Charges (Dealer Charges) for model city Combination
-- EXEC [GetCompulsoryCharges] 10,269
-- =============================================
CREATE PROCEDURE [dbo].[GetCompulsoryCharges]
...
/****** Object:  StoredProcedure [dbo].[GetOptionalCharges]    Script Date: 05-07-2016 11:36:27 ******/
-- SET ANSI_NULLS ON
