...
-- =============================================
CREATE  PROCEDURE [dbo].[GetAggregateOffers_V14.11.3.2]
...
BEGIN
	...
	WITH  CTE AS (
	SELECT 
	DO.ID As OfferId,DO.MaxOfferValue, DOD.DealerId,DO.OfferTitle,DO.OfferDescription,(DO.OfferUnits - DO.ClaimedUnits) AS AvailabiltyCount,('http://' + DO.HostURL + DO.ImagePath + DO.ImageName)AS ImageUrl,DO.OfferType,
			 CONVERT(varchar, DO.EndDate, 106) AS ExpiryDate,OV.MakeId AS MakeId,CMA.Name AS MakeName, OV.ModelId AS ModelId,OV.VersionId AS VersionId,DOD.CityId AS CityId,DOD.ZoneId AS ZoneId
			 ,CityName = (CASE WHEN ZoneId > 0 THEN CZ.ZoneName ELSE C.Name END),CMO.Name As ModelName,CV.Name AS VersionName,DO.SourceCategory AS SourceCategory,
