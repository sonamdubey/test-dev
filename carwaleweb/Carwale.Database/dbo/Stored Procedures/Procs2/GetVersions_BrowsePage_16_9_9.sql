IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetVersions_BrowsePage_16_9_9]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetVersions_BrowsePage_16_9_9]
GO
...
-- Modified By : Ajay Singh on 26-09-2016 fetched transmission name
-- =============================================
create PROCEDURE [dbo].[GetVersions_BrowsePage_16_9_9]
...
BEGIN
   ...
   -- Insert statements for procedure here
       ...
       IsNull(CV.ReviewCount, 0) AS ReviewCount,
	    CV.BodyStyleId,
		SD.TransmissionType,--adde by ajay singh
		CASE  
