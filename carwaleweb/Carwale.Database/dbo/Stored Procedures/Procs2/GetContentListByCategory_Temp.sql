IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentListByCategory_Temp]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentListByCategory_Temp]
GO
...
--================================================================
CREATE PROCEDURE [dbo].[GetContentListByCategory_Temp]
