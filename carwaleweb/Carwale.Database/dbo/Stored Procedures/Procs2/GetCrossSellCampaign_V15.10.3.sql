...
-- =============================================
CREATE PROCEDURE [dbo].[GetCrossSellCampaign_V15.10.3]
...
AS
BEGIN
	SELECT CMK.Name AS CrossSellMakeName,CM.Name AS CrossSellModelName,CV.Name AS CrossSellVersionName,CSR.CrossSellVersion AS CrossSellVersionId,CV.CarModelId AS CrossSellModelId,SDT.TemplateId AS TemplateId,SDT.TemplateName FROM PQ_CrossSellCampaignRules CSR WITH (NOLOCK)
