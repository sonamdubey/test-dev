IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[IMG_AllCarPhotosInsert]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[IMG_AllCarPhotosInsert]
GO
...
-- =============================================    
CREATE PROCEDURE [dbo].[IMG_AllCarPhotosInsert]    
...
SET @Url = 'http://'+@HostUrl+@DirPath+@OrigFileName
