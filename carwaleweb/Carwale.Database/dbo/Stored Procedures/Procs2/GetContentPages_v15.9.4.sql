IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentPages_v15]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentPages_v15]
GO
...
CREATE  PROCEDURE [dbo].[GetContentPages_v15.9.4] @BasicId INT
AS
BEGIN
