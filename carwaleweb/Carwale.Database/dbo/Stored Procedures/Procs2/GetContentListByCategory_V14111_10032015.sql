IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentListByCategory_V14111_10032015]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentListByCategory_V14111_10032015]
GO
...
--================================================================
CREATE PROCEDURE [dbo].[GetContentListByCategory_V14111_10032015] -- exec dbo.GetContentListByCategory_V14111 1,'1',1,10
