IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetRelatedArticles_v15_8_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetRelatedArticles_v15_8_1]
GO
...
CREATE PROCEDURE [dbo].[GetRelatedArticles_v15_8_1]
		@ApplicationId INT
