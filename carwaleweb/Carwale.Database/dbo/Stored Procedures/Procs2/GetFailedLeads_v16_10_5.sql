IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetFailedLeads_v16_10_5]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetFailedLeads_v16_10_5]
GO
...
-- EXEC [GetFailedLeads_v16_10_5] '2016-01-01','2016-11-01','Failed'
-- =============================================
CREATE PROCEDURE [dbo].[GetFailedLeads_v16_10_5] @StartDate DATE
	,@EndDate DATE
	,@LeadType VARCHAR(10)
AS
BEGIN
