IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentPages_v16_5_3]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentPages_v16_5_3]
GO
...
CREATE PROCEDURE [dbo].[GetContentPages_v16_5_3] @BasicId INT
AS
BEGIN
