IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetNCDDealers_V16_8_7]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetNCDDealers_V16_8_7]
GO
...
-- Modified : Vicky Lund, 24/08/2016, Removed +91 and fetched landline code as well
-- EXEC [GetNCDDealers_V16_8_7] 1,1,8
-- Modified: Vicky Lund, 26-10-2016, Added check of isDeleted column
-- =============================================================================================================================
CREATE PROCEDURE [dbo].[GetNCDDealers_V16_8_7] (
	@StateId SMALLINT
	,@CityId SMALLINT
	,@MakeId SMALLINT
	)
