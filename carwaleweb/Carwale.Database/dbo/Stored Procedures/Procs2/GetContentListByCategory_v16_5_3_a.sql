IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentListByCategory_v16_5_3_a]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentListByCategory_v16_5_3_a]
GO
...
--================================================================
CREATE PROCEDURE [dbo].[GetContentListByCategory_v16_5_3_a]
