IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetContentPages_15_8_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetContentPages_15_8_1]
GO
...
-- Modified by Satish Sharma On 23/Jul/2015, Image dynamic resize revamp
CREATE PROCEDURE [dbo].[GetContentPages_15_8_1] @BasicId INT
AS
BEGIN
