IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[NewRecommendCars_16_12_3]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[NewRecommendCars_16_12_3]
GO
...
*/
CREATE PROCEDURE [dbo].[NewRecommendCars_16_12_3]
