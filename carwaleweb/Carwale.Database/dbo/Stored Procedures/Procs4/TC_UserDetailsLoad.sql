IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_UserDetailsLoad]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_UserDetailsLoad]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[TC_UserDetailsLoad]
