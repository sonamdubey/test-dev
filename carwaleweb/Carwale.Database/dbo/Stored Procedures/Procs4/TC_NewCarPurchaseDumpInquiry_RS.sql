IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_NewCarPurchaseDumpInquiry_RS]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_NewCarPurchaseDumpInquiry_RS]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[TC_NewCarPurchaseDumpInquiry_RS] 
