IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_PaymentReceivedAdd]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_PaymentReceivedAdd]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[TC_PaymentReceivedAdd]
(
