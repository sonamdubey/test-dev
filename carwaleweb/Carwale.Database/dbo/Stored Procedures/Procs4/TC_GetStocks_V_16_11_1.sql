IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_GetStocks_V_16_11_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_GetStocks_V_16_11_1]
GO
...
-- ============================================================================================================================  
CREATE PROCEDURE [dbo].[TC_GetStocks_V_16_11_1] (
	@BranchId BIGINT
