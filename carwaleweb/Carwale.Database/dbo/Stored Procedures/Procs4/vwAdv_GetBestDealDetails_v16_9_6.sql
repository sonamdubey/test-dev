IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[vwAdv_GetBestDealDetails_v16_9_6]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[vwAdv_GetBestDealDetails_v16_9_6]
GO
...
-- =============================================
CREATE  PROCEDURE [dbo].[vwAdv_GetBestDealDetails_v16_9_6] @ModelId INT
	,@CityId INT
	,@VersionId INT = NULL
AS
BEGIN
