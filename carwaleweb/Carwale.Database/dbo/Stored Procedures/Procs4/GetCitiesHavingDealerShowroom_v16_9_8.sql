IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[GetCitiesHavingDealerShowroom_v16_9_8]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[GetCitiesHavingDealerShowroom_v16_9_8]
GO
-- Author:Akansha
...
-- Modified by : Prachi Phalak on 22-09-2016 Removed check of EndDate.

CREATE PROCEDURE [dbo].[GetCitiesHavingDealerShowroom_v16_9_8]
AS
BEGIN
