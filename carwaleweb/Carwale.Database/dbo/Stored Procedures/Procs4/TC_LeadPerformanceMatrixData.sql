IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_LeadPerformanceMatrixData]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_LeadPerformanceMatrixData]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[TC_LeadPerformanceMatrixData]
	@BranchID INT 
AS
BEGIN
