IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_TMDistributeTarget]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_TMDistributeTarget]
GO

	-- =============================================
-- Author	:	    Tejashree Patil
-- Create date	:	18 Dec 2013
-- Description	:	Distribute target for the first screen for AutoBiz2 	
-- EXEC  [dbo].[TC_TMDistributeTarget] 1,40000,NULL,2013
-- =============================================
CREATE  PROCEDURE [dbo].[TC_TMDistributeTarget] 
