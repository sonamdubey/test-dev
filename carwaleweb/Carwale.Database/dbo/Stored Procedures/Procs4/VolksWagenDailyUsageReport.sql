IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[VolksWagenDailyUsageReport]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[VolksWagenDailyUsageReport]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[VolksWagenDailyUsageReport]	
AS
BEGIN
