IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_SaveStockInfo_SP_2012]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_SaveStockInfo_SP_2012]
GO
...
CREATE PROCEDURE [dbo].[TC_SaveStockInfo_SP_2012]
