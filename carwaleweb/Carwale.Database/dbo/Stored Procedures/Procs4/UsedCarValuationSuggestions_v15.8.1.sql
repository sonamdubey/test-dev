...
-- =============================================
CREATE PROCEDURE [dbo].[UsedCarValuationSuggestions_v15.8.1] @Version INT
	,@MakeYear DATETIME
	,@Cityid INT
	,@CarKm BIGINT
	,@CarPrice [numeric] (
...
BEGIN
	...
	BEGIN
		...
		--set @CarPrice=1000
		SET @sql = ' select top ' + cast(@cnt AS CHAR(2)) + '  L.ProfileId,Seller,L.MakeName+'' ''+L.ModelName+'' ''+L.VersionName as CarName,L.MakeName,L.ModelName,CMO.MaskingName,L.CityName,L.AreaName,L.MakeYear,L.Price,L.Kilometers,L.FrontImagePath,L.HostURL,L.ImageUrlMedium,L.IsPremium, L.OriginalImgPath ' +
