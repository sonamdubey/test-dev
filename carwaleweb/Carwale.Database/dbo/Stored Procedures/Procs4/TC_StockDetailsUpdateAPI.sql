IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_StockDetailsUpdateAPI]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_StockDetailsUpdateAPI]
GO
...
-- =============================================  
CREATE PROCEDURE [dbo].[TC_StockDetailsUpdateAPI] @StockId BIGINT
	,
