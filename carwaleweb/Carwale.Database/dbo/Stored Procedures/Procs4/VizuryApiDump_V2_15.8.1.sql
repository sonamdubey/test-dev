IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[VizuryApiDump_V2_15]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[VizuryApiDump_V2_15]
GO
...
-- Modified By: Shalini Nair on 12/08/2015 retrieving OriginalImgPath
-- =============================================
CREATE PROCEDURE [dbo].[VizuryApiDump_V2_15.8.1] 
