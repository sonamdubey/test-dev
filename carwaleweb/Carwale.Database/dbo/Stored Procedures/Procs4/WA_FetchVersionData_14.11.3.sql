IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[WA_FetchVersionData_14]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[WA_FetchVersionData_14]
GO
...
CREATE PROCEDURE [dbo].[WA_FetchVersionData_14.11.3]
...
EXECUTE [dbo].[WA_GetVersionDetails_14.11.3] @versionId,@CityId
