IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TempSetHostURLForImages]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TempSetHostURLForImages]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[TempSetHostURLForImages]
