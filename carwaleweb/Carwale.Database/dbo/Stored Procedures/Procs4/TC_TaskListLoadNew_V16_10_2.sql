IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_TaskListLoadNew_V16_10_2]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_TaskListLoadNew_V16_10_2]
GO
...
-- EXEC [dbo].[TC_TaskListLoadNew_V16_10_2] 1,5,243,1,10,null,null,null,null,null,null,1,null,null,null,null,10,null,null,3,2
--exec [dbo].[TC_TaskListLoadNew_V16_10_2] 4,20553,88927,1,20,null,null,null,null,null,null,1,null,null,null,null,27,null,null,6,5,0
--exec [dbo].[TC_TaskListLoadNew_V16_10_2] 3,20466,88916,1,20,null,null,null,null,null,null,1,null,null,null,null,12,null,null,4,null,0,null
-- exec [dbo].[TC_TaskListLoadNew_V16_10_2] 2,20553,88927,1,20,null,null,null,null,null,null,1,null,null,null,null,33,null,null,6,null,2,null,0   --from dashboard
...
-- Modified By : Khushaboo Patil on 26 oct 2016 , fetch expirydate
-- ======================================================================================================
create PROCEDURE [dbo].[TC_TaskListLoadNew_V16_10_2]
...
BEGIN
	IF @RequestType = 1 -- Page Load
		BEGIN
			...
			EXEC [TC_TaskListPageLoad_V16_10_2] @BranchId-- Added By : Tejashree Patil on 28 Sept 2016
				,@UserId
				,@LeadBucketId
				,@BusinessTypeId
				,@MasterDispositionId
	...
	ELSE
		IF @RequestType = 2 -- Pagination
			EXEC [TC_TaskListPaging_V16_10_2] @BranchId-- Added By : Tejashree Patil on 28 Sept 2016
				,@UserId
				,@LeadBucketId
				,@FromIndex
				,@ToIndex
		...
		ELSE
			IF @RequestType = 3 -- Searching
				EXEC [TC_TaskListLoadSearch_V16_10_2] @BranchId-- Added By : Tejashree Patil on 28 Sept 2016
					,@UserId
					,@FromIndex
					,@ToIndex
					,@CustomerName
			...
			ELSE
				IF @RequestType = 4 -- Excel Data
					EXEC [TC_TaskData_V16_10_2] @UserId-- Added By : Tejashree Patil on 28 Sept 2016
						,@BranchId
						,@TopCount
						,@LeadBucketId
						,@BusinessTypeId
