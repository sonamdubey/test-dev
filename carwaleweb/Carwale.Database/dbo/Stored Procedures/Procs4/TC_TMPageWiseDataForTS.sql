IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_TMPageWiseDataForTS]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_TMPageWiseDataForTS]
GO
...
--- EXEC  [dbo].[TC_TMPageWiseData] 	@PageId=7
 -- =============================================
CREATE PROCEDURE [dbo].[TC_TMPageWiseDataForTS] 
	@PageId TINYINT,
