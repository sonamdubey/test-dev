IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_PayReciptPrint_11292011]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_PayReciptPrint_11292011]
GO
...
-- =============================================  
CREATE PROCEDURE [dbo].[TC_PayReciptPrint_11292011]  
(  
