IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_TaskListUpdateInsurance_16_10_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_TaskListUpdateInsurance_16_10_1]
GO
...
-- Modified By : Added by Khushaboo Patil on 26 th oct 2016 (insert ExpiryDate in tasklist)
-- =========================================================================================
create PROCEDURE [dbo].[TC_TaskListUpdateInsurance_16_10_1]
	@CallId BIGINT
	...
	IF NOT EXISTS (SELECT TC_CallsId FROM TC_TaskLists WITH (NOLOCK) WHERE TC_CallsId = @CallId)
		BEGIN
			...
			SELECT TOP 1 TCIL.TC_InquiriesLeadId
				...
				,TII.ExpiryDate -- Added by Khushaboo Patil on 26 th oct 2016
