IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[VizuryApiDump]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[VizuryApiDump]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[VizuryApiDump] 
...
,isnull(IV.ItemValue,' ') 'arai_mileadge'
,isnull(NCS.Displacement,' ') 'cc'
...
/****** Object:  StoredProcedure [dbo].[ClientMissedCallVerification]    Script Date: 3/16/2015 4:36:15 PM ******/
SET ANSI_NULLS ON
