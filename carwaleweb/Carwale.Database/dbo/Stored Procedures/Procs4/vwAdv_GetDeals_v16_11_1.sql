IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[vwAdv_GetDeals_v16_11_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[vwAdv_GetDeals_v16_11_1]
GO
-- =============================================
-- Author:		<Mukul Bansal>
...
-- Modified By: Saket Thapliyal on 17/11/2016
-- Description: Replaced vwLiveDeals by LiveDeals 
-- =============================================
CREATE PROCEDURE [dbo].[vwAdv_GetDeals_v16_11_1] 
	@CityId int,
	@StartIndex int ,
    @EndIndex int, 
    @Makes varchar(100),
