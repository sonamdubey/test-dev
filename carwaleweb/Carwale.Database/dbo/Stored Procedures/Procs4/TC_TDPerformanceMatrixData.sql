IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_TDPerformanceMatrixData]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_TDPerformanceMatrixData]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[TC_TDPerformanceMatrixData]
	@BranchID INT 
AS
BEGIN
