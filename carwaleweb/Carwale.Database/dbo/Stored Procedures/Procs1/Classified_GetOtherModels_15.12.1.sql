...
-- Modified By : Purohith Guguloth on 22nd june, 2015
  ...
  --Modified by Sahil Sharma on 25-11-2015 (Added fuel and transmission type)
-- =============================================
CREATE PROCEDURE [dbo].[Classified_GetOtherModels_15.12.1]
	...
	BEGIN 
			...
			LEFT Join CarVersions CV WITH(NOLOCK) --Added by Sahil Sharma on 25-11-2015
					ON LL.VersionId=CV.ID
			LEFT JOIN CarFuelType CFT WITH (NOLOCK) --Added by Sahil Sharma on 25-11-2015 
					ON CFT.FuelTypeId = CV.CarFuelType
			LEFT JOIN CarTransmission CR WITH (NOLOCK)  --Added by Sahil Sharma on 25-11-2015
