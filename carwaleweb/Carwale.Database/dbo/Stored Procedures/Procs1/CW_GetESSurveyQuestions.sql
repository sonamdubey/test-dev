...
-- modified by piyush 
-- Description:  Added multiselect option to fetch isMultiselect from table
-- ======================================================================
CREATE PROCEDURE [dbo].[CW_GetESSurveyQuestions] @CampaignId INT = NULL
AS
BEGIN
	SELECT Q.Id
		,Q.QuestionNumber
	...
	SELECT O.Id
		...
		,O.OptionValue
		,O.OptionNumber
	FROM CW_ESSurveyCampaigns C WITH (NOLOCK)
