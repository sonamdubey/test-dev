IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[AbSure_GetOverallSummary]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[AbSure_GetOverallSummary]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[AbSure_GetOverallSummary] 
(
	@UserId          INT
)
AS
