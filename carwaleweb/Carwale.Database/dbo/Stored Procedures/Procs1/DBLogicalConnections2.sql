IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[DBLogicalConnections2]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[DBLogicalConnections2]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[DBLogicalConnections2]	
AS
BEGIN
