IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[BW_GetDealersLatLong_21032016]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[BW_GetDealersLatLong_21032016]
GO
...
-- EXEC BW_GetDealersLatLong_21032016 165,36
-- =============================================
CREATE PROCEDURE [dbo].[BW_GetDealersLatLong_21032016] 
	@VersionId INT
	,@AreaId INT
AS
BEGIN
