IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[CW_SaveFinanceLeads_v16_8_6]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[CW_SaveFinanceLeads_v16_8_6]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[CW_SaveFinanceLeads_v16_8_6]
...
BEGIN
	...
	ELSE
		...
		select @FinanceLeadId as FinanceLeadId
END
