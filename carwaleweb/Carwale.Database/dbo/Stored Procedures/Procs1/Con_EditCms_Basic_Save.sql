IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[Con_EditCms_Basic_Save]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[Con_EditCms_Basic_Save]
GO
...
CREATE PROCEDURE [dbo].[Con_EditCms_Basic_Save] @CategoryId NUMERIC(18, 0)
	,@Title VARCHAR(250)
