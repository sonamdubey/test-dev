IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[Con_EditCms_PublishArticle_v16_9_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[Con_EditCms_PublishArticle_v16_9_1]
GO
...
-- Modified by Meet Shah on 1 September 2016 to remove PushNotification
CREATE PROCEDURE [dbo].[Con_EditCms_PublishArticle_v16_9_1]  
@BasicId INT,  
@Path VARCHAR(50),  
@AddToForum BIT,  
@CustomerId INT,  
