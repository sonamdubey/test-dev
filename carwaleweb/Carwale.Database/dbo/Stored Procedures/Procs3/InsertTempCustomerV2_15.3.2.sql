...
--Modified by Rakesh Yadav On 2 Feb 2016, stop saving customers password in plaintext
-- =============================================
CREATE PROCEDURE [dbo].[InsertTempCustomerV2_15.3.2] 
	@Name VARCHAR(100)
	,@Email VARCHAR(100)
	,@Mobile VARCHAR(20)
	,
...
BEGIN
	...
	BEGIN
		...
		INSERT INTO Customers (NAME,Email,Mobile,CityId,StateId,ReceiveNewsletters,RegistrationDateTime,IsVerified,IsFake,PwdSaltHashStr,FbId,GplusId,OAuth,IsEmailVerified)
		VALUES				(@Name,@Email,@Mobile,@CityId,@State,@ReceiveNewsletters,@RegistrationDateTime,1,0,@PwdSaltHashStr,@FbId,@GplusId,@NewOAuth,@OpenIDVerified)
