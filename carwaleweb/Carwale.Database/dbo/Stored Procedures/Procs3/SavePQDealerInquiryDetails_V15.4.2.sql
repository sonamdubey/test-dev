...
--Modified By : Shalini Nair on 30/09/2015 Storing campaignid and assigned default value to dealerid
-- =============================================
CREATE PROCEDURE [dbo].[SavePQDealerInquiryDetails_V15.4.2] 
...
BEGIN
	...
	INSERT INTO PQDealerAdLeads(PQId,DealerId,LeadClickSource,DealerLeadBusinessType,Name,Email,Mobile,AssignedDealerID,CityId,ZoneId,VersionId,PlatformId,LTSRC,Comment,CampaignId) 
	                   values (@PQId,@DealerId,@LeadClickSource,@DealerLeadBusinessType,@Name,@Email,@Mobile,@AssignedDealerId,@CityID,@ZoneID,@VersionId,@PlatformId,@LTSRC,@Comment,@CampaignId)
