IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[OLM_AudiBE_GradesFeatures]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[OLM_AudiBE_GradesFeatures]
GO
...
--Modified By : Rakesh Yadav 18 Aug 2014 fetching g.Priority AS FeaturePriority column
...
CREATE PROCEDURE [dbo].[OLM_AudiBE_GradesFeatures] @TransactionId INTEGER
