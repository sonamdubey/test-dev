IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[RetrieveVideoParameters_16]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[RetrieveVideoParameters_16]
GO
...
-- ============================================= 
CREATE PROCEDURE [dbo].[RetrieveVideoParameters_16.2.3]
