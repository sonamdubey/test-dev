IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[RetrieveSimilarCarsVideos_15]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[RetrieveSimilarCarsVideos_15]
GO
...
-- ============================================= 
CREATE PROCEDURE [dbo].[RetrieveSimilarCarsVideos_15.8.1] --[dbo].[RetrieveSimilarCars] 13827,1
