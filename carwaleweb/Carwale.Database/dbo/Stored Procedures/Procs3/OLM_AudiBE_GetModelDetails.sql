IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[OLM_AudiBE_GetModelDetails]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[OLM_AudiBE_GetModelDetails]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[OLM_AudiBE_GetModelDetails]
