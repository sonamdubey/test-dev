IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[InsertThirdPartyLeadQueue_16_8_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[InsertThirdPartyLeadQueue_16_8_1]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[InsertThirdPartyLeadQueue_16_8_1]
