IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_Deals_AddEditStocks_v_16_8_3]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_Deals_AddEditStocks_v_16_8_3]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[TC_Deals_AddEditStocks_v_16_8_3] 
	@BranchId INT, 
	@CarVersionId INT, 
	@MakeYear DATETIME, 
	@VersionColorId INT,
