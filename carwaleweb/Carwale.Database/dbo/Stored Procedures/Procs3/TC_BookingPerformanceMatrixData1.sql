IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_BookingPerformanceMatrixData1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_BookingPerformanceMatrixData1]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[TC_BookingPerformanceMatrixData1]
	@BranchID INT 
AS
BEGIN
