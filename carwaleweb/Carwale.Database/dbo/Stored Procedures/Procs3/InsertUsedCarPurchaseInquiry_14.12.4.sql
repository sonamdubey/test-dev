IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[InsertUsedCarPurchaseInquiry_14]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[InsertUsedCarPurchaseInquiry_14]
GO
...
CREATE  PROCEDURE   [dbo].[InsertUsedCarPurchaseInquiry_14.12.4]    
