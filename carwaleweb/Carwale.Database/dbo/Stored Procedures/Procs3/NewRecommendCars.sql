IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[NewRecommendCars]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[NewRecommendCars]
GO
...
*/
CREATE PROCEDURE [dbo].[NewRecommendCars]
...
*/		
	...
	SELECT T.ModelID, CMA.Name MkName,CMO.Name MoName,'http://'+CMO.HostURL+CMO.LargePic img
	,CMO.Summary
	,VCount
	,Score
	,PriceMax
...
/****** Object:  StoredProcedure [dbo].[GetValuationVersions]    Script Date: 6/9/2015 7:23:08 AM ******/
SET ANSI_NULLS ON
