...
-- Modified by Afrose on 14th April 2016, added input parameter IMEI 
 --Modified by Prachi Phalak on 25/04/2016-Added notificationId for app notification.
 -- Modified by Navead on 31/05/2016 - Moved the scope Identity to correct place
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  
    
--THIS PROCEDURE IS FOR INSERTING AND UPDATING RECORDS FOR SellInquiries TABLE    
    
CREATE  PROCEDURE   [dbo].[InsertUsedCarPurchaseInquiry_16.4.8]    
 ...
 @notificationId TINYINT = 0 --Modified by Prachi Phalak on 25/04/2016-Added notificationId for app notification.
 AS    
 BEGIN 
 ...
 SET @SentSMS = 0
  ...
  BEGIN      
    ...
    INSERT INTO UsedCarPurchaseInquiries(CustomerId, SellInquiryId,     
     ...
     NoOfCars, BuyTime, CarModelIds, CarModelNames, Comments, RequestDateTime, IsApproved, SourceId,IPAddress,LTSrc,Cwc,UtmaCookie,UtmzCookie,UsedCarPurchaseOriginId,NotificationId,IMEICode)    
    VALUES( @CustomerId, @SellInquiryId,     
	 ...
	 @UtmaCookie,@UtmzCookie,@OriginId,@notificationId,@IMEICode)    
