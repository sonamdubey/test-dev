IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[RetrieveVideosByMake_14]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[RetrieveVideosByMake_14]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[RetrieveVideosByMake_14.11.3]
