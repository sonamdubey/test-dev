...
CREATE PROCEDURE [dbo].[InsertClassifiedRequests_16.4.8]
 ...
 AS
	BEGIN
		...
		BEGIN
			...
			SET @InquiryId = SCOPE_IDENTITY()  -- Modified by Navead on 31/05/2016 - Moved the scope Identity to correct place
