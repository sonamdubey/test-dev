IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[RetrieveVideosBySubCategory]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[RetrieveVideosBySubCategory]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[RetrieveVideosBySubCategory] --[dbo].[RetrieveVideosBySubCategory] 2,1,1,9
