IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_BookingWarrantiesView]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_BookingWarrantiesView]
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[TC_BookingWarrantiesView]
(
@DealerId NUMERIC
)
