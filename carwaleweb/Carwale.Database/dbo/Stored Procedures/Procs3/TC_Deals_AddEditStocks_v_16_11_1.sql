IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[TC_Deals_AddEditStocks_v_16_11_1]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [dbo].[TC_Deals_AddEditStocks_v_16_11_1]
GO
...
--Modifier      : Anchal gupta change the input vin table from [TC_Deals_VIN] to [TC_Deals_VINs] as [TC_Deals_VINs] has one more column colorId
-- =============================================
CREATE PROCEDURE [dbo].[TC_Deals_AddEditStocks_v_16_11_1] 
	@BranchId INT, 
	@CarVersionId INT, 
	@MakeYear DATETIME, 
	@VersionColorId INT,
