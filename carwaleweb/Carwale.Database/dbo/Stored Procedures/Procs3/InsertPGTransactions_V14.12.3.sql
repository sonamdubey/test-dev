...
BEGIN
	...
	BEGIN CATCH
		...
		VALUES('MysqlSync','InsertPGTransactions_V14.12.3',ERROR_MESSAGE(),'SyncDealersWithMysqlUpdate',@RecordId,GETDATE(),@InsertType)
	END CATCH		
	...
	BEGIN CATCH
		INSERT INTO CarWaleMyslSyncExceptions(ModuleName,SPName,ErrorMsg,TableName,FailedId,CreatedOn,InputParameter)
		VALUES('MysqlSync','InsertPGTransactions_V14.12.3',ERROR_MESSAGE(),'SyncPGTransactionsWithMysqlUpdate',@RecordId,GETDATE(),2)
	END CATCH	
	END
	ELSE
	BEGIN
	...
	BEGIN CATCH
		INSERT INTO CarWaleMyslSyncExceptions(ModuleName,SPName,ErrorMsg,TableName,FailedId,CreatedOn,InputParameter)
		VALUES('MysqlSync','InsertPGTransactions_V14.12.3',ERROR_MESSAGE(),'SyncPGTransactionsWithMysqlUpdate',@Id,GETDATE(),@UpdateType)
	END CATCH	
	...
	BEGIN CATCH
		INSERT INTO CarWaleMyslSyncExceptions(ModuleName,SPName,ErrorMsg,TableName,FailedId,CreatedOn,InputParameter)
		VALUES('MysqlSync','InsertPGTransactions_V14.12.3',ERROR_MESSAGE(),'SyncConsumerPackageRequestsWithMysqlUpdate',@PckReqId,GETDATE(),3)
	END CATCH	
	 END
    --------------------------------------------------------------------------------------------------------------
