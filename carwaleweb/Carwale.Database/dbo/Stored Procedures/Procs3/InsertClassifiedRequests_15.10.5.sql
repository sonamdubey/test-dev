...
CREATE    PROCEDURE [dbo].[InsertClassifiedRequests_15.10.5]
 ...
 AS
	BEGIN
		...
		BEGIN
			INSERT INTO ClassifiedRequests(SellInquiryId, CustomerId, Comments,SourceId, RequestDateTime,IPAddress,LTSrc,Cwc,UtmaCookie,UtmzCookie)
			VALUES (@SellInquiryId,@CustomerId, @Comments, @SourceId, @RequestDateTime,@IPAddress,@LTsrc,@Cwc,@UtmaCookie,@UtmzCookie)
