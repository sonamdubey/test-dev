...
-- =============================================
CREATE PROCEDURE [dbo].[SavePQDealerInquiryDetails_V15.9.5] 
...
BEGIN
	...
	ELSE 
		BEGIN
			INSERT INTO PQDealerAdLeads(PQId,DealerId,LeadClickSource,DealerLeadBusinessType,Name,Email,Mobile,AssignedDealerID,CityId,ZoneId,VersionId,PlatformId,LTSRC,Comment,UtmaCookie,UtmzCookie,CampaignId) values (@PQId,@DealerId,@LeadClickSource,@DealerLeadBusinessType,@Name,@Email,@Mobile,@AssignedDealerId,@CityID,@ZoneID,@VersionId,@PlatformId,@LTSRC,@Comment,@UtmaCookie,@UtmzCookie,@CampaignId)
