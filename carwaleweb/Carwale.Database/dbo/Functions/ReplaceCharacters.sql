IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[dbo].[ReplaceCharacters]') 
    AND xtype IN (N'FN', N'IF', N'TF')
)
    DROP FUNCTION [dbo].[ReplaceCharacters]
GO
...
-- ==========================================================================================
CREATE FUNCTION [dbo].[ReplaceCharacters](@iString varchar(300), @validChars varchar(50))
