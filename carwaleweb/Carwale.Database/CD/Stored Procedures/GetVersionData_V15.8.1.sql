IF EXISTS (
    SELECT * FROM sysobjects WHERE id = object_id(N'[CD].[GetVersionData_V15]') 
    AND xtype IN (N'P')
)
    DROP PROCEDURE [CD].[GetVersionData_V15]
GO
