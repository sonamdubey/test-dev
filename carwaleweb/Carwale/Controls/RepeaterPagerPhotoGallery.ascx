<%@ Control Language="C#" AutoEventWireUp="false" Inherits="Carwale.UI.Controls.RepeaterPagerPhotoGallery" Debug="false" %>
<table id="tbl_res" border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr class="dgNavDivTop hide" id="TopPager" runat="server">
