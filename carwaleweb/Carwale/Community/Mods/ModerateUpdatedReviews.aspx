<%@ Page trace="false" Inherits="Carwale.UI.Community.Mods.ModerateUpdatedReviews" AutoEventWireUp="false" Language="C#" %>
<!doctype html>
<html>
<head>
	...
	function fnApprove(reviewId){
		...
		if(ret) {
			...
			$.ajax({
				...
				data: '{"reviewId":"'+ reviewId +'", "customerId":"'+ customerId +'"}',
				beforeSend: function(xhr) { xhr.setRequestHeader("X-AjaxPro-Method", "ApproveUpdatedReview"); },
	...
	function fnDelete(reviewId){
		...
		if(ret) {
			$.ajax({
				...
				beforeSend: function(xhr) { xhr.setRequestHeader("X-AjaxPro-Method", "DeleteUpdatedReview"); },
				success: function(response) {											
					var responseJSON = eval('('+ response +')');
					if(responseJSON.value == false) alert("Technical Error!!"); 
					else  {
                ...
                <div class="grid-12">
                    <div class="breadcrumb margin-bottom15">
                        ...
                        <ul class="special-skin-text">
                            ...
                            <li><span class="fa fa-angle-right margin-right10"></span>Unverified updated reviews</li>
                        </ul>
                        <div class="clear"></div>
                    </div>
                    <h1 class="font30 text-black special-skin-text">List of unverified updated reviews</h1>
	                        ...
	                        <asp:Repeater ID="dtgrdForums" runat="server">
		                        ...
		                        <itemtemplate>
			                        ...
			                        <tr class="item" rowid='<%# DataBinder.Eval(Container.DataItem,"ReviewId")%>'>
				                        ...
				                        <td colspan="2">
					                        <a href="/Research/userreviews/reviewdetails.aspx?rid=<%#DataBinder.Eval(Container.DataItem,"ReviewId")%>"><strong>View this review currently on CarWale</strong></a>
				                        </td>
			                        </tr>
			                        <tr class="item" rowid='<%# DataBinder.Eval(Container.DataItem,"ReviewId")%>'>
				                        <td colspan="3">
		                        ...
		                        <alternatingitemtemplate>
			                        <tr rowid='<%# DataBinder.Eval(Container.DataItem,"ReviewId")%>'>
				                        ...
				                        <td>
					                        <%# DataBinder.Eval(Container.DataItem,"CustomerName")%>
					                        <asp:Label ID="lblReviewCustomerId" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem,"CustomerId")%>' />
				                        </td>	
				                        <td>
					                        <%# Convert.ToDateTime( DataBinder.Eval(Container.DataItem,"EntryDateTime") ).ToString("dd-MMM-yy HH:mm")%>
				                        </td>
