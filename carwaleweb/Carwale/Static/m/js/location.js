var globalLocation = {
    ...
    setLocationCookies: function (cityId, cityName, areaId, areaName, zoneId, zoneName) {
        ...
        Common.utils.setEachCookie('_CustCityMaster', Number(cityId) > 0 ? cityName : "Select City");
        Common.utils.setEachCookie('_CustAreaId', areaId);
        Common.utils.setEachCookie('_CustAreaName', Number(areaId) > 0 ? areaName : "Select Area");
        Common.utils.setEachCookie('_CustZoneIdMaster', zoneId);
        Common.utils.setEachCookie('_CustZoneMaster', Number(zoneId) > 0 ? zoneName : "Select Zone");
    },
