...
function verifyForm() {
    ...
    } else if (!isModerator && descWithoutHtmlArr.length < 150) {
        isError = true;
    ...
    if (document.getElementById("txtEmail")) {
        ...
        } else if (!reEmail.test(document.getElementById("txtEmail").value.toLowerCase())) {// verify valid email!
...
var path = "https://img.carwale.com/images/ratings/";
