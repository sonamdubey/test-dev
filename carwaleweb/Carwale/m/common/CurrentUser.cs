...
namespace MobileWeb.Common 
{
	public class CurrentUser
	{
        ...
        public static string ASPSessionId
        {
            get
            {
                if (HttpContext.Current.Request.Cookies["ASP.NET_SessionId"] != null && HttpContext.Current.Request.Cookies["ASP.NET_SessionId"].Value.ToString() != "")
                {
                    return HttpContext.Current.Request.Cookies["ASP.NET_SessionId"].Value.ToString();
                }
                else return "-1";
            }
        }
