    ...
    public class AutomateRegistration
    {
        ...
        */
        public AutomateRegistrationResult ProcessRequest(string name, string eMail, string landlineNo, string mobileNo,
                                                        string cityId, string stateId, string cityName, bool autoLogin = true)
        {
            ...
            {          
                ...
                {
                    arr.CustomerId = RegisterUser(name, eMail, landlineNo, mobileNo, cityId, stateId, cityName, out existingCustomer, out fakeCustomer, out isApproved, autoLogin);
                }
        ...
        string RegisterUser(string name, string eMail, string landlineNo, string mobileNo, string cityId, string stateId,
                                string cityName, out bool existingCustomer, out bool fakeCustomer, out bool isApproved, bool autoLogin)
        {
            string customerId = "-1";
            ...
            {
                HttpContext.Current.Trace.Warn("AutomateRegistration.RegisterUser : " + err.Source + " : " + err.Message);
            ...
            finally
            {
                ...
                {       
                   if (autoLogin)
                    ...
                    SourceIdCommon.UpdateSourceId(EnumTableType.Customers, customerId);                  
                }
        ...
        bool UpdateCustomerDetails(string customerId, string name, string eMail, string landlineNo, string mobileNo, string cityId, string stateId)
        {
            ...
            if (fake == false)
            {
                ...
                {               
                    ...
                    isUpdated = customerRepo.UpdateCustomerDetails(new Customer()
                    {
