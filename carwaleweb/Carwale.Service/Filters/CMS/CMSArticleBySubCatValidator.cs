...
{
    public class CMSArticleBySubCatValidator : ActionFilterAttribute
    {
        /// <summary>
        ...
        public override void OnActionExecuting(HttpActionContext actionContext)
        {
            ...
            ushort subCategoryId = Convert.ToUInt16(querystringPrm["subcategoryid"]);

            if (!RegExValidations.IsNumeric(querystringPrm["subcategoryid"]))
            {
                isValidRequest = false;
            }
