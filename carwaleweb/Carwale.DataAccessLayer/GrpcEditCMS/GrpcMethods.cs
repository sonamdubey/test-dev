...
namespace Grpc.CMS
{
    ...
    public static class GrpcMethods
    {
        ...
        public static GrpcPopularModelVideoData GetPopularNewModelVideos(ArticleByCatURI queryString)
        {
            try
            {
                IMessage message = new GrpcMakeModelApplicationID
                ...
                return GetData<GrpcPopularModelVideoData>("GetPopularNewModelVideos", message);
            }
            catch (Exception e)
            {
        ...
        public static GrpcVideosList GetNewModelsVideosByMakeId(int makeId, uint applicationId, uint startId, uint endId)
        {
            try
            {
                IMessage message = new GrpcVideosByIdURI()
                ...
                return GetData<GrpcVideosList>("GetNewModelsVideosByMakeId", message);
            }
            catch (Exception e)
            {
                Logger.LogException(e);
        ...
        public static GrpcVideosList GetNewModelsVideosBySubCategory(uint catId, uint applicationId, uint startId, uint endId)
        {
            try
            {
                IMessage message = new GrpcVideosBySubCategoryURI()
                ...
                return GetData<GrpcVideosList>("GetNewModelsVideosBySubCategory", message);
            }
            catch (Exception e)
            {
                Logger.LogException(e);
        ...
        public static GrpcPopularModelPhotosData GetPopularNewModelPhotos(ArticleByCatURI queryString)
        {
            try
            {
                IMessage message = new GrpcMakeModelApplicationID()
                ...
                return GetData<GrpcPopularModelPhotosData>("GetPopularNewModelPhotos", message);
            }
            catch (Exception err)
            {
        ...
        public static T GetData<T>(string methodName,IMessage message) where T : IMessage
        {
            ...
            apiGatewayCaller.Add(CWConfiguration.EditCMSModuleName, methodName, message);
