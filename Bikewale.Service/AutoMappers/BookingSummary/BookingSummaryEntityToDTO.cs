...
namespace Bikewale.Service.AutoMappers.BookingSummary
{
    public class BookingSummaryEntityToDTO
    {
        ...
        internal static DTO.PriceQuote.DetailedDealerQuotation.DDQDealerDetailBase ConvertDetailEntity(Entity.BikeBooking.PQ_DealerDetailEntity dealerDetailEntity)
        {
