...
namespace Bikewale.Interfaces.PriceQuote
{
    ...
    public interface ILeadNofitication
    {
        ...
        void PushtoAB(string dealerId, uint pqId, string customerName, string customerMobile, string customerEmail, string versionId, string cityId, string pqGuId, uint leadId);
