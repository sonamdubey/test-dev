...
namespace BikewaleOpr.BAL.ServiceCenter
{
    ...
    public class ServiceCenter : IServiceCenter
    {
        ...
        /// </summary>
        /// <returns></returns>
        public bool AddUpdateServiceCenter(ServiceCenterCompleteData serviceCenterDetails,string _updatedBy)
        {
            bool status = false;
            ...
            try
            {
                ...
                {
                   status = _IServiceCenter.AddUpdateServiceCenter(serviceCenterDetails, _updatedBy);
