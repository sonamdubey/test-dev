...
namespace EditCMSWindowsService.Messages {
  public static partial class EditCMSGrpcService
  {
    ...
    static readonly Marshaller<global::EditCMSWindowsService.Messages.GrpcCarModelDetails> __Marshaller_GrpcCarModelDetails = Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::EditCMSWindowsService.Messages.GrpcCarModelDetails.Parser.ParseFrom);
    ...
    static readonly Marshaller<global::EditCMSWindowsService.Messages.GrpcPopularCarDataList> __Marshaller_GrpcPopularCarDataList = Marshallers.Create((arg) => global::Google.Protobuf.MessageExtensions.ToByteArray(arg), global::EditCMSWindowsService.Messages.GrpcPopularCarDataList.Parser.ParseFrom);
    ...
    static readonly Method<global::EditCMSWindowsService.Messages.GrpcInt, global::EditCMSWindowsService.Messages.GrpcCarModelDetails> __Method_GetModelDetailsById = new Method<global::EditCMSWindowsService.Messages.GrpcInt, global::EditCMSWindowsService.Messages.GrpcCarModelDetails>(
        MethodType.Unary,
        __ServiceName,
        "GetModelDetailsById",
        __Marshaller_GrpcInt,
        __Marshaller_GrpcCarModelDetails);
    ...
    static readonly Method<global::EditCMSWindowsService.Messages.GrpcInt, global::EditCMSWindowsService.Messages.GrpcPopularCarDataList> __Method_GetPopularCar = new Method<global::EditCMSWindowsService.Messages.GrpcInt, global::EditCMSWindowsService.Messages.GrpcPopularCarDataList>(
        MethodType.Unary,
        __ServiceName,
        "GetPopularCar",
        __Marshaller_GrpcInt,
        __Marshaller_GrpcPopularCarDataList);
    ...
    public abstract partial class EditCMSGrpcServiceBase
    {
      ...
      /// <summary>
      ///rpc GrpcGetFeaturedCar(GrpcFeatureCarURI) returns (GrpcInt){}
      /// </summary>
      ...
      public virtual global::System.Threading.Tasks.Task<global::EditCMSWindowsService.Messages.GrpcCarModelDetails> GetModelDetailsById(global::EditCMSWindowsService.Messages.GrpcInt request, ServerCallContext context)
      {
        throw new RpcException(new Status(StatusCode.Unimplemented, ""));
      }
      ...
      public virtual global::System.Threading.Tasks.Task<global::EditCMSWindowsService.Messages.GrpcPopularCarDataList> GetPopularCar(global::EditCMSWindowsService.Messages.GrpcInt request, ServerCallContext context)
      {
        throw new RpcException(new Status(StatusCode.Unimplemented, ""));
      }
    ...
    public partial class EditCMSGrpcServiceClient : ClientBase<EditCMSGrpcServiceClient>
    {
      ...
      public virtual global::EditCMSWindowsService.Messages.GrpcCarModelDetails GetModelDetailsById(global::EditCMSWindowsService.Messages.GrpcInt request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken))
      {
        return GetModelDetailsById(request, new CallOptions(headers, deadline, cancellationToken));
      }
      public virtual global::EditCMSWindowsService.Messages.GrpcCarModelDetails GetModelDetailsById(global::EditCMSWindowsService.Messages.GrpcInt request, CallOptions options)
      {
        return CallInvoker.BlockingUnaryCall(__Method_GetModelDetailsById, null, options, request);
      }
      public virtual AsyncUnaryCall<global::EditCMSWindowsService.Messages.GrpcCarModelDetails> GetModelDetailsByIdAsync(global::EditCMSWindowsService.Messages.GrpcInt request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken))
      {
        return GetModelDetailsByIdAsync(request, new CallOptions(headers, deadline, cancellationToken));
      }
      public virtual AsyncUnaryCall<global::EditCMSWindowsService.Messages.GrpcCarModelDetails> GetModelDetailsByIdAsync(global::EditCMSWindowsService.Messages.GrpcInt request, CallOptions options)
      {
        return CallInvoker.AsyncUnaryCall(__Method_GetModelDetailsById, null, options, request);
      }
      ...
      public virtual global::EditCMSWindowsService.Messages.GrpcPopularCarDataList GetPopularCar(global::EditCMSWindowsService.Messages.GrpcInt request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken))
      {
        return GetPopularCar(request, new CallOptions(headers, deadline, cancellationToken));
      }
      public virtual global::EditCMSWindowsService.Messages.GrpcPopularCarDataList GetPopularCar(global::EditCMSWindowsService.Messages.GrpcInt request, CallOptions options)
      {
        return CallInvoker.BlockingUnaryCall(__Method_GetPopularCar, null, options, request);
      }
      public virtual AsyncUnaryCall<global::EditCMSWindowsService.Messages.GrpcPopularCarDataList> GetPopularCarAsync(global::EditCMSWindowsService.Messages.GrpcInt request, Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken))
      {
        return GetPopularCarAsync(request, new CallOptions(headers, deadline, cancellationToken));
      }
      public virtual AsyncUnaryCall<global::EditCMSWindowsService.Messages.GrpcPopularCarDataList> GetPopularCarAsync(global::EditCMSWindowsService.Messages.GrpcInt request, CallOptions options)
      {
        return CallInvoker.AsyncUnaryCall(__Method_GetPopularCar, null, options, request);
      }
    ...
    public static ServerServiceDefinition BindService(EditCMSGrpcServiceBase serviceImpl)
    {
      return ServerServiceDefinition.CreateBuilder()
          ...
          .AddMethod(__Method_GetModelDetailsById, serviceImpl.GetModelDetailsById)
          ...
          .AddMethod(__Method_GetPopularCar, serviceImpl.GetPopularCar)
          ...
          .AddMethod(__Method_GetCarSynopsis, serviceImpl.GetCarSynopsis).Build();
    }
