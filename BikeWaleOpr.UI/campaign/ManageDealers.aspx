          ...
          <div id="box" class="box">
              <table class="table-default-style">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" id="txtMaskingNumber" MaxLength="10" class="req width300" Enabled="true" />
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox runat="server" id="txtdealerRadius" placeholder="" class="numeric width300" />
                        </td>
                    </tr>
                        <tr>
