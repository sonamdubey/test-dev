...
$(document).ready(function(){
	...
	grayContent += "<div id='gb-window'>";
					grayContent += "<div id='gb-head'><span id='gb-title'></span><a id='gb-close'><span>X</span></a></div>";
					grayContent += "<img id='loading' src='https://imgd1.aeplcdn.com/0x0/bw/static/design15/old-images/d/load.gif'/><div id='gb-content'></div>";
	grayContent += "</div>";
