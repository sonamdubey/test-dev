		...
		<asp:Repeater ID="rptFeatures" runat="server" >
			...
			<itemtemplate>
					<tr>
						...
						<td>
                            <div id ="div1">
                                <img id="imgSmall" class='<%# Convert.ToBoolean(DataBinder.Eval(Container.DataItem,"IsReplicated")) ? "": "checkImage" %>'  image-id="<%= verId%>" src='<%# BikeWaleOpr.ImagingOperations.GetPathToShowImages(DataBinder.Eval( Container.DataItem, "HostURL").ToString(),"227X128" , DataBinder.Eval( Container.DataItem, "OriginalImagePath" ).ToString()) %>'/>
                            </div>
                        </td>
